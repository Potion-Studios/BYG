...
public class BYGTerraBlenderRegion extends Region {
    ...
    public BYGTerraBlenderRegion(OverworldRegion overworldRegion) {
        this(overworldRegion.overworldWeight(),
                ...
                _2DResourceKeyArrayTo2DList(overworldRegion.plateauEdgeBiomes().value()),
                _2DResourceKeyArrayTo2DList(overworldRegion.plateauEdgeBiomesVariant().value()),
                _2DResourceKeyArrayTo2DList(overworldRegion.mountainEdgeBiomes().value()),
                _2DResourceKeyArrayTo2DList(overworldRegion.mountainEdgeBiomesVariant().value()),
    ...
    public BYGTerraBlenderRegion(int overworldWeight,
        ...
        plateauEdgeBiomes = filter("plateau_edge_biomes", this.getName(), count, plateauEdgeBiomes, noVoidBiomes, false);
        plateauEdgeBiomesVariant = filter("plateau_edge_biomes_variant", this.getName(), count, plateauEdgeBiomesVariant, noVoidBiomes, false);
        mountainEdgeBiomes = filter("mountain_edge_biomes", this.getName(), count, mountainEdgeBiomes, noVoidBiomes, false);
        mountainEdgeBiomesVariant = filter("mountain_edge_biomes_variant", this.getName(), count, mountainEdgeBiomesVariant, noVoidBiomes, false);
        ...
        this.bygOverworldBiomeBuilder = new BYGOverworldBiomeBuilder(
                ...
                plateauEdgeBiomes, plateauEdgeBiomesVariant, mountainEdgeBiomes, mountainEdgeBiomesVariant
        );
