...
public class ColorManager {
    ...
    public static synchronized void onBlockColorsInit(BlockColors blockColors) {
        ...
        blockColors.register((unknown, lightReader, pos, unknown2) -> lightReader != null && pos != null ? BiomeColors.getAverageFoliageColor(lightReader, pos) : FoliageColor.get(0.5D, 1.0D), BYGWoodTypes.MAHOGANY.leaves().get(), BYGBlocks.POISON_IVY.get(), BYGBlocks.LEAF_PILE.get(), BYGBlocks.ORCHARD_LEAVES.get(), BYGBlocks.FLOWERING_ORCHARD_LEAVES.get(), BYGBlocks.RIPE_ORCHARD_LEAVES.get(), BYGBlocks.WILLOW_LEAVES.get(), BYGBlocks.MAPLE_LEAVES.get(), BYGBlocks.JOSHUA_LEAVES.get(), BYGBlocks.RIPE_JOSHUA_LEAVES.get(), BYGWoodTypes.CYPRESS.leaves().get());
    ...
    public static synchronized void onItemColorsInit(BlockColors blockColors, ItemColors itemColors) {
        ...
        itemColors.register(itemBlockColourHandler,
            ...
            BYGItems.WILLOW_LEAVES.get(), BYGWoodTypes.CYPRESS.leaves().get(),
