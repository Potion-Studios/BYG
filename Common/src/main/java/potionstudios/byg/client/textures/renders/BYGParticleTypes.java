...
public class BYGParticleTypes {
    ...
    public static final RegistryObject<SimpleParticleType> WITCH_HAZEL_LEAVES = createSimpleParticle(() -> SimpleParticleTypeAccess.byg_create(true), "witch_hazel_leaves");public static final RegistryObject<SimpleParticleType> WHITE_CHERRY_BLOSSOM_LEAVES = createSimpleParticle(() -> SimpleParticleTypeAccess.byg_create(false), "white_cherry_blossom_leaves");
