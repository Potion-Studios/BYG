...
public class BYGGlobalPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> ORE_SOAPSTONE_UPPER = BYGPlacedFeaturesUtil.createPlacedFeature(globalFeaturePath("ore_soapstone_upper"), BYGGlobalFeatureFeatures.ORE_SOAPSTONE, new ImmutableList.Builder<PlacementModifier>().addAll(OrePlacementsAccess.byg_invokeRareOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(128)))).add(new IsDimensionFilter(List.of(Level.OVERWORLD))).build().stream().filter(placementModifier -> !(placementModifier instanceof BiomeFilter)).toList());
    public static final Holder<PlacedFeature> ORE_SOAPSTONE_LOWER = BYGPlacedFeaturesUtil.createPlacedFeature(globalFeaturePath("ore_soapstone_lower"), BYGGlobalFeatureFeatures.ORE_SOAPSTONE, new ImmutableList.Builder<PlacementModifier>().addAll(OrePlacementsAccess.byg_invokeCommonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(60)))).add(new IsDimensionFilter(List.of(Level.OVERWORLD))).build().stream().filter(placementModifier -> !(placementModifier instanceof BiomeFilter)).toList());
    public static final Holder<PlacedFeature> ORE_TRAVERTINE_UPPER = BYGPlacedFeaturesUtil.createPlacedFeature(globalFeaturePath("ore_travertine_upper"), BYGGlobalFeatureFeatures.ORE_TRAVERTINE, new ImmutableList.Builder<PlacementModifier>().addAll(OrePlacementsAccess.byg_invokeRareOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(128)))).add(new IsDimensionFilter(List.of(Level.OVERWORLD))).build().stream().filter(placementModifier -> !(placementModifier instanceof BiomeFilter)).toList());
    public static final Holder<PlacedFeature> ORE_TRAVERTINE_LOWER = BYGPlacedFeaturesUtil.createPlacedFeature(globalFeaturePath("ore_travertine_lower"), BYGGlobalFeatureFeatures.ORE_TRAVERTINE, new ImmutableList.Builder<PlacementModifier>().addAll(OrePlacementsAccess.byg_invokeCommonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(60)))).add(new IsDimensionFilter(List.of(Level.OVERWORLD))).build().stream().filter(placementModifier -> !(placementModifier instanceof BiomeFilter)).toList());
