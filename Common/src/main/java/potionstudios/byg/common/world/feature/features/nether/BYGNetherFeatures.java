...
public class BYGNetherFeatures {
    ...
    public static final ConfiguredFeature<?, ?> MAGMA_PATCH_FIRE = createConfiguredFeature("magma_patch_fire", Feature.RANDOM_PATCH.configured(FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.SOUL_FIRE))), List.of(BYGBlocks.NYLIUM_SOUL_SOIL, BYGBlocks.NYLIUM_SOUL_SAND))));
}
