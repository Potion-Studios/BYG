...
public class BYGSurfaceRules {
    ...
    public static final SurfaceRules.RuleSource ETHEREAL_ISLANDS = SurfaceRules.ifTrue(SurfaceRules.isBiome(BYGBiomes.ETHEREAL_ISLANDS), SurfaceRules.sequence(SurfaceRules.ifTrue(WATER_CHECK, SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.state(BYGBlockFamilies.ETHER.get(BYGBlockFamily.BlockVariant.SPREADABLE).defaultBlockState()))), SurfaceRules.state(BYGBlockFamilies.ETHER_STONE.get(BYGBlockFamily.BlockVariant.BASE_BLOCK).defaultBlockState())));
