...
public class BYGSurfaceRules {
    ...
    public static final SurfaceRules.RuleSource BYG_SURFACE_RULES = SurfaceRules.sequence(SWAMP_SURFACE_RULES, NOISE_PEAT, NOISE_COARSE_DIRT_PODZOL, NOISE_COARSE_DIRT_PEAT, OVERGROWN_STONE);
