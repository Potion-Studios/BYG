    ...
    protected boolean generate(Set<BlockPos> changedBlocks, WorldGenLevel worldIn, Random rand, BlockPos pos, BoundingBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getMaxBuildHeight()) {
            if (!isDesiredGroundwEndTags(worldIn, pos.below(), config)) {
                ...
                placeLeaves(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(8, 9, -3), boundsIn);
                ...
                placeLeaves(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(7, 10, -3), boundsIn);
                ...
                placeLeaves(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(8, 10, -4), boundsIn);
                placeLeaves(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(8, 10, -2), boundsIn);
                ...
                placeLeaves(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(7, 11, -4), boundsIn);
                placeLeaves(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(7, 11, -3), boundsIn);
