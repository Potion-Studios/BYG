...
public class BYGOverworldTreeFeatures {
    public static final ResourceKey<ConfiguredFeature<?, ?>> ARAUCARIA_TREE1 = createConfiguredFeature("araucaria_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BlockStateProvider.simple(BYGBlockFamilies.PINE.get(BYGBlockFamily.BlockVariant.LOG).defaultBlockState()),
                    ...
                    BYGBlockFamilies.ARAUCARIA.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of()
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> ASPEN_SHRUB1 = createConfiguredFeature("aspen_shrub1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.ASPEN.getTag(BYGBlockFamily.BlockVariant.GROWER), 1, ImmutableList.of()
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> ASPEN_TREE1 = createConfiguredFeature("aspen_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.ASPEN.get(BYGBlockFamily.BlockVariant.LOG),
                    BYGBlockFamilies.ASPEN.get(BYGBlockFamily.BlockVariant.LEAVES),
                    BYGBlockFamilies.ASPEN.getTag(BYGBlockFamily.BlockVariant.GROWER), 4, ImmutableList.of(SHELF_FUNGI.get())
            )
    );
    public static final ResourceKey<ConfiguredFeature<?, ?>> ASPEN_TREE2 = createConfiguredFeature("aspen_tree2",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.ASPEN.get(BYGBlockFamily.BlockVariant.LOG),
                    BYGBlockFamilies.ASPEN.get(BYGBlockFamily.BlockVariant.LEAVES),
                    BYGBlockFamilies.ASPEN.getTag(BYGBlockFamily.BlockVariant.GROWER), 8, ImmutableList.of(SHELF_FUNGI.get())
            )
    );
    ...
    public static final Supplier<AttachedToLeavesDecorator> BAOBAB_FRUIT = () -> new AttachedToLeavesDecorator(0.2F, 2, 0, new RandomizedIntStateProvider(BlockStateProvider.simple(BYGBlockFamilies.BAOBAB.get(BYGBlockFamily.BlockVariant.FRUIT_BLOCK).defaultBlockState()), FruitBlock.AGE, UniformInt.of(0, 3)), 2, List.of(Direction.DOWN));
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> BAOBAB_TREE1 = createConfiguredFeature("baobab_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BiasedToBottomInt.of(5, 15),
                    BlockStateProvider.simple(BYGBlockFamilies.BAOBAB.get(BYGBlockFamily.BlockVariant.LOG).defaultBlockState()),
                    new WeightedStateProvider(new SimpleWeightedRandomList.Builder<BlockState>()
                            .add(BYGBlockFamilies.BAOBAB.get(BYGBlockFamily.BlockVariant.LEAVES).defaultBlockState(), 10)
                            .add(BYGBlockFamilies.BAOBAB.get(BYGBlockFamily.BlockVariant.FLOWERING_LEAVES).defaultBlockState(), 2)
                            .add(BYGBlockFamilies.BAOBAB.get(BYGBlockFamily.BlockVariant.FRUIT_LEAVES).defaultBlockState(), 1).build()
                    ),
                    ...
                    BYGBlockFamilies.BAOBAB.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of(BAOBAB_FRUIT.get())
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> OAK_BUSH1 = createConfiguredFeature("oak_bush1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    Blocks.OAK_LOG,
                    Blocks.OAK_LEAVES,
                    BYGBlockFamilies.ZELKOVA.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of()
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> SAKURA_CHERRY_TREE1 = createConfiguredFeature("white_cherry_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.WHITE_SAKURA_CHERRY.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of()
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> CIKA_TREE1 = createConfiguredFeature("cika_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.CIKA.getTag(BYGBlockFamily.BlockVariant.GROWER), 14, ImmutableList.of()
            )
    );
    public static final ResourceKey<ConfiguredFeature<?, ?>> CIKA_TREE2 = createConfiguredFeature("cika_tree2",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.CIKA.get(BYGBlockFamily.BlockVariant.LOG),
                    BYGBlockFamilies.CIKA.get(BYGBlockFamily.BlockVariant.LEAVES),
                    BYGBlockFamilies.CIKA.getTag(BYGBlockFamily.BlockVariant.GROWER), 12, ImmutableList.of()
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> CONIFER_TREE1 = createConfiguredFeature("conifer_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BlockStateProvider.simple(BYGBlockFamilies.FIR.get(BYGBlockFamily.BlockVariant.LOG).defaultBlockState()),
                    ...
                    BYGBlockFamilies.FIR.getTag(BYGBlockFamily.BlockVariant.GROWER), 14, ImmutableList.of()
            )
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> CYPRESS_TREE1 = createConfiguredFeature("cypress_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.CYPRESS.getTag(BYGBlockFamily.BlockVariant.GROWER), 14, ImmutableList.of(new LeaveVineDecorator(1), new TrunkVineDecorator(), MOSS_CARPET.get())
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> HOLLY_TREE1 = createConfiguredFeature("holly_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.HOLLY.getTag(BYGBlockFamily.BlockVariant.GROWER), 6, ImmutableList.of()
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> BLUE_ENCHANTED_TREE1 = createConfiguredFeature("blue_enchanted_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.BLUE_ENCHANTED.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of()
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> GREEN_ENCHANTED_TREE1 = createConfiguredFeature("green_enchanted_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYG.createLocation("features/trees/enchanted/enchanted_canopy_1"),
                    BiasedToBottomInt.of(3, 8),
                    new WeightedStateProvider(new SimpleWeightedRandomList.Builder<BlockState>().add(BYGBlockFamilies.GREEN_ENCHANTED.get(BYGBlockFamily.BlockVariant.IMBUED_LOG).defaultBlockState(), 1).add(BYGBlockFamilies.GREEN_ENCHANTED.get(BYGBlockFamily.BlockVariant.LOG).defaultBlockState(), 4).build()),
                    BlockStateProvider.simple(BYGBlockFamilies.GREEN_ENCHANTED.get(BYGBlockFamily.BlockVariant.LEAVES).defaultBlockState()),
                    BYGBlockFamilies.BLUE_ENCHANTED.get(BYGBlockFamily.BlockVariant.LOG),
                    BYGBlockFamilies.BLUE_ENCHANTED.get(BYGBlockFamily.BlockVariant.LEAVES),
                    BYGBlockFamilies.GREEN_ENCHANTED.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of()
            )
    );
    ...
    public static final Supplier<AttachedToLeavesDecorator> JOSHUA_FRUIT = () ->
            new AttachedToLeavesDecorator(0.1F, 2, 0,
                    new RandomizedIntStateProvider(BlockStateProvider.simple(BYGBlockFamilies.JOSHUA.get(BYGBlockFamily.BlockVariant.FRUIT_BLOCK).defaultBlockState()), FruitBlock.AGE, UniformInt.of(0, 3)), 2, List.of(Direction.DOWN));
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> JOSHUA_TREE1 = createConfiguredFeature("joshua_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BlockStateProvider.simple(Blocks.OAK_LOG.defaultBlockState()),
                    new WeightedStateProvider(new SimpleWeightedRandomList.Builder<BlockState>()
                            .add(BYGBlockFamilies.JOSHUA.get(BYGBlockFamily.BlockVariant.LEAVES).defaultBlockState(), 10)
                            .add(BYGBlockFamilies.JOSHUA.get(BYGBlockFamily.BlockVariant.FLOWERING_LEAVES).defaultBlockState(), 2)
                            .add(BYGBlockFamilies.JOSHUA.get(BYGBlockFamily.BlockVariant.FRUIT_LEAVES).defaultBlockState(), 1).build()
                    ),
                    Blocks.OAK_LOG,
                    BYGBlockFamilies.JOSHUA.get(BYGBlockFamily.BlockVariant.LEAVES),
                    BYGBlockFamilies.JOSHUA.getTag(BYGBlockFamily.BlockVariant.GROWER), 4, ImmutableList.of(JOSHUA_FRUIT.get())
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> JOSHUA_TREE2 = createConfiguredFeature("joshua_tree2",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    Blocks.OAK_LOG,
                    BYGBlockFamilies.JOSHUA.get(BYGBlockFamily.BlockVariant.LEAVES),
                    BYGBlockFamilies.JOSHUA.getTag(BYGBlockFamily.BlockVariant.GROWER), 6, ImmutableList.of(JOSHUA_FRUIT.get())
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> WHITE_MANGROVE_TREE1 = createConfiguredFeature("white_mangrove_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.WHITE_MANGROVE.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of(new LeaveVineDecorator(1), new TrunkVineDecorator(), MOSS_CARPET.get())
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> IRONWOOD_TREE = createConfiguredFeature("ironwood_tree",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.WHITE_MANGROVE.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of(new LeaveVineDecorator(1), new TrunkVineDecorator())
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORCHARD_TREE1 = createConfiguredFeature("orchard_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BlockStateProvider.simple(Blocks.OAK_LOG),
                    new WeightedStateProvider(new SimpleWeightedRandomList.Builder<BlockState>()
                            .add(BYGBlockFamilies.ORCHARD.get(BYGBlockFamily.BlockVariant.LEAVES).defaultBlockState(), 10)
                            .add(BYGBlockFamilies.ORCHARD.get(BYGBlockFamily.BlockVariant.FLOWERING_LEAVES).defaultBlockState(), 1)
                            .add(BYGBlockFamilies.ORCHARD.get(BYGBlockFamily.BlockVariant.FRUIT_LEAVES).defaultBlockState(), 1).build()
                    ),
                    Blocks.OAK_LOG,
                    BYGBlockFamilies.ORCHARD.get(BYGBlockFamily.BlockVariant.LEAVES),
                    BYGBlockFamilies.ORCHARD.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of()
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> PALM_TREE1 = createConfiguredFeature("palm_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BlockStateProvider.simple(BYGBlockFamilies.PALM.get(BYGBlockFamily.BlockVariant.LOG).defaultBlockState()),
                    ...
                    BYGBlockFamilies.PALM.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of()
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> PINE_LARGE_TREE1 = createConfiguredFeature("large_pine_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.PINE.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of()
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> RAINBOW_EUCALYPTUS_TREE1 = createConfiguredFeature("rainbow_eucalyptus_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.RAINBOW_EUCALYPTUS.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of(new BYGLeavesVineDecorator((VineBlock) Blocks.VINE, 0.05F), new BYGTrunkVineDecorator((VineBlock) Blocks.VINE, 0.05F))
            )
    );
    public static final ResourceKey<ConfiguredFeature<?, ?>> RAINBOW_EUCALYPTUS_LARGE_TREE1 = createConfiguredFeature("rainbow_eucalyptus_large_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.RAINBOW_EUCALYPTUS.get(BYGBlockFamily.BlockVariant.LOG),
                    BYGBlockFamilies.RAINBOW_EUCALYPTUS.get(BYGBlockFamily.BlockVariant.LEAVES),
                    BYGBlockFamilies.RAINBOW_EUCALYPTUS.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of(new BYGTrunkVineDecorator((VineBlock) Blocks.VINE, 0.05F), new BYGLeavesVineDecorator((VineBlock) Blocks.VINE, 0.05F))
            )
    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> REDWOOD_TREE1 = createConfiguredFeature("redwood_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BYGBlockFamilies.REDWOOD.getTag(BYGBlockFamily.BlockVariant.GROWER), 5, ImmutableList.of()
            )
    );
    ...
    public static final Supplier<AttachedToLeavesDecorator> GREEN_APPLE_FRUIT = () -> new AttachedToLeavesDecorator(0.1F, 2, 0, new RandomizedIntStateProvider(BlockStateProvider.simple(BYGBlockFamilies.SKYRIS.get(BYGBlockFamily.BlockVariant.FRUIT_BLOCK).defaultBlockState()), FruitBlock.AGE, UniformInt.of(0, 3)), 2, List.of(Direction.DOWN));
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> SKYRIS_TREE1 = createConfiguredFeature("skyris_tree1",
            ...
            () -> new TreeFromStructureNBTConfig(
                    ...
                    BiasedToBottomInt.of(5, 15),
                    BlockStateProvider.simple(BYGBlockFamilies.SKYRIS.get(BYGBlockFamily.BlockVariant.LOG).defaultBlockState()),
                    new WeightedStateProvider(new SimpleWeightedRandomList.Builder<BlockState>()
                            .add(BYGBlockFamilies.SKYRIS.get(BYGBlockFamily.BlockVariant.LEAVES).defaultBlockState(), 10)
                            .add(BYGBlockFamilies.SKYRIS.get(BYGBlockFamily.BlockVariant.FLOWERING_LEAVES).defaultBlockState(), 2)
                            .add(BYGBlockFamilies.SKYRIS.get(BYGBlockFamily.BlockVariant.FRUIT_LEAVES).defaultBlockState(), 1).build()
                    ),
