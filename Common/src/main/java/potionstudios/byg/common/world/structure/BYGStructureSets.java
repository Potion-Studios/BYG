...
public class BYGStructureSets {
    ...
    public static final Holder<StructureSet> ARCH = register("arches", new StructureSet(List.of(StructureSet.entry(BYGStructureFeatures.RED_ROCK_ARCH), StructureSet.entry(BYGStructureFeatures.DESTROYED_RED_ROCK_ARCH)), new RandomSpreadStructurePlacement(8, 2, RandomSpreadType.LINEAR, 10387312)));
