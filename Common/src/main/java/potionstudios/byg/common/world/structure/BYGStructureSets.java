...
public class BYGStructureSets {
    ...
    public static final Holder<StructureSet> VILLAGES = register("villages", () -> new StructureSet(List.of(StructureSet.entry(BYGStructures.VILLAGE_RED_ROCK), StructureSet.entry(BYGStructures.VILLAGE_RUINS), StructureSet.entry(BYGStructures.VILLAGE_SALEM), StructureSet.entry(BYGStructures.PUMPKIN_PATCH), StructureSet.entry(BYGStructures.VILLAGE_TROPICAL), StructureSet.entry(BYGStructures.VILLAGE_SKYRIS)), new RandomSpreadStructurePlacement(34, 8, RandomSpreadType.LINEAR, 437845874)));
