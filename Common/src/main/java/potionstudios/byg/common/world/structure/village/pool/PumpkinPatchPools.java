...
public class PumpkinPatchPools {
    public static final Holder<StructureTemplatePool> PUMPKIN_PATCH_JIGSAW = Pools.register(new StructureTemplatePool(BYG.createLocation("village/pumpkin_patch/town_centers"),
        new ResourceLocation("empty"),
        ImmutableList.of(
                Pair.of(StructurePoolElement.legacy("byg:village/pumpkin_patch/town_centers/pumpkin_patch_meeting_point_1", ProcessorLists.MOSSIFY_10_PERCENT), 35),
                Pair.of(StructurePoolElement.legacy("byg:village/pumpkin_patch/town_centers/pumpkin_patch_meeting_point_2", ProcessorLists.MOSSIFY_10_PERCENT), 35),
                Pair.of(StructurePoolElement.legacy("byg:village/pumpkin_patch/town_centers/pumpkin_patch_meeting_point_3", ProcessorLists.MOSSIFY_10_PERCENT), 35)), StructureTemplatePool.Projection.RIGID));

    static {
        //Normal
        Pools.register(new StructureTemplatePool(BYG.createLocation("village/pumpkin_patch/streets"),
            BYG.createLocation("village/pumpkin_patch/terminators"),
        ...
        Pools.register(new StructureTemplatePool(BYG.createLocation("village/pumpkin_patch/houses"),
            BYG.createLocation("village/pumpkin_patch/terminators"),
            ImmutableList.of(Pair.of(StructurePoolElement.legacy("byg:village/pumpkin_patch/houses/pumpkin_patch_small_house_1"), 3),
                    ...
                    Pair.of(StructurePoolElement.legacy("byg:village/pumpkin_patch/houses/pumpkin_patch_small_farm_1", ProcessorLists.FARM_TAIGA), 2),
                    Pair.of(StructurePoolElement.legacy("byg:village/pumpkin_patch/houses/pumpkin_patch_small_farm_2", ProcessorLists.FARM_TAIGA), 3),
                    Pair.of(StructurePoolElement.legacy("byg:village/pumpkin_patch/houses/pumpkin_patch_small_farm_3", ProcessorLists.FARM_TAIGA), 2),
                    Pair.of(StructurePoolElement.legacy("byg:village/pumpkin_patch/houses/pumpkin_patch_small_farm_4", ProcessorLists.FARM_TAIGA), 3),
                    Pair.of(StructurePoolElement.legacy("byg:village/pumpkin_patch/houses/pumpkin_patch_small_farm_5", ProcessorLists.FARM_TAIGA), 2),
                    Pair.of(StructurePoolElement.empty(), 10)), StructureTemplatePool.Projection.RIGID));

        Pools.register(new StructureTemplatePool(BYG.createLocation("village/pumpkin_patch/terminators"),
            new ResourceLocation("empty"),
        ...
        Pools.register(new StructureTemplatePool(BYG.createLocation("village/pumpkin_patch/decor"),
            new ResourceLocation("empty"),
        ...
        Pools.register(new StructureTemplatePool(BYG.createLocation("village/pumpkin_patch/wards"),
            new ResourceLocation("empty"),
