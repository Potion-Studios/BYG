...
public class BYGOverworldBiomeSelectors {
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> MIDDLE_BIOMES_VANILLA = create("middle_biomes/middle_biomes_vanilla", MIDDLE_BIOMES_LAYOUT, new ResourceKey[][]{
        ...
        {Biomes.PLAINS, BYGBiomes.ALLIUM_FIELDS, BYGBiomes.RED_OAK_FOREST, Biomes.TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA},
        {Biomes.FLOWER_FOREST, Biomes.PLAINS, BYGBiomes.RED_OAK_FOREST, Biomes.BIRCH_FOREST, Biomes.DARK_FOREST},
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> MIDDLE_BIOMES_VARIANT = create("middle_biomes_variant/middle_biomes_variant_1", MIDDLE_BIOMES_VARIANT_LAYOUT, new ResourceKey[][]{
        {Biomes.ICE_SPIKES, Biomes.THE_VOID, Biomes.SNOWY_TAIGA, BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.FROSTED_TAIGA},
        {Biomes.THE_VOID, BYGBiomes.WEEPING_WITCH_FOREST, BYGBiomes.ASPEN_FOREST, BYGBiomes.AUTUMNAL_TAIGA, Biomes.OLD_GROWTH_PINE_TAIGA},
        {Biomes.THE_VOID, BYGBiomes.PRAIRIE, BYGBiomes.ORCHARD, BYGBiomes.ASPEN_FOREST, BYGBiomes.REDWOOD_THICKET},
        {BYGBiomes.BAOBAB_SAVANNA, BYGBiomes.ARAUCARIA_SAVANNA, Biomes.THE_VOID, BYGBiomes.AMARANTH_FIELDS, BYGBiomes.TROPICAL_RAINFOREST},
        {Biomes.ERODED_BADLANDS, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.SIERRA_BADLANDS, BYGBiomes.MOJAVE_DESERT, BYGBiomes.MOJAVE_DESERT}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES = create("plateau_biomes/plateau_biomes_1", PLATEAU_BIOMES_LAYOUT, new ResourceKey[][]{
        {Biomes.SNOWY_PLAINS, BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.FROSTED_TAIGA, BYGBiomes.CARDINAL_TUNDRA, Biomes.SNOWY_TAIGA},
        {Biomes.MEADOW, BYGBiomes.WEEPING_WITCH_FOREST, BYGBiomes.MAPLE_TAIGA, BYGBiomes.CANADIAN_SHIELD, BYGBiomes.BLACK_FOREST},
        {Biomes.MEADOW, BYGBiomes.COCONINO_MEADOW, BYGBiomes.COCONINO_MEADOW, BYGBiomes.FRAGMENT_FOREST, Biomes.DARK_FOREST},
        {Biomes.SAVANNA_PLATEAU, Biomes.SAVANNA_PLATEAU, BYGBiomes.RED_OAK_FOREST, Biomes.FOREST, BYGBiomes.GUIANA_SHIELD},
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES_2 = create("plateau_biomes/plateau_biomes_2", PLATEAU_BIOMES_LAYOUT, new ResourceKey[][]{
        {Biomes.SNOWY_PLAINS, BYGBiomes.CONIFEROUS_FOREST, BYGBiomes.FROSTED_CONIFEROUS_FOREST, Biomes.SNOWY_TAIGA, Biomes.SNOWY_TAIGA},
        {BYGBiomes.COCONINO_MEADOW, BYGBiomes.COCONINO_MEADOW, BYGBiomes.CONIFEROUS_FOREST, BYGBiomes.CIKA_WOODS, BYGBiomes.SKYRIS_VALE},
        {Biomes.MEADOW, BYGBiomes.COCONINO_MEADOW, Biomes.MEADOW, Biomes.MEADOW, Biomes.DARK_FOREST},
        {Biomes.SAVANNA_PLATEAU, Biomes.SAVANNA_PLATEAU, BYGBiomes.RED_OAK_FOREST, Biomes.FOREST, BYGBiomes.GUIANA_SHIELD},
        {Biomes.BADLANDS, Biomes.BADLANDS, Biomes.BADLANDS, Biomes.WOODED_BADLANDS, Biomes.WOODED_BADLANDS}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES_3 = create("plateau_biomes/plateau_biomes_3", PLATEAU_BIOMES_LAYOUT, new ResourceKey[][]{
        {Biomes.SNOWY_PLAINS, BYGBiomes.FROSTED_CONIFEROUS_FOREST, Biomes.SNOWY_PLAINS, Biomes.SNOWY_TAIGA, Biomes.SNOWY_TAIGA},
        {Biomes.MEADOW, BYGBiomes.CONIFEROUS_FOREST, BYGBiomes.CONIFEROUS_FOREST, BYGBiomes.DACITE_RIDGES, BYGBiomes.SKYRIS_VALE},
        {Biomes.MEADOW, Biomes.MEADOW, Biomes.MEADOW, Biomes.MEADOW, Biomes.DARK_FOREST},
        {Biomes.SAVANNA_PLATEAU, Biomes.SAVANNA_PLATEAU, BYGBiomes.RED_OAK_FOREST, Biomes.FOREST, BYGBiomes.GUIANA_SHIELD},
        {Biomes.BADLANDS, Biomes.BADLANDS, Biomes.BADLANDS, Biomes.WOODED_BADLANDS, Biomes.WOODED_BADLANDS}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES_4 = create("plateau_biomes/plateau_biomes_4", PLATEAU_BIOMES_LAYOUT, new ResourceKey[][]{
        {Biomes.SNOWY_PLAINS, Biomes.SNOWY_PLAINS, Biomes.SNOWY_PLAINS, Biomes.SNOWY_TAIGA, Biomes.SNOWY_TAIGA},
        {Biomes.MEADOW, BYGBiomes.WEEPING_WITCH_FOREST, BYGBiomes.CONIFEROUS_FOREST, BYGBiomes.AUTUMNAL_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA},
        {Biomes.MEADOW, Biomes.MEADOW, Biomes.MEADOW, Biomes.MEADOW, Biomes.DARK_FOREST},
        {Biomes.SAVANNA_PLATEAU, Biomes.SAVANNA_PLATEAU, BYGBiomes.RED_OAK_FOREST, Biomes.FOREST, Biomes.JUNGLE},
        {Biomes.BADLANDS, Biomes.BADLANDS, Biomes.BADLANDS, Biomes.WOODED_BADLANDS, Biomes.WOODED_BADLANDS}
    });
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES_5 = create("plateau_biomes/plateau_biomes_5", PLATEAU_BIOMES_LAYOUT, new ResourceKey[][]{
        {Biomes.SNOWY_PLAINS, BYGBiomes.FROSTED_CONIFEROUS_FOREST, Biomes.SNOWY_PLAINS, Biomes.SNOWY_TAIGA, Biomes.SNOWY_TAIGA},
        {BYGBiomes.FROSTED_CONIFEROUS_FOREST, BYGBiomes.FROSTED_CONIFEROUS_FOREST, BYGBiomes.CONIFEROUS_FOREST, BYGBiomes.ROSE_FIELDS, BYGBiomes.SKYRIS_VALE},
        {Biomes.MEADOW, Biomes.MEADOW, Biomes.MEADOW, Biomes.MEADOW, Biomes.DARK_FOREST},
        {Biomes.SAVANNA_PLATEAU, Biomes.SAVANNA_PLATEAU, Biomes.FOREST, BYGBiomes.EBONY_WOODS, Biomes.JUNGLE},
        {Biomes.BADLANDS, Biomes.BADLANDS, Biomes.BADLANDS, Biomes.WOODED_BADLANDS, Biomes.WOODED_BADLANDS}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES_7 = create("plateau_biomes/plateau_biomes_7", PLATEAU_BIOMES_LAYOUT, new ResourceKey[][]{
        {Biomes.SNOWY_PLAINS, Biomes.SNOWY_PLAINS, Biomes.SNOWY_PLAINS, Biomes.SNOWY_TAIGA, Biomes.SNOWY_TAIGA},
        {Biomes.MEADOW, Biomes.MEADOW, BYGBiomes.CONIFEROUS_FOREST, BYGBiomes.AUTUMNAL_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA},
        {Biomes.MEADOW, Biomes.MEADOW, Biomes.MEADOW, Biomes.MEADOW, Biomes.DARK_FOREST},
        {Biomes.SAVANNA_PLATEAU, Biomes.SAVANNA_PLATEAU, Biomes.FOREST, BYGBiomes.TROPICAL_RAINFOREST, BYGBiomes.GUIANA_SHIELD},
        {Biomes.BADLANDS, Biomes.BADLANDS, Biomes.BADLANDS, Biomes.WOODED_BADLANDS, Biomes.WOODED_BADLANDS}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES_VARIANT = create("plateau_biomes_variant/plateau_biomes_variant_1", PLATEAU_BIOMES_VARIANT_LAYOUT, new ResourceKey[][]{
        {Biomes.ICE_SPIKES, BYGBiomes.BOREALIS_GROVE, BYGBiomes.FROSTED_TAIGA, BYGBiomes.CARDINAL_TUNDRA, Biomes.THE_VOID},
        {BYGBiomes.FROSTED_CONIFEROUS_FOREST, BYGBiomes.FROSTED_CONIFEROUS_FOREST, BYGBiomes.CONIFEROUS_FOREST, Biomes.MEADOW, BYGBiomes.BOREALIS_GROVE},
        {Biomes.THE_VOID, Biomes.THE_VOID, BYGBiomes.GROVE, Biomes.BIRCH_FOREST, BYGBiomes.REDWOOD_THICKET},
        {Biomes.THE_VOID, Biomes.THE_VOID, Biomes.THE_VOID, BYGBiomes.TROPICAL_RAINFOREST, BYGBiomes.GUIANA_SHIELD},
        {Biomes.ERODED_BADLANDS, Biomes.ERODED_BADLANDS, BYGBiomes.SIERRA_BADLANDS, BYGBiomes.SIERRA_BADLANDS, BYGBiomes.SIERRA_BADLANDS}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES_VARIANT_2 = create("plateau_biomes_variant/plateau_biomes_variant_2", PLATEAU_BIOMES_VARIANT_LAYOUT, new ResourceKey[][]{
        {Biomes.ICE_SPIKES, BYGBiomes.BOREALIS_GROVE, BYGBiomes.FROSTED_CONIFEROUS_FOREST, Biomes.THE_VOID, Biomes.THE_VOID},
        {BYGBiomes.BOREALIS_GROVE, BYGBiomes.BOREALIS_GROVE, Biomes.MEADOW, BYGBiomes.MAPLE_TAIGA, Biomes.OLD_GROWTH_PINE_TAIGA},
        {Biomes.THE_VOID, Biomes.THE_VOID, Biomes.FOREST, Biomes.BIRCH_FOREST, Biomes.THE_VOID},
        {Biomes.THE_VOID, Biomes.THE_VOID, Biomes.THE_VOID, BYGBiomes.TROPICAL_RAINFOREST, BYGBiomes.TROPICAL_RAINFOREST},
        {Biomes.ERODED_BADLANDS, Biomes.ERODED_BADLANDS, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY}
    });
