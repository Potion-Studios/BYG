...
public class BYGOverworldBiomeSelectors {
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PEAK_BIOMES_1 = create("peak_biomes/peak_biomes_1", PEAK_BIOMES_LAYOUT, new ResourceKey[][]{
            {BYGBiomes.SHATTERED_GLACIER, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS},
            {BYGBiomes.SHATTERED_GLACIER, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS},
            {BYGBiomes.SHATTERED_GLACIER, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS},
            {BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS, BYGBiomes.HOWLING_PEAKS, BYGBiomes.GUIANA_SHIELD},
            {BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.SIERRA_BADLANDS, BYGBiomes.SIERRA_BADLANDS, BYGBiomes.SIERRA_BADLANDS}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> SLOPE_BIOMES_1 = create("slope_biomes/slope_biomes_1", SLOPE_BIOMES_LAYOUT, new ResourceKey[][]{
            {BYGBiomes.SHATTERED_GLACIER, BYGBiomes.HOWLING_PEAKS, BYGBiomes.CANADIAN_SHIELD, BYGBiomes.TWILIGHT_MEADOW, BYGBiomes.BOREALIS_GROVE},
            {BYGBiomes.SHATTERED_GLACIER, BYGBiomes.HOWLING_PEAKS, BYGBiomes.CANADIAN_SHIELD, BYGBiomes.TWILIGHT_MEADOW, BYGBiomes.BOREALIS_GROVE},
            {BYGBiomes.SHATTERED_GLACIER, BYGBiomes.HOWLING_PEAKS, BYGBiomes.CANADIAN_SHIELD, BYGBiomes.TWILIGHT_MEADOW, BYGBiomes.BOREALIS_GROVE},
            {BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.REDWOOD_THICKET, BYGBiomes.REDWOOD_THICKET, BYGBiomes.GUIANA_SHIELD},
            {BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.SIERRA_BADLANDS, BYGBiomes.SIERRA_BADLANDS, BYGBiomes.SIERRA_BADLANDS}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> MIDDLE_BIOMES_1 = create("middle_biomes/middle_biomes_1", MIDDLE_BIOMES_LAYOUT, new ResourceKey[][]{
            {BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.FROSTED_CONIFEROUS_FOREST, BYGBiomes.CONIFEROUS_FOREST},
            {BYGBiomes.AUTUMNAL_VALLEY, BYGBiomes.AUTUMNAL_VALLEY, BYGBiomes.SKYRIS_VALE, BYGBiomes.SKYRIS_VALE, BYGBiomes.CIKA_WOODS},
            {BYGBiomes.PRAIRIE, BYGBiomes.ALLIUM_FIELDS, BYGBiomes.ALLIUM_FIELDS, BYGBiomes.RED_OAK_FOREST, BYGBiomes.TEMPERATE_RAINFOREST},
            {BYGBiomes.ARAUCARIA_SAVANNA, BYGBiomes.ARAUCARIA_SAVANNA, BYGBiomes.AMARANTH_FIELDS, BYGBiomes.EBONY_WOODS, BYGBiomes.JACARANDA_FOREST},
            {BYGBiomes.MOJAVE_DESERT, BYGBiomes.MOJAVE_DESERT, BYGBiomes.WINDSWEPT_DESERT, BYGBiomes.ATACAMA_DESERT, BYGBiomes.ATACAMA_DESERT}
    });
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> MIDDLE_BIOMES_2 = create("middle_biomes/middle_biomes_2", MIDDLE_BIOMES_LAYOUT, new ResourceKey[][]{
            {BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.FROSTED_TAIGA, BYGBiomes.FROSTED_TAIGA, BYGBiomes.AUTUMNAL_TAIGA},
            {BYGBiomes.COCONINO_MEADOW, BYGBiomes.COCONINO_MEADOW, BYGBiomes.MAPLE_TAIGA, BYGBiomes.AUTUMNAL_FOREST, BYGBiomes.AUTUMNAL_FOREST},
            {BYGBiomes.PRAIRIE, BYGBiomes.ORCHARD, BYGBiomes.ORCHARD, BYGBiomes.ASPEN_FOREST, BYGBiomes.WEEPING_WITCH_FOREST},
            {BYGBiomes.BAOBAB_SAVANNA, BYGBiomes.BAOBAB_SAVANNA, BYGBiomes.RED_OAK_FOREST, BYGBiomes.CRAG_GARDENS, BYGBiomes.TROPICAL_RAINFOREST},
            {BYGBiomes.MOJAVE_DESERT, BYGBiomes.MOJAVE_DESERT, BYGBiomes.WINDSWEPT_DESERT, BYGBiomes.ATACAMA_DESERT, BYGBiomes.ATACAMA_DESERT}
    });
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> MIDDLE_BIOMES_3 = create("middle_biomes/middle_biomes_3", MIDDLE_BIOMES_LAYOUT, new ResourceKey[][]{
            {BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.FROSTED_CONIFEROUS_FOREST, BYGBiomes.FROSTED_TAIGA, BYGBiomes.BLACK_FOREST},
            {BYGBiomes.COCONINO_MEADOW, BYGBiomes.COCONINO_MEADOW, BYGBiomes.MAPLE_TAIGA, BYGBiomes.ZELKOVA_FOREST, BYGBiomes.DACITE_RIDGES},
            {BYGBiomes.PRAIRIE, BYGBiomes.PRAIRIE, BYGBiomes.ALLIUM_FIELDS, BYGBiomes.ASPEN_FOREST, BYGBiomes.TEMPERATE_RAINFOREST},
            {BYGBiomes.FIRECRACKER_SHRUBLAND, BYGBiomes.FIRECRACKER_SHRUBLAND,  BYGBiomes.AMARANTH_FIELDS, BYGBiomes.FORGOTTEN_FOREST, BYGBiomes.FRAGMENT_FOREST},
            {BYGBiomes.MOJAVE_DESERT, BYGBiomes.MOJAVE_DESERT, BYGBiomes.WINDSWEPT_DESERT, BYGBiomes.ATACAMA_DESERT, BYGBiomes.ATACAMA_DESERT}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES_1 = create("plateau_biomes/plateau_biomes_1", PLATEAU_BIOMES_LAYOUT, new ResourceKey[][]{
            {BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.FROSTED_CONIFEROUS_FOREST, BYGBiomes.FROSTED_TAIGA, BYGBiomes.CONIFEROUS_FOREST},
            {BYGBiomes.COCONINO_MEADOW, BYGBiomes.COCONINO_MEADOW, BYGBiomes.ASPEN_FOREST, BYGBiomes.SKYRIS_VALE, BYGBiomes.SKYRIS_VALE},
            {BYGBiomes.GROVE, BYGBiomes.GROVE, BYGBiomes.GROVE, BYGBiomes.ROSE_FIELDS, BYGBiomes.DACITE_RIDGES},
            {BYGBiomes.BAOBAB_SAVANNA, BYGBiomes.BAOBAB_SAVANNA, BYGBiomes.TEMPERATE_RAINFOREST, BYGBiomes.EBONY_WOODS, BYGBiomes.JACARANDA_FOREST},
            {BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.SIERRA_BADLANDS, BYGBiomes.SIERRA_BADLANDS}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES_2 = create("plateau_biomes/plateau_biomes_2", PLATEAU_BIOMES_LAYOUT, new ResourceKey[][]{
            {BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.FROSTED_CONIFEROUS_FOREST, BYGBiomes.FROSTED_TAIGA, BYGBiomes.CONIFEROUS_FOREST},
            {BYGBiomes.COCONINO_MEADOW, BYGBiomes.COCONINO_MEADOW, BYGBiomes.BLACK_FOREST, BYGBiomes.BLACK_FOREST, BYGBiomes.AUTUMNAL_TAIGA},
            {BYGBiomes.CHERRY_BLOSSOM_FOREST, BYGBiomes.CHERRY_BLOSSOM_FOREST, BYGBiomes.CHERRY_BLOSSOM_FOREST, BYGBiomes.ROSE_FIELDS, BYGBiomes.WEEPING_WITCH_FOREST},
            {BYGBiomes.ARAUCARIA_SAVANNA, BYGBiomes.ARAUCARIA_SAVANNA, BYGBiomes.RED_OAK_FOREST, BYGBiomes.EBONY_WOODS, BYGBiomes.TROPICAL_RAINFOREST},
            {BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.SIERRA_BADLANDS, BYGBiomes.SIERRA_BADLANDS}
    });
    ...
    protected static final Wrapped<List<List<ResourceKey<Biome>>>> PLATEAU_BIOMES_3 = create("plateau_biomes/plateau_biomes_3", PLATEAU_BIOMES_LAYOUT, new ResourceKey[][]{
            {BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.CARDINAL_TUNDRA, BYGBiomes.FROSTED_CONIFEROUS_FOREST, BYGBiomes.FROSTED_TAIGA, BYGBiomes.CONIFEROUS_FOREST},
            {BYGBiomes.COCONINO_MEADOW, BYGBiomes.COCONINO_MEADOW, BYGBiomes.CIKA_WOODS, BYGBiomes.CIKA_WOODS, BYGBiomes.AUTUMNAL_TAIGA},
            {BYGBiomes.GROVE, BYGBiomes.GROVE, BYGBiomes.GROVE, BYGBiomes.ROSE_FIELDS, BYGBiomes.WEEPING_WITCH_FOREST},
            {BYGBiomes.FIRECRACKER_SHRUBLAND, BYGBiomes.FIRECRACKER_SHRUBLAND, BYGBiomes.REDWOOD_THICKET, BYGBiomes.EBONY_WOODS, BYGBiomes.FORGOTTEN_FOREST},
            {BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.RED_ROCK_VALLEY, BYGBiomes.SIERRA_BADLANDS, BYGBiomes.SIERRA_BADLANDS}
    });
