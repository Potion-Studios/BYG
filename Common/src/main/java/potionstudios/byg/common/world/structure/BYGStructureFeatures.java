...
public class BYGStructureFeatures {
    ...
    public static final RegistrationProvider<ConfiguredStructureFeature<?, ?>> PROVIDER = RegistrationProvider.get(BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE, BYG.MOD_ID);
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> RED_ROCK_ARCH = register("red_rock_arch", () -> BYGStructureFeature.ARCH.get().configured(Util.make(new ArchConfiguration.Builder(), builder -> {
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> OVERGROWN_STONE_ARCH = register("overgrown_stone_arch", () -> BYGStructureFeature.ARCH.get().configured(Util.make(new ArchConfiguration.Builder(), builder -> {
        WeightedStateProvider blockProvider = new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder()
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> STONE_ARCH = register("stone_arch", () -> BYGStructureFeature.ARCH.get().configured(Util.make(new ArchConfiguration.Builder(), builder -> {
        WeightedStateProvider blockProvider = new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder()
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> DESTROYED_RED_ROCK_ARCH = register("destroyed_red_rock_arch", () -> BYGStructureFeature.ARCH.get().configured(Util.make(new ArchConfiguration.Builder(), builder -> {
        WeightedStateProvider blockProvider = new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder()
            .add(BYGBlocks.RED_ROCK.defaultBlockState(), 4)
            .add(Blocks.TERRACOTTA.defaultBlockState(), 1)
        );
