...
public class BYGPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> SHULKREN_PLANTS = createPlacedFeature("shulkren_plants", BYGEndVegetationFeatures.SHULKREN_PLANTS, () -> worldSurfaceSquaredWithCount(5));
    public static final ResourceKey<PlacedFeature> SHULKREN_HANGING_VINES = createPlacedFeature("shulkren_hanging_vines", BYGEndVegetationFeatures.HANGING_SHULKREN_VINE, () -> CountPlacement.of(6), () -> HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top()));
    ...
    public static final ResourceKey<PlacedFeature> SHULKREN_TREES = createPlacedFeature("shulkren_trees", BYGEndVegetationFeatures.SHULKREN_TREES, () -> treePlacement(PlacementUtils.countExtra(1, 0.2F, 2)));
    ...
    public static final ResourceKey<PlacedFeature> FROST_MAGMA_LAKE = createPlacedFeature("frost_magma_lake", BYGOverworldFeatures.FROST_MAGMA_LAKE, () -> worldSurfaceSquaredWithCount(3));
...
//    public static final ResourceKey<PlacedFeature> BRIMSTONE_VENTS = createPlacedFeature("brimstone_vents", BYGNetherFeatures.BRIMSTONE_VENTS, CountOnEveryLayerPlacement () -> .of(4), BiomeFilter::biome);
    ...
    public static final ResourceKey<PlacedFeature> FROST_MAGMA_PILLARS = createPlacedFeature("frost_magma_pillars", BYGNetherFeatures.FROST_MAGMA_PILLARS, () -> CountPlacement.of(10), InSquarePlacement::spread, () -> PlacementUtils.FULL_RANGE, BiomeFilter::biome);
    ...
    public static final ResourceKey<PlacedFeature> SUBZERO_CRYSTALS = createPlacedFeature("subzero_crystals", BYGNetherFeatures.SUBZERO_CRYSTAL, () -> CountOnEveryLayerPlacement.of(35), BiomeFilter::biome);
    ...
    public static final ResourceKey<PlacedFeature> SUBZERO_ASHES = createPlacedFeature("subzero_ashes", BYGNetherFeatures.SUBZERO_ASHES, () -> CountOnEveryLayerPlacement.of(4), BiomeFilter::biome);
