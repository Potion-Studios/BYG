...
public class BYGPlacedFeatures {
    ...
    public static final PlacedFeature THERIUM_DEPOSIT = createPlacedFeature("therium_deposit", BYGEndFeatures.THERIUM_CRYSTAL_DEPOSIT_LARGE.placed(new ImmutableList.Builder<PlacementModifier>().addAll(worldSurfaceSquaredWithCount(1)).add(RarityFilter.onAverageOnceEvery(65)).build()));
    ...
    public static final PlacedFeature DEAD_ETHER_TREES = createPlacedFeature("dead_ether_trees", BYGEndVegetationFeatures.DEAD_ETHER_TREES.placed(CountPlacement.of(7), HeightRangePlacement.uniform(VerticalAnchor.absolute(200), VerticalAnchor.absolute(256)), PlacementUtils.HEIGHTMAP, RarityFilter.onAverageOnceEvery(2)));
    public static final PlacedFeature THERIUM_CRYSTAL_DEPOSIT = createPlacedFeature("therium_crystal_deposit", BYGEndFeatures.THERIUM_CRYSTAL_DEPOSIT.placed(CountPlacement.of(255), HeightRangePlacement.uniform(VerticalAnchor.absolute(200), VerticalAnchor.absolute(256))));
    ...
    public static final PlacedFeature LARGE_BOULDERS = createPlacedFeature("large_boulders", BYGOverworldFeatures.LARGE_BOULDER.placed(oceanFloorSquaredWithCount(1, RarityFilter.onAverageOnceEvery(2))));
    public static final PlacedFeature LARGE_GRANITE_BOULDERS = createPlacedFeature("large_granite_boulders", BYGOverworldFeatures.LARGE_GRANITE_BOULDER.placed(oceanFloorSquaredWithCount(1, RarityFilter.onAverageOnceEvery(2))));
    ...
    public static final PlacedFeature ISLANDS = createPlacedFeature("islands", BYGEndFeatures.ISLANDS.placed(CountPlacement.of(1), RarityFilter.onAverageOnceEvery(6), HeightRangePlacement.uniform(VerticalAnchor.absolute(200), VerticalAnchor.absolute(230))));
