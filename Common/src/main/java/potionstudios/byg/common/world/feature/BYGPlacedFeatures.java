...
public class BYGPlacedFeatures {
    ...
    public static final PlacedFeature ARAUCARIA_TREES = createPlacedFeature("araucaria_trees", BYGConfiguredFeatures.ARAUCARIA_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.25F, 2))));
    public static final PlacedFeature ASPEN_SHRUBS = createPlacedFeature("aspen_shrubs", BYGConfiguredFeatures.ASPEN_SHRUBS.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.25F, 2))));
    public static final PlacedFeature ASPEN_TREES = createPlacedFeature("aspen_trees", BYGConfiguredFeatures.ASPEN_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(6, 0.25F, 3))));
    public static final PlacedFeature ASPEN_TREES_SPARSE = createPlacedFeature("aspen_trees_sparse", BYGConfiguredFeatures.ASPEN_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.25F, 1))));
    public static final PlacedFeature BAOBAB_TREES = createPlacedFeature("baobab_trees", BYGConfiguredFeatures.BAOBAB_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.25F, 1))));
    public static final PlacedFeature BOREAL_TREES = createPlacedFeature("boreal_trees", BYGConfiguredFeatures.BOREAL_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(4, 0.2F, 2))));
    public static final PlacedFeature BAYOU_TREES = createPlacedFeature("bayou_trees", BYGConfiguredFeatures.BAYOU_TREES.placed(clearingTreePlacementBaseOceanFloor(PlacementUtils.countExtra(4, 0.2F, 2))));
    public static final PlacedFeature BLACK_FOREST_TREES = createPlacedFeature("black_forest_trees", BYGConfiguredFeatures.BLACK_FOREST_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(8, 0.2F, 2))));
    public static final PlacedFeature CANADIAN_SHIELD_TREES = createPlacedFeature("canadian_shield_trees", BYGConfiguredFeatures.CANADIAN_SHIELD_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(4, 0.25F, 2))));
    public static final PlacedFeature CHERRY_TREES = createPlacedFeature("cherry_trees", BYGConfiguredFeatures.CHERRY_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(6, 0.25F, 2))));
    public static final PlacedFeature CIKA_TREES = createPlacedFeature("cika_trees", BYGConfiguredFeatures.CIKA_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(2, 0.25F, 2))));
    public static final PlacedFeature CONIFER_TREES = createPlacedFeature("conifer_trees", BYGConfiguredFeatures.CONIFER_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(7, 0.25F, 3))));
    public static final PlacedFeature CYPRESS_TREES = createPlacedFeature("cypress_trees", BYGConfiguredFeatures.CYPRESS_TREES.placed(clearingTreePlacementBaseOceanFloor(PlacementUtils.countExtra(4, 0.25F, 1))));
    public static final PlacedFeature DACITE_RIDGE_TREES = createPlacedFeature("dacite_ridge_trees", BYGConfiguredFeatures.DACITE_RIDGE_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.25F, 2))));
    public static final PlacedFeature DECIDUOUS_TREES = createPlacedFeature("deciduous_trees", BYGConfiguredFeatures.DECIDUOUS_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(3, 0.25F, 2))));
    public static final PlacedFeature EBONY_TREES = createPlacedFeature("ebony_trees", BYGConfiguredFeatures.EBONY_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(4, 0.25F, 4))));
    public static final PlacedFeature ENCHANTED_TREES = createPlacedFeature("enchanted_trees", BYGConfiguredFeatures.ENCHANTED_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(5, 0.2F, 2))));
    public static final PlacedFeature TEMPERATE_GROVE_TREES = createPlacedFeature("temperate_grove_trees", BYGConfiguredFeatures.TEMPERATE_GROVE_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.25F, 2))));
    public static final PlacedFeature JACARANDA_TREES = createPlacedFeature("jacaranda_trees", BYGConfiguredFeatures.JACARANDA_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(4, 0.2F, 2))));
    ...
    public static final PlacedFeature JOSHUA_TREES = createPlacedFeature("joshua_tree", BYGConfiguredFeatures.JOSHUA_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.2F, 2))));
    public static final PlacedFeature MANGROVE_TREES = createPlacedFeature("mangrove_trees", BYGConfiguredFeatures.MANGROVE_TREES.placed(clearingTreePlacementBaseOceanFloor(PlacementUtils.countExtra(6, 0.25F, 2))));
    public static final PlacedFeature MAPLE_TREES = createPlacedFeature("maple_trees", BYGConfiguredFeatures.MAPLE_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(4, 0.25F, 2))));
    ...
    public static final PlacedFeature RED_OAK_TREES = createPlacedFeature("red_oak_trees", BYGConfiguredFeatures.RED_OAK_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.2F, 1))));
    public static final PlacedFeature ORANGE_OAK_TREES = createPlacedFeature("orange_oak_trees", BYGConfiguredFeatures.ORANGE_OAK_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.2F, 1))));
    public static final PlacedFeature BROWN_OAK_TREES = createPlacedFeature("brown_oak_trees", BYGConfiguredFeatures.BROWN_OAK_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.2F, 1))));
    ...
    public static final PlacedFeature AUTUMNAL_SPRUCE_TREES = createPlacedFeature("autumnal_spruce_trees", BYGConfiguredFeatures.AUTUMNAL_SPRUCE_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(4, 0.2F, 1))));
    public static final PlacedFeature PRAIRIE_SHRUBS = createPlacedFeature("prairie_shrubs", BYGConfiguredFeatures.PRAIRIE_SHRUBS.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.25F, 2))));
    public static final PlacedFeature GUIANA_SHIELD_TREES = createPlacedFeature("guiana_shield_trees", BYGConfiguredFeatures.GUIANA_SHIELD_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(15, 0.25F, 1))));
    public static final PlacedFeature RAINFOREST_TREES = createPlacedFeature("rainforest_trees", BYGConfiguredFeatures.RAINFOREST_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(15, 0.25F, 1))));
    public static final PlacedFeature REDWOOD_TREES = createPlacedFeature("redwood_trees", BYGConfiguredFeatures.REDWOOD_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.25F, 2))));
    public static final PlacedFeature FRAGMENT_FOREST_TREES = createPlacedFeature("fragment_forest_trees", BYGConfiguredFeatures.FRAGMENT_FOREST_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(2, 0.25F, 2))));
    public static final PlacedFeature SKYRIS_TREES = createPlacedFeature("skyris_trees", BYGConfiguredFeatures.SKYRIS_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.25F, 2))));
    public static final PlacedFeature RED_SPRUCE_TREES_SPARSE = createPlacedFeature("sparse_red_spruce_trees", BYGConfiguredFeatures.RED_SPRUCE_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.25F, 1))));
    public static final PlacedFeature BLUE_SPRUCE_TREES = createPlacedFeature("blue_spruce_trees", BYGConfiguredFeatures.BLUE_SPRUCE_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(2, 0.1F, 1))));
    public static final PlacedFeature SPRUCE_TREES_SPARSE = createPlacedFeature("sparse_spruce_trees", BYGConfiguredFeatures.SPRUCE_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.2F, 1))));
    public static final PlacedFeature BROWN_ZELKOVA_TREES = createPlacedFeature("brown_zelkova_trees", BYGConfiguredFeatures.BROWN_ZELKOVA_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.25F, 2))));
    public static final PlacedFeature ZELKOVA_TREES = createPlacedFeature("zelkova_trees", BYGConfiguredFeatures.ZELKOVA_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(5, 0.2F, 2))));
    public static final PlacedFeature TEMPERATE_RAINFOREST_TREES = createPlacedFeature("temperate_rainforest_trees", BYGConfiguredFeatures.TEMPERATE_RAINFOREST_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(1, 0.25F, 1))));
    public static final PlacedFeature MEADOW_TREES = createPlacedFeature("meadow_trees", BYGConfiguredFeatures.MEADOW_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(2, 0.25F, 3))));
    public static final PlacedFeature MEADOW_TREES_SPARSE = createPlacedFeature("sparse_meadow_trees", BYGConfiguredFeatures.MEADOW_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.25F, 1))));
    ...
    public static final PlacedFeature MEADOW_SHRUBS = createPlacedFeature("meadow_shrubs", BYGConfiguredFeatures.MEADOW_SHRUBS.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.25F, 2))));
    public static final PlacedFeature FIRECRACKER_SHRUBS = createPlacedFeature("firecracker_shrubs", BYGConfiguredFeatures.FIRECRACKER_SHRUBS.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.25F, 2))));

    public static final PlacedFeature SPARSE_RED_OAK_TREES = createPlacedFeature("sparse_red_oak_trees", BYGConfiguredFeatures.RED_OAK_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.2F, 1))));

    public static final PlacedFeature SPARSE_JACARANDA_TREES = createPlacedFeature("sparse_jacaranda_trees", BYGConfiguredFeatures.JACARANDA_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.2F, 2))));
    public static final PlacedFeature SPARSE_ARAUCARIA_TREES = createPlacedFeature("sparse_araucaria_trees", BYGConfiguredFeatures.ARAUCARIA_TREES.placed(clearingTreePlacement(PlacementUtils.countExtra(0, 0.2F, 3))));
