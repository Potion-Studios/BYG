...
public class BYGPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> HAZEL_TREES = createPlacedFeature("hazel_trees", BYGOverworldTreeFeatures.WITCH_HAZEL_TREES, () -> clearingTreePlacement(PlacementUtils.countExtra(1, 0.25F, 2)));
