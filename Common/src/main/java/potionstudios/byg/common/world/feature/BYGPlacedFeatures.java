...
public class BYGPlacedFeatures {
    ...
    public static final PlacedFeature TINY_LILY_PAD = createPlacedFeature("tiny_lily_pad", BYGOverworldVegetationFeatures.TINY_LILY_PAD.placed(CountPlacement.of(20), InSquarePlacement.spread(), HeightmapPlacement.onHeightmap(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES), BiomeFilter.biome()));
    public static final PlacedFeature LILY_PAD = createPlacedFeature("lily_pad", VegetationFeatures.PATCH_WATERLILY.placed(CountPlacement.of(20), InSquarePlacement.spread(), HeightmapPlacement.onHeightmap(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES), BiomeFilter.biome()));
