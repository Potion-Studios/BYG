...
public class BYGPlacedFeatures {
    ...
    public static final PlacedFeature GROVE = createPlacedFeature("grove_trees", BYGConfiguredFeatures.GROVE_TREES.placed(treePlacement(PlacementUtils.countExtra(1, 0.25F, 2))));
