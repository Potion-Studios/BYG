...
//    public static final PlacedFeature BRIMSTONE_VENTS = createPlacedFeature("brimstone_vents", BYGNetherFeatures.BRIMSTONE_VENTS.placed(CountOnEveryLayerPlacement.of(4), BiomeFilter.biome()));
    ...
    public static final PlacedFeature SUBZERO_CRYSTALS = createPlacedFeature("subzero_crystals", BYGNetherFeatures.SUBZERO_CRYSTAL.placed(CountOnEveryLayerPlacement.of(35), BiomeFilter.biome()));
    ...
    public static final PlacedFeature EMBUR_MUSHROOMS = createPlacedFeature("embur_mushrooms", BYGNetherVegetationFeatures.EMBUR_MUSHROOMS.placed(CountOnEveryLayerPlacement.of(3), BiomeFilter.biome()));
    ...
    public static final PlacedFeature SOUL_SHROOM_TREES = createPlacedFeature("soul_shroom_trees", BYGNetherVegetationFeatures.SOUL_SHROOM_TREES.placed(CountOnEveryLayerPlacement.of(8), BiomeFilter.biome()));
    ...
    public static final PlacedFeature DEATH_CAP_TREES = createPlacedFeature("death_cap_trees", BYGNetherVegetationFeatures.DEATH_CAP_TREES.placed(CountOnEveryLayerPlacement.of(6), BiomeFilter.biome()));
