...
public class BYGPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> BAYOU_TREES = createPlacedFeature("bayou_trees", BYGOverworldTreeFeatures.BAYOU_TREES, () -> treePlacementBaseOceanFloor(PlacementUtils.countExtra(10, 0.2F, 5)));
