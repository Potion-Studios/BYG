...
public class BYGItems {
    ...
    public static final RegistryObject<Item> WHITE_PUFFBALL_STEW = createItem(() -> new StackableBowlFoodItem(new Properties().tab(BYGCreativeTab.CREATIVE_TAB).food(new FoodProperties.Builder().nutrition(9).saturationMod(1.0f).build())), "white_puffball_stew");
