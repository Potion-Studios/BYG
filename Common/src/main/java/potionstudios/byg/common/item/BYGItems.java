...
public class BYGItems {
    ...
    public static final Item CATTAIL_SPROUT = createItem(new CampfireExplodingBlockItem(BYGBlocks.CATTAIL_SPROUT, "byg.cattail_campfire", new Item.Properties().tab(BYGCreativeTab.CREATIVE_TAB)), BYGBlocks.CATTAIL_SPROUT);
