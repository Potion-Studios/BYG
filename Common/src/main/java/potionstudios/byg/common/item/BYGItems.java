...
public class BYGItems {
    ...
    public static final RegistryObject<Item> EMBUR_LILY = createItem(() -> new WaterLilyBlockItem(BYGBlocks.EMBUR_LILY.get(), new Properties().tab(BYGCreativeTab.CREATIVE_TAB)), "embur_lily");
    ...
    public static final RegistryObject<Item> ENDER_LILY = createItem(() -> new WaterLilyBlockItem(BYGBlocks.ENDER_LILY.get(), new Properties().tab(BYGCreativeTab.CREATIVE_TAB)), "ender_lily");
