...
public class BYGScaffoldingBlock extends ScaffoldingBlock implements SimpleWaterloggedBlock {
    ...
    @Override
    public void tick(@NotNull BlockState $$0, @NotNull ServerLevel $$1, @NotNull BlockPos $$2, @NotNull RandomSource $$3) {
    ...
    @Override
    public void onPlace(@NotNull BlockState $$0, Level $$1, @NotNull BlockPos $$2, @NotNull BlockState $$3, boolean $$4) {
        if (!$$1.isClientSide) {
