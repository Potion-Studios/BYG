...
public class BYGBlockTags {
    ...
    public static final TagKey<Block> GROUND_MANGROVE_TREE = createDesertPlantTag("may_place_on/mangrove_tree");
    ...
    public static final TagKey<Block> GROUND_MANGROVE_SAPLING = createPlantTag("may_place_on/mangrove_sapling");
