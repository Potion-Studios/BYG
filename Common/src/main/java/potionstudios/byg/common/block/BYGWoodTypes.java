...
public enum BYGWoodTypes {
    ...
    BAOBAB("baobab", new Builder()
            ...
            .materialColor(MaterialColor.TERRACOTTA_GREEN).leavesFactory(id -> BYGBlocks.createFruitLeaves(MaterialColor.COLOR_GREEN, () -> BYGBlocks.BAOBAB_FRUIT_BLOCK.defaultBlockState().setValue(FruitBlock.AGE, 0), id, 0.01F))),
