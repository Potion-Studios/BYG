...
public interface StructuresAccess {
    ...
    @Invoker("structure")
    static Structure.StructureSettings structure(TagKey<Biome> p_236539_, GenerationStep.Decoration p_236540_, TerrainAdjustment p_236541_) {
        throw new Error("Mixin did not apply!");
    }

    @Invoker("structure")
    static Structure.StructureSettings structure(TagKey<Biome> p_236543_, TerrainAdjustment p_236544_) {
        throw new Error("Mixin did not apply!");
    }
}
