...
//                registerItem(BYGItemList.PENDORITE_HORSE_ARMOR = new BYGHorseArmor(7, "pendorite", (new Item.Settings()).maxStackSize(1).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_horse_armor");
