...
//                registerItem(BYGItemList.AMETRINE_AXE = new AxeItem(BYGItemTiers.AMETRINE, 3, -2.4F, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("ametrine_axe");
//                registerItem(BYGItemList.AMETRINE_PICK = new PickaxeItem(BYGItemTiers.AMETRINE, 3, -2.4F, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("ametrine_pickaxe");
//                registerItem(BYGItemList.AMETRINE_SWORD = new SwordItem(BYGItemTiers.AMETRINE, 3, -2.4F, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("ametrine_sword");
//                registerItem(BYGItemList.AMETRINE_BATTLEAXE = new AxeItem(BYGItemTiers.AMETRINE, 3, -2.4F, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("ametrine_battleaxe");
//                registerItem(BYGItemList.AMETRINE_HOE = new HoeItem(BYGItemTiers.AMETRINE, 3, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("ametrine_hoe");
//                registerItem(BYGItemList.AMETRINE_HELMET = new ArmorItem(BYGArmorTiers.AMETRINE, EquipmentSlotType.HEAD, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("ametrine_helmet");
...
//                registerItem(BYGItemList.AMETRINE_HORSE_ARMOR = new BYGHorseArmor(7, "ametrine", (new Item.Settings()).maxCount(1).group(BYG.BYG_TAB)), Registry.BLOCK.getId("ametrine_horse_armor");
...
//                registerItem(BYGItemList.PENDORITE_AXE = new AxeItem(BYGItemTiers.PENDORITE, 6.0f, -3.0F, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_axe");
//                registerItem(BYGItemList.PENDORITE_PICK = new PickaxeItem(BYGItemTiers.PENDORITE, 2, -2.8F, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_pickaxe");
//                registerItem(BYGItemList.PENDORITE_SWORD = new SwordItem(BYGItemTiers.PENDORITE, 4, -2.4F, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_sword");
//                registerItem(BYGItemList.PENDORITE_BATTLEAXE = new AxeItem(BYGItemTiers.PENDORITE, 9.0f, -3.3F, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_battleaxe");
//                registerItem(BYGItemList.PENDORITE_HOE = new HoeItem(BYGItemTiers.PENDORITE, 0.5f, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_hoe");
//                registerItem(BYGItemList.PENDORITE_HELMET = new ArmorItem(BYGArmorTiers.PENDORITE, EquipmentSlotType.HEAD, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_helmet");
//                registerItem(BYGItemList.PENDORITE_CHEST = new ArmorItem(BYGArmorTiers.PENDORITE, EquipmentSlotType.CHEST, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_chestplate");
//                registerItem(BYGItemList.PENDORITE_LEGGINGS = new ArmorItem(BYGArmorTiers.PENDORITE, EquipmentSlotType.LEGS, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_leggings");
//                registerItem(BYGItemList.PENDORITE_BOOTS = new ArmorItem(BYGArmorTiers.PENDORITE, EquipmentSlotType.FEET, (new Item.Settings()).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_boots");
...
//                registerItem(BYGItemList.PENDORITE_HORSE_ARMOR = new BYGHorseArmor(7, "pendorite", (new Item.Settings()).maxCount(1).group(BYG.BYG_TAB)), Registry.BLOCK.getId("pendorite_horse_armor");
