...
public class BYGConfiguredFeatures {
    ...
    public static ConfiguredFeature<?, ?> WHITE_SANDSTONE_BOULDER = newConfiguredFeature("white_sandstone_boulder", BYGFeatureList.STACKABLE_BOULDERS.withConfiguration(new BYGBoulderFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlockList.WHITE_SANDSTONE.getDefaultState(), 3).addWeightedBlockstate(BYGBlockList.WHITE_SANDSTONE.getDefaultState(), 2).addWeightedBlockstate(BYGBlockList.WHITE_SMOOTH_SANDSTONE.getDefaultState(), 3).addWeightedBlockstate(BYGBlockList.WHITE_SAND.getDefaultState(), 5)).setMinStackHeight(7).setMaxHeight(12).setMinRadius(13).setMaxRadius(20).build()).withPlacement(AtOceanFloorWithExtra.OCEANFLOOR.configure(new AtSurfaceWithExtraConfig(0, 0.08F, 1))));
