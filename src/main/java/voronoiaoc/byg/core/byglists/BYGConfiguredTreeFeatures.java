...
//    public static final ConfiguredFeature<?, ?> ACACIA_TREE1 = newConfiguredFeature("acacia_tree1", BYGFeatureList.ACACIA_TREE1.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG));
    ...
    public static final ConfiguredFeature<?, ?> RED_MUSHROOM_MINI = newConfiguredFeature("mini_red_mushroom", BYGFeatureList.MINI_RED_MUSHROOM.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.MUSHROOM_STEM).setMushroomBlock(Blocks.RED_MUSHROOM_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<?, ?> BROWN_MUSHROOM_MINI = newConfiguredFeature("mini_brown_mushroom", BYGFeatureList.MINI_BROWN_MUSHROOM.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.MUSHROOM_STEM).setMushroomBlock(Blocks.BROWN_MUSHROOM_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
