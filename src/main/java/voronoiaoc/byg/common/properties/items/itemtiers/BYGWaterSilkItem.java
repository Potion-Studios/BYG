package voronoiaoc.byg.common.properties.items.itemtiers;//package voronoiaoc.byg.common.properties.items.itemtiers;
//
//
...
//    public BYGWaterSilkItem(Block blockIn, AbstractBlock.Settings builder) {
...
//                if ((ifluidstate.getFluid() == Fluids.WATER || material == Material.ICE) && worldIn.isAir
//                        (blockpos1)) {
//
//                    // special case for handling block Decorator with water lilies
