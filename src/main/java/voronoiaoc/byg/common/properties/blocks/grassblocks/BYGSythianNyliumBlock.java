...
public class BYGSythianNyliumBlock extends SpreadableSythianBlock implements BonemealableBlock {
    ...
    public void performBonemeal(ServerLevel world, Random rand, BlockPos blockPos, BlockState state) {
        ...
        BlockState blockstate = BYGBlockList.SYTHIAN_ROOTS.defaultBlockState();
