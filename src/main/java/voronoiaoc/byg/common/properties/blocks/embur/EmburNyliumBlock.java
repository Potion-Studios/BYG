...
public class EmburNyliumBlock extends SpreadableEmburBlock implements Fertilizable {
    public EmburNyliumBlock(AbstractBlock.Settings properties) {
        super(properties);
    }
    ...
    public void grow(ServerWorld world, Random rand, BlockPos blockPos, BlockState state) {
        ...
        BlockState blockstate = BYGBlockList.EMBUR_ROOTS.getDefaultState();
