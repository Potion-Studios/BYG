...
public class EmburNyliumBlock extends SpreadableEmburBlock implements BonemealableBlock {
    public EmburNyliumBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    public void performBonemeal(ServerLevel world, Random rand, BlockPos blockPos, BlockState state) {
        ...
        BlockState blockstate = BYGBlockList.EMBUR_ROOTS.defaultBlockState();
