...
public class OvergrownNetherrackBlock extends SpreadableOvergrownNetherrackBlock implements BonemealableBlock {
    public OvergrownNetherrackBlock(Properties properties) {
        super(properties);
    }
    ...
    public void performBonemeal(ServerLevel world, Random rand, BlockPos blockPos, BlockState state) {
        ...
        BlockState blockstate = BYGBlockList.WEED_GRASS.defaultBlockState();
