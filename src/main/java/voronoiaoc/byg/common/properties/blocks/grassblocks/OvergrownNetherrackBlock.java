...
public class OvergrownNetherrackBlock extends SpreadableOvergrownNetherrackBlock implements Fertilizable {
    public OvergrownNetherrackBlock(Settings properties) {
        super(properties);
    }
