...
public class BYGOverGrownStoneBlock extends SpreadableSnowyOvergrownStoneBlock implements Fertilizable {
    public BYGOverGrownStoneBlock(Settings properties) {
        super(properties);
    }
