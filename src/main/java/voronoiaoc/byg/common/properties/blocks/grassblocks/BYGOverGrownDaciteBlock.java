...
public class BYGOverGrownDaciteBlock extends SpreadableSnowyOvergrownDaciteBlock implements Fertilizable {
    public BYGOverGrownDaciteBlock(Settings properties) {
        super(properties);
    }
