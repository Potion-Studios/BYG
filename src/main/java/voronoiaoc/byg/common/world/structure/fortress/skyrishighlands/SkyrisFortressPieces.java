...
//
//      public Corridor(int p_i45615_1_, Random p_i45615_2_, BlockBox p_i45615_3_, Direction p_i45615_4_) {
//         super(StructurePieceType.NESCLT, p_i45615_1_);
...
//         super(StructurePieceType.NESCLT, nbt);
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175879_2_, p_175879_3_, p_175879_4_, -1, 0, 0, 5, 7, 5, direction);
//         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(structurePieceList, mutableboundingbox) == null ? new Corridor(p_175879_6_, rand, mutableboundingbox, direction) : null;
//      }
//
//      public boolean create(IWorld world, ChunkGenerator<?> chunkGenerator, Random rand, BlockBox mutable, ChunkPos chunkPos) {
...
//      private boolean chest;
//
//      public Corridor2(int p_i45613_1_, Random p_i45613_2_, BlockBox p_i45613_3_, Direction p_i45613_4_) {
//         super(StructurePieceType.NESCRT, p_i45613_1_);
...
//         super(StructurePieceType.NESCRT, p_i50266_2_);
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175876_2_, p_175876_3_, p_175876_4_, -1, 0, 0, 5, 7, 5, p_175876_5_);
...
//         super(StructurePieceType.NECCS, p_i50280_1_);
...
//         super(StructurePieceType.NECCS, p_i50281_2_);
//      }
//
//      /**
//       * Initiates construction of the Structure Component picked, at the current Location of StructGen
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175883_1_, p_175883_2_, p_175883_3_, -1, -7, 0, 5, 14, 10, p_175883_4_);
...
//      }
//
//      public boolean create(IWorld world, ChunkGenerator<?> chunkGen, Random rand, BlockBox mutable, ChunkPos chunkPos) {
...
//         super(StructurePieceType.NECTB, p_i50277_1_);
...
//         super(StructurePieceType.NECTB, p_i50278_2_);
//      }
//
//      /**
//       * Initiates construction of the Structure Component picked, at the current Location of StructGen
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_214814_1_, p_214814_2_, p_214814_3_, -3, 0, 0, 9, 7, 9, direction);
//         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(structurePieceList, mutableboundingbox) == null ? new Corridor4(p_214814_5_, mutableboundingbox, direction) : null;
//      }
//
//      public boolean create(IWorld world, ChunkGenerator<?> chunkGen, Random rand, BlockBox mutable, ChunkPos p_225577_5_) {
...
//         super(StructurePieceType.NESC, p_i50268_1_);
...
//         super(StructurePieceType.NESC, p_i50269_2_);
//      }
//
//      /**
//       * Initiates construction of the Structure Component picked, at the current Location of StructGen
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175877_1_, p_175877_2_, p_175877_3_, -1, 0, 0, 5, 7, 5, p_175877_4_);
...
//      }
//
//      public boolean create(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, BlockBox p_225577_4_, ChunkPos p_225577_5_) {
...
//         super(StructurePieceType.NERC, p_i50258_1_);
...
//         super(StructurePieceType.NERC, p_i50259_2_);
//      }
//
//      /**
//       * Initiates construction of the Structure Component picked, at the current Location of StructGen
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175873_1_, p_175873_2_, p_175873_3_, -2, 0, 0, 7, 9, 7, p_175873_4_);
...
//         super(StructurePieceType.NESCSC, p_i50273_1_);
...
//         super(StructurePieceType.NESCSC, p_i50274_2_);
//      }
//
//      /**
//       * Initiates construction of the Structure Component picked, at the current Location of StructGen
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175878_1_, p_175878_2_, p_175878_3_, -1, 0, 0, 5, 7, 5, p_175878_4_);
...
//         super(StructurePieceType.NEBCR, p_i50286_1_);
...
//         super(StructurePieceType.NEBCR, 0);
...
//         this(StructurePieceType.NEBCR, p_i50288_2_);
//      }
//
//      /**
//       * Initiates construction of the Structure Component picked, at the current Location of StructGen
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175885_1_, p_175885_2_, p_175885_3_, -8, -3, 0, 19, 10, 19, p_175885_4_);
...
//         super(StructurePieceType.NEBEF, p_i45621_1_);
...
//         super(StructurePieceType.NEBEF, p_i50285_2_);
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175884_2_, p_175884_3_, p_175884_4_, -1, -3, 0, 5, 10, 8, p_175884_5_);
...
//      public Entrance(int p_i45617_1_, Random p_i45617_2_, BlockBox p_i45617_3_, Direction p_i45617_4_) {
//         super(StructurePieceType.NECE, p_i45617_1_);
...
//         super(StructurePieceType.NECE, p_i50276_2_);
//      }
//
//      /**
//       * Initiates construction of the Structure Component picked, at the current Location of StructGen
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175881_2_, p_175881_3_, p_175881_4_, -5, -3, 0, 13, 14, 13, p_175881_5_);
...
//      public NetherStalkRoom(int p_i50264_1_, BlockBox p_i50264_2_, Direction p_i50264_3_) {
//         super(StructurePieceType.NECSR, p_i50264_1_);
//         this.setCoordBaseMode(p_i50264_3_);
//         this.boundingBox = p_i50264_2_;
//      }
//
//      public NetherStalkRoom(StructureManager p_i50265_1_, CompoundTag p_i50265_2_) {
//         super(StructurePieceType.NECSR, p_i50265_2_);
//      }
//
//      /**
//       * Initiates construction of the Structure Component picked, at the current Location of StructGen
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175875_1_, p_175875_2_, p_175875_3_, -5, -3, 0, 13, 14, 13, p_175875_4_);
...
//         super(StructurePieceType.NESR, p_i50255_1_);
...
//         super(StructurePieceType.NESR, p_i50256_2_);
//      }
//
//      /**
//       * Initiates construction of the Structure Component picked, at the current Location of StructGen
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175872_1_, p_175872_2_, p_175872_3_, -2, 0, 0, 7, 11, 7, p_175872_5_);
...
//
//         for(PieceWeight fortresspieces$pieceweight : SkyrisFortressPieces.PRIMARY_COMPONENTS) {
...
//
//         for(PieceWeight fortresspieces$pieceweight1 : SkyrisFortressPieces.SECONDARY_COMPONENTS) {
...
//         super(StructurePieceType.NESTART, p_i50253_2_);
//      }
//   }
//
...
//         super(StructurePieceType.NEBS, p_i45620_1_);
...
//         super(StructurePieceType.NEBS, p_i50283_2_);
//      }
//
//      /**
//       * Initiates construction of the Structure Component picked, at the current Location of StructGen
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175882_2_, p_175882_3_, p_175882_4_, -1, -3, 0, 5, 10, 19, p_175882_5_);
...
//
//      public Throne(int p_i50262_1_, BlockBox p_i50262_2_, Direction p_i50262_3_) {
//         super(StructurePieceType.NEMT, p_i50262_1_);
...
//         super(StructurePieceType.NEMT, p_i50263_2_);
...
//         BlockBox mutableboundingbox = BlockBox.getComponentToAddBoundingBox(p_175874_1_, p_175874_2_, p_175874_3_, -2, 0, 0, 7, 8, 9, p_175874_5_);
