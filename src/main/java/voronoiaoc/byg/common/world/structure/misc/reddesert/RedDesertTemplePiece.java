...
public class RedDesertTemplePiece extends StructurePieceWithDimensions {
    ...
    public RedDesertTemplePiece(StructureManager p_i51351_1_, CompoundTag p_i51351_2_) {
        super(StructurePieceType.DESERT_TEMPLE, p_i51351_2_);
    ...
    public boolean generate(ServerWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
        ...
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 10, 0, 7, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 10, 0, 8, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 9, 0, 9, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 11, 0, 9, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 8, 0, 10, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 12, 0, 10, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 7, 0, 10, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 13, 0, 10, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 9, 0, 11, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 11, 0, 11, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 10, 0, 12, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 10, 0, 13, boundingBox);
        ...
        for (int l1 = 0; l1 <= this.width - 1; l1 += this.width - 1) {
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), l1, 2, 1, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), l1, 2, 2, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), l1, 2, 3, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), l1, 3, 1, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), l1, 3, 2, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), l1, 3, 3, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), l1, 4, 1, boundingBox);
            this.addBlock(world, Blocks.CHISELED_RED_SANDSTONE.getDefaultState(), l1, 4, 2, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), l1, 4, 3, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), l1, 5, 1, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), l1, 5, 2, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), l1, 5, 3, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), l1, 6, 1, boundingBox);
            this.addBlock(world, Blocks.CHISELED_RED_SANDSTONE.getDefaultState(), l1, 6, 2, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), l1, 6, 3, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), l1, 7, 1, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), l1, 7, 2, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), l1, 7, 3, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), l1, 8, 1, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), l1, 8, 2, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), l1, 8, 3, boundingBox);
        }

        for (int i2 = 2; i2 <= this.width - 3; i2 += this.width - 3 - 2) {
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), i2 - 1, 2, 0, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), i2, 2, 0, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), i2 + 1, 2, 0, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), i2 - 1, 3, 0, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), i2, 3, 0, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), i2 + 1, 3, 0, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), i2 - 1, 4, 0, boundingBox);
            this.addBlock(world, Blocks.CHISELED_RED_SANDSTONE.getDefaultState(), i2, 4, 0, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), i2 + 1, 4, 0, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), i2 - 1, 5, 0, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), i2, 5, 0, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), i2 + 1, 5, 0, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), i2 - 1, 6, 0, boundingBox);
            this.addBlock(world, Blocks.CHISELED_RED_SANDSTONE.getDefaultState(), i2, 6, 0, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), i2 + 1, 6, 0, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), i2 - 1, 7, 0, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), i2, 7, 0, boundingBox);
            this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), i2 + 1, 7, 0, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), i2 - 1, 8, 0, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), i2, 8, 0, boundingBox);
            this.addBlock(world, Blocks.CUT_RED_SANDSTONE.getDefaultState(), i2 + 1, 8, 0, boundingBox);
        }
        ...
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 9, 5, 0, boundingBox);
        this.addBlock(world, Blocks.CHISELED_RED_SANDSTONE.getDefaultState(), 10, 5, 0, boundingBox);
        this.addBlock(world, Blocks.BLUE_TERRACOTTA.getDefaultState(), 11, 5, 0, boundingBox);
        this.fillWithOutline(world, boundingBox, 8, -14, 8, 12, -11, 12, Blocks.CUT_RED_SANDSTONE.getDefaultState(), Blocks.CUT_RED_SANDSTONE.getDefaultState(), false);
        ...
        for (Direction direction : Direction.Type.HORIZONTAL) {
            if (!this.hasPlacedChest[direction.getHorizontal()]) {
                int i1 = direction.getOffsetX() * 2;
                int j1 = direction.getOffsetZ() * 2;
                this.hasPlacedChest[direction.getHorizontal()] = this.addChest(world, boundingBox, random, 10 + i1, -11, 10 + j1, LootTables.DESERT_PYRAMID_CHEST);
            }
        }
