...
public class CragGardens extends SurfaceBuilder<TernarySurfaceConfig> {
    public CragGardens(Codec<TernarySurfaceConfig> p_i51310_1_) {
        super(p_i51310_1_);
    }
    ...
    protected void buildSurface(Random random, Chunk chunkIn, Biome biomeIn, int xStart, int zStart, int landHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, BlockState topBlock, BlockState middleBlock, BlockState bottomBlock, int seaLevel) {
        int x = xStart & 15;
        int z = zStart & 15;
