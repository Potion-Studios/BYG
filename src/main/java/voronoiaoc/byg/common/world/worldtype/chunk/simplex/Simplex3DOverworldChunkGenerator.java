...
//
//public class Simplex3DOverworldChunkGenerator extends Simplex3DNoiseChunkGenerator<OverworldGenSettings> {
...
//
//    public Simplex3DOverworldChunkGenerator(IWorld world, BiomeProvider provider, OverworldGenSettings settings) {
