...
//            return (rand.random(islandChance + 2) == 0) ? Registry.BIOME.getOrThrowId(getTropIslandBiome().pickBiome(rand)) : centre;
//        }
//        if (ClimateBooleans.isDeepFrozenOcean(centre)) {
//            return (rand.random(islandChance + 2) == 0) ? Registry.BIOME.getOrThrowId(getSnowyIslandBiome().pickBiome(rand)) : centre;
//        }
//        if (ClimateBooleans.isDeepLukeWarmOcean(centre)) {
//            return (rand.random(islandChance + 2) == 0) ? Registry.BIOME.getOrThrowId(getTemperateIslandBiome().pickBiome(rand)) : centre;
//        }
//        return centre;
//    }
//
