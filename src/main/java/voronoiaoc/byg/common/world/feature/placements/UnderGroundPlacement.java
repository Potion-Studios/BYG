...
public class UnderGroundPlacement extends FeatureDecorator<FrequencyWithExtraChanceDecoratorConfiguration> {

    public static final FeatureDecorator<FrequencyWithExtraChanceDecoratorConfiguration> UGPLACER = BiomeHelper.newDecorator("underground_count_extra_decorator", new UnderGroundPlacement(FrequencyWithExtraChanceDecoratorConfiguration.CODEC));

    public UnderGroundPlacement(Codec<FrequencyWithExtraChanceDecoratorConfiguration> codec) {
        super(codec);
    }
