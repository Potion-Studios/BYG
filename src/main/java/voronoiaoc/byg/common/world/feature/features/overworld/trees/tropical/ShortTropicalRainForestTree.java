...
public class ShortTropicalRainForestTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public ShortTropicalRainForestTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
