...
public class SkyrisTree2 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public SkyrisTree2(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
        ...
        if (posY >= 1 && posY + randTreeHeight + 1 < 256) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), Blocks.GRASS_BLOCK)) {
                ...
                for (int buildTrunk = 0; buildTrunk < randTreeHeight; ++buildTrunk) {
                    ...
                    this.treelog(changedBlocks, worldIn, blockpos2.south(2).east().above(), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.south(2).east().above(2), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.south().east(), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.south().east().below(), boundsIn);

                    this.treelog(changedBlocks, worldIn, blockpos2.south(3).east().above(3).west(), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.south(4).east().above(3).west(), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.south(5).east().above(4), boundsIn);


                    this.treelog(changedBlocks, worldIn, blockpos2.south().east(2).above(3), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.south().east(2).above(4), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.south().east(2).above(5), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.south().east(3).above(5), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.south(2).east(4).above(6), boundsIn);

                    this.treelog(changedBlocks, worldIn, blockpos2.above(6), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.east().above(6), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.north().above(7), boundsIn);
