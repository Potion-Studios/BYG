...
public class BlueEnchantedGroveTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    //Blocks used for the tree.
    private static final BlockState LOG = BYGBlockList.BLUE_ENCHANTED_LOG.defaultBlockState();
    private static final BlockState LEAVES = BYGBlockList.BLUE_ENCHANTED_LEAVES.defaultBlockState();
    private static final BlockState LEAVES2 = BYGBlockList.BLUE_ENCHANTED_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();

    public BlueEnchantedGroveTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
