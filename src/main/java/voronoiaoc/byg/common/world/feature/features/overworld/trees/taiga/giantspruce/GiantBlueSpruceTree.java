...
public class GiantBlueSpruceTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    //BYGBlockRenders used for the tree.
    private static final BlockState LOG = Blocks.SPRUCE_LOG.defaultBlockState();
    private static final BlockState LEAVES = BYGBlockList.BLUE_SPRUCE_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();

    public GiantBlueSpruceTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
