...
public class BlueGlowshroom2Huge extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public BlueGlowshroom2Huge(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
