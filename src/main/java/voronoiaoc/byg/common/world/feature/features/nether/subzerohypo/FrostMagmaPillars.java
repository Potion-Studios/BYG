package voronoiaoc.byg.common.world.feature.features.nether.subzerohypo;
...
public class FrostMagmaPillars extends Feature<NoFeatureConfig> {
    public FrostMagmaPillars(Codec<NoFeatureConfig> p_i231926_1_) {
        super(p_i231926_1_);
    }
