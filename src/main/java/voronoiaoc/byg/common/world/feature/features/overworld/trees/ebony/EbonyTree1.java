...
public class EbonyTree1 extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public EbonyTree1(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, IWorldGenerationReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            ...
            if (!isDesiredGround(worldIn, blockpos, Blocks.GRASS_BLOCK)) {
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(7, randTreeHeight + 7, -5), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(8, randTreeHeight + 7, -4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(8, randTreeHeight + 7, -3), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(6, randTreeHeight + 8, -4), boundsIn);
