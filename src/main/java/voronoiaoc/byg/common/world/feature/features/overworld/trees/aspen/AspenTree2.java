...
.HORIZONTAL.random(rand);
    ...
    //Log Placement
    private void placeLog(Set<BlockPos> setlogblock, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
    ...
    //Leaves Placement
    private void placeLeaf(ISeedReader reader, int x, int y, int z, MutableBoundingBox boundingBox, Set<BlockPos> blockPos) {
