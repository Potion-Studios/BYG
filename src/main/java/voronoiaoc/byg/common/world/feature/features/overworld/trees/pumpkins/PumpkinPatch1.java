...
public class PumpkinPatch1 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    //Blocks used for the tree.
    private static final BlockState LOG = Blocks.PUMPKIN.defaultBlockState();
    ...
    public PumpkinPatch1(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
