    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 10, -8), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 10, -8), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-8, 15, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-8, 15, 1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(7, 15, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(7, 15, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(8, 15, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(8, 15, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(8, 15, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(8, 15, 1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 18, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(5, 18, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-8, 22, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-8, 22, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-8, 22, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-8, 22, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-8, 22, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-8, 22, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-7, 22, -5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-7, 22, -4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-6, 22, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-6, 22, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-5, 22, -6), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-4, 22, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-4, 22, 6), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-4, 22, 7), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 28, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 28, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 28, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 28, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 28, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 28, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 28, 0), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 28, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 28, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 28, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 28, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(5, 28, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(5, 28, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(5, 28, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(5, 28, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(5, 28, 3), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 29, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 29, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 29, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 29, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(5, 29, 0), boundsIn);
            }
        }
        return true;
    }
