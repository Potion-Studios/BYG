...
public class WillowDeadTree1 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public WillowDeadTree1(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, WorldGenLevel worldIn, Random rand, BlockPos pos, BoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(3, 0, -1), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight + 2, -4), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(5, randTreeHeight + 2, 1), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight + 3, -3), boundsIn);
