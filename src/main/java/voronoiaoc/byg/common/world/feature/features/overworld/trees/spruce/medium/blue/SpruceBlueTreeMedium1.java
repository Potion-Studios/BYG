...
public class SpruceBlueTreeMedium1 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceBlueTreeMedium1(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
