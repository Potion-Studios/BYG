...
public class BlueEnchantedTree1 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public BlueEnchantedTree1(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, WorldGenLevel worldIn, Random rand, BlockPos pos, BoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight - 9, 0), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight - 8, 1), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 7, 2), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight - 6, -3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight - 6, -2), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 6, 0), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 6, 3), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 5, 3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 5, 3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 5, 4), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 4, 5), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 3, 1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight - 3, 3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(3, randTreeHeight - 3, 3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 3, 4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 3, 5), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 2, 1), boundsIn);
    ...
    private void treeLog(Set<BlockPos> setlogblock, WorldGenLevel reader, BlockPos pos, BoundingBox boundingBox) {
        if (canLogPlaceHere(reader, pos)) {
            this.setFinalBlockState(setlogblock, reader, pos, BYGBlockList.BLUE_ENCHANTED_LOG.defaultBlockState(), boundingBox);
        }
    }
    ...
    private void leafs(Set<BlockPos> blockPos, WorldGenLevel reader, BlockPos pos, BoundingBox boundingBox) {
        ...
        if (isAir(reader, blockpos)) {
            this.setFinalBlockState(blockPos, reader, blockpos, BYGBlockList.BLUE_ENCHANTED_LEAVES.defaultBlockState(), boundingBox);
        }
    }
