...
public class TallBlueSpruceTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public TallBlueSpruceTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
