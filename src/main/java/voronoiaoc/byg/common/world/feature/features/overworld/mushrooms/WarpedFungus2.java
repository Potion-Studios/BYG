...
public class WarpedFungus2 extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public WarpedFungus2(Codec<NoFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    public boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, blockpos, BYGBlockList.OVERGROWN_CRIMSON_BLACKSTONE)) {
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 8, 1), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-6, 9, 1), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-6, 9, 2), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-3, 9, -4), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-2, 9, -5), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 9, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 9, 2), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(5, 9, -1), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(5, 9, 0), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-6, 10, 1), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-6, 10, 2), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-3, 10, -5), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-2, 10, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 10, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 10, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 10, 4), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-1, 10, -1), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-1, 10, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 10, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 10, 4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 10, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 10, 5), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(2, 10, 6), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 10, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 10, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 10, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 10, 0), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 10, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 10, 3), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(5, 10, -1), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(5, 10, 0), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-4, 11, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-4, 11, 4), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-3, 11, 3), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-3, 11, 4), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-2, 11, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 11, 5), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-2, 11, 6), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-1, 11, 6), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(0, 11, -5), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(1, 11, -5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 11, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 11, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 11, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 11, 5), boundsIn);
                ...
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(3, 11, 2), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(3, 11, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 11, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 11, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 11, -3), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 11, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 11, 4), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-4, 12, 4), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-2, 12, 5), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-1, 12, 6), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(0, 12, -4), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(1, 12, -5), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(3, 12, 3), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(4, 12, 2), boundsIn);
            }
        }
        return true;
    }
