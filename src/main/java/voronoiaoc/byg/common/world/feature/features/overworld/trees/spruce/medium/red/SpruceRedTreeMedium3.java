package voronoiaoc.byg.common.world.feature.features.overworld.trees.spruce.medium.red;
...
public class SpruceRedTreeMedium3 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceRedTreeMedium3(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    private void leafs(Set<BlockPos> blockPos, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
        if (isAir(reader, pos)) {
            this.setFinalBlockState(blockPos, reader, pos, BYGBlockList.RED_SPRUCE_LEAVES.getDefaultState(), boundingBox);
        }
    }
