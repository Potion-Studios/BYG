...
public class SmallYellowTaigaTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public SmallYellowTaigaTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
