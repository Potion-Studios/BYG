...
public class TallOrangeSpruceTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public TallOrangeSpruceTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
