...
public class SpruceYellowTreeMedium2 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceYellowTreeMedium2(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
