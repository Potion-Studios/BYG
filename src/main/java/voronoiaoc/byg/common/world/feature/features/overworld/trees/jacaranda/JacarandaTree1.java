...
public class JacarandaTree1 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    private static final BlockState LOG = BYGBlockList.JACARANDA_LOG.defaultBlockState();
    private static final BlockState LEAVES = BYGBlockList.JACARANDA_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();

    public JacarandaTree1(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
