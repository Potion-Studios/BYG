...
public class OrangeBirchTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    //BYGBlockRenders used for the tree.
    private static final BlockState LOG = Blocks.BIRCH_LOG.defaultBlockState();
    private static final BlockState LEAVES = BYGBlockList.ORANGE_BIRCH_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();


    public OrangeBirchTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
