...
public class BlueGlowshroomHuge extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public BlueGlowshroomHuge(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn) {
        super(configIn);
    }
