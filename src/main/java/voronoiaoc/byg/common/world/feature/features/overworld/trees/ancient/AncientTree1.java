...
public class AncientTree1 extends BYGAbstractTreeFeature<DefaultFeatureConfig> {

    public AncientTree1(Codec<DefaultFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(7, 12, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 12, 4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(7, 12, 4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(6, 12, 7), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 21, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 21, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-6, 21, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-5, 21, 0), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 22, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 22, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 22, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 22, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 22, 0), boundsIn);
