package voronoiaoc.byg.common.world.feature.features.overworld.trees.spruce.medium.orange;
...
public class SpruceOrangeTreeMedium3 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceOrangeTreeMedium3(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeLog(LOG, changedBlocks, worldIn, mainmutable.add(0, 16, 0), boundsIn);
                placeLog(LOG, changedBlocks, worldIn, mainmutable.add(0, 17, 0), boundsIn);
                placeLog(LOG, changedBlocks, worldIn, mainmutable.add(0, 18, 0), boundsIn);
                placeLog(LOG, changedBlocks, worldIn, mainmutable.add(0, 19, 0), boundsIn);
                placeLog(LOG, changedBlocks, worldIn, mainmutable.add(0, 20, 0), boundsIn);
                placeLog(LOG, changedBlocks, worldIn, mainmutable.add(0, 21, 0), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-4, 16, 0), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(3, 17, 1), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(0, 23, 0), boundsIn);
            }
        }
        return true;
    }
    ...
    private void leafs(Set<BlockPos> blockPos, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
        if (isAir(reader, pos)) {
            this.setFinalBlockState(blockPos, reader, pos, BYGBlockList.ORANGE_SPRUCE_LEAVES.getDefaultState(), boundingBox);
        }
    }
