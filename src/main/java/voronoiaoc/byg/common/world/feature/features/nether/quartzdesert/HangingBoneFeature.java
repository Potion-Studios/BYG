package voronoiaoc.byg.common.world.feature.features.nether.quartzdesert;
...
public class HangingBoneFeature extends Feature<NoFeatureConfig> {
    private static final Direction[] field_236426_a_ = Direction.values();

    public HangingBoneFeature(Codec<NoFeatureConfig> p_i232004_1_) {
        super(p_i232004_1_);
    }
    ...
    private void func_236428_a_(IWorld p_236428_1_, Random p_236428_2_, BlockPos p_236428_3_) {
        p_236428_1_.setBlockState(p_236428_3_, Blocks.BONE_BLOCK.getDefaultState(), 2);
        ...
        for (int i = 0; i < 200; ++i) {
            ...
            if (p_236428_1_.isAirBlock(blockpos$mutable)) {
                ...
                if (j == 1) {
                    p_236428_1_.setBlockState(blockpos$mutable, Blocks.BONE_BLOCK.getDefaultState(), 2);
                }
            }
        }
        ...
        for (int i = 0; i < 100; ++i) {
            ...
            if (p_236429_1_.isAirBlock(blockpos$mutable)) {
                ...
                if (blockstate.isIn(BYGBlockList.QUARTZITE_SAND) || blockstate.isIn(Blocks.BONE_BLOCK)) {
                    ...
                    int k = 17;
                    int l = 25;
                    func_236427_a_(p_236429_1_, blockpos$mutable, j);
                }
            }
        }
    ...
    public static void func_236427_a_(IWorld p_236427_0_, BlockPos.Mutable p_236427_2_, int p_236427_3_) {
