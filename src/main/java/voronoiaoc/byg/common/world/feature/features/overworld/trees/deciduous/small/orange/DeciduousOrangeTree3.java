...
public class DeciduousOrangeTree3 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public DeciduousOrangeTree3(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        int randTreeHeight = 16 + rand.nextInt(5);
