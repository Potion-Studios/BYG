...
public class WillowTreeM1 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public WillowTreeM1(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, WorldGenLevel worldIn, Random rand, BlockPos pos, BoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-6, randTreeHeight - 2, -8), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight - 2, -8), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight - 2, -6), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight - 2, -6), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-6, randTreeHeight - 2, -4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight - 1, -8), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight - 1, -7), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight - 1, -6), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight + 2, -4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight - 4, -8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 4, -8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-8, randTreeHeight - 4, -6), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-6, randTreeHeight - 3, -9), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight - 3, -9), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight - 3, -8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 3, -8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-8, randTreeHeight - 3, -7), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight - 3, -4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-6, randTreeHeight - 2, -9), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight - 2, -9), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight - 2, -9), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight - 2, -8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight - 2, -8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 2, -8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-8, randTreeHeight - 2, -7), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 2, -7), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-6, randTreeHeight - 1, -9), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight - 1, -8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 1, -8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-8, randTreeHeight - 1, -7), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-6, randTreeHeight, -9), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight, -9), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight, -9), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight, -9), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight, -8), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight, -8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-8, randTreeHeight, -7), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight, -4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight + 1, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight + 1, -3), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight + 1, -2), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight + 2, -4), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight + 2, -3), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight + 2, -2), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 2, -2), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight + 3, -3), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight + 3, -1), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 4, -3), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight + 4, -1), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight + 4, 0), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 5, -3), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight + 5, 0), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 6, -3), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight + 6, 0), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 6, 1), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight + 7, -4), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 7, -4), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight + 7, -4), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight + 7, -3), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 7, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight + 7, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight + 7, -2), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 7, -2), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight + 7, -2), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 7, 1), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 8, -4), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight + 8, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 8, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight + 8, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 8, -2), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight + 8, 0), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 8, 0), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight + 8, 0), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight + 8, 1), boundsIn);
                this.stem(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 8, 1), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight + 8, 1), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight + 8, 2), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 8, 2), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight + 8, 2), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 9, -4), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight + 9, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 9, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight + 9, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 9, -2), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 9, 0), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight + 9, 1), boundsIn);
                ...
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 9, 2), boundsIn);
                ...
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight + 10, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 10, 0), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight + 10, 1), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 10, 1), boundsIn);
                ...
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 11, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 11, 0), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 11, 1), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 11, 2), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 12, -3), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 12, 1), boundsIn);
                this.glowshroom(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight + 13, 1), boundsIn);
            }
        }
        return true;
    }
    ...
    private void stem(Set<BlockPos> blockPos, WorldGenLevel reader, BlockPos pos, BoundingBox boundingBox) {
        ...
        if (isAir(reader, blockpos)) {
            this.setFinalBlockState(blockPos, reader, blockpos, BYGBlockList.RED_GLOWSHROOM_STEM.defaultBlockState(), boundingBox);
        }
    }
