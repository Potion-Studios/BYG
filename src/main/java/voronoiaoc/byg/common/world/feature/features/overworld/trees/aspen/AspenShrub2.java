...
public class AspenShrub2 extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public AspenShrub2(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
        super(configIn);
