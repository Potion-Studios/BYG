...
public class GiantRedSpruceTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    //BYGBlockRenders used for the tree.
    private static final BlockState LOG = Blocks.SPRUCE_LOG.defaultBlockState();
    private static final BlockState LEAVES = BYGBlockList.RED_SPRUCE_LEAVES.defaultBlockState();
    private static final BlockState LEAVES2 = BYGBlockList.RED_SPRUCE_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();

    public GiantRedSpruceTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
