...
public class BYGSaplingToTree {
    public static class BlueSpruceSaplingToTree extends BYGHugeTree {
        @Nullable
        public BYGAbstractTreeFeature<NoneFeatureConfiguration> getBigTreeFeature(Random random) {
            return BYGFeatureList.BLUE_GIANT_SPRUCE_TREE;
        }

        @Nullable
        public BYGAbstractTreeFeature<NoneFeatureConfiguration> getTreeFeature(Random random) {
