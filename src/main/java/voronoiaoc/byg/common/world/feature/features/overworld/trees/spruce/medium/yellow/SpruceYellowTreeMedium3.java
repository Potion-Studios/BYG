package voronoiaoc.byg.common.world.feature.features.overworld.trees.spruce.medium.yellow;
...
public class SpruceYellowTreeMedium3 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceYellowTreeMedium3(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
