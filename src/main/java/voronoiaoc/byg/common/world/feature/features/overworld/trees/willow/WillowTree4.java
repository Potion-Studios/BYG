...
public class WillowTree4 extends BYGAbstractTreeFeature<DefaultFeatureConfig> {

    public WillowTree4(Codec<DefaultFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getDimensionHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, blockpos, Blocks.GRASS_BLOCK)) {
                ...
                BlockPos.Mutable rootMutable2 = new BlockPos.Mutable().set(mainmutable.add(4, 0, 0));
                BlockPos.Mutable rootMutable3 = new BlockPos.Mutable().set(mainmutable.add(0, 0, -4));
                BlockPos.Mutable rootMutable4 = new BlockPos.Mutable().set(mainmutable.add(0, 0, 4));
