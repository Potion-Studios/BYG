...
public class TallRedSpruceTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public TallRedSpruceTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
