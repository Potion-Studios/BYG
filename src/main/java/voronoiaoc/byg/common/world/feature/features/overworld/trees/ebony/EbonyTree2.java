...
public class EbonyTree2 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public EbonyTree2(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, WorldGenLevel worldIn, Random rand, BlockPos pos, BoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight - 2, 0), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight - 2, 0), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 1, 5), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight + 1, 3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(5, randTreeHeight + 2, -4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight + 2, -3), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight + 3, 1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(6, randTreeHeight + 3, 2), boundsIn);
