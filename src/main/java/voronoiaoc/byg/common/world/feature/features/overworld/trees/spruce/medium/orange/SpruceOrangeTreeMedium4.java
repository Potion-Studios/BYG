...
public class SpruceOrangeTreeMedium4 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceOrangeTreeMedium4(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
