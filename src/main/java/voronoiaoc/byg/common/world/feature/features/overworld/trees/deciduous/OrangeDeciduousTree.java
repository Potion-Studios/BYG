...
public class OrangeDeciduousTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    private static final BlockState LOG = Blocks.OAK_LOG.defaultBlockState();
    private static final BlockState LEAVES = BYGBlockList.ORANGE_OAK_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();

    public OrangeDeciduousTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
