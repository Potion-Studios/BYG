...
public class AspenShrub extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public AspenShrub(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
        super(configIn);
