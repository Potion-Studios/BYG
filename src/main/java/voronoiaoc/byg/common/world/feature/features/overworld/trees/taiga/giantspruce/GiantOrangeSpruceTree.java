...
public class GiantOrangeSpruceTree extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {
    ...
    public GiantOrangeSpruceTree(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
