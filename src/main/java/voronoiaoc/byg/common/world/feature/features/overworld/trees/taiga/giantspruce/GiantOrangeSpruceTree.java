...
public class GiantOrangeSpruceTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    private static final BlockState LEAVES2 = BYGBlockList.ORANGE_SPRUCE_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();

    public GiantOrangeSpruceTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
