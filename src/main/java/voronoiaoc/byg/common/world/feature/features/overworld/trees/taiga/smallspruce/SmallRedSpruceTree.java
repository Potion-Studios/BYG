...
public class SmallRedSpruceTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    private static final BlockState LEAVES3 = BYGBlockList.RED_SPRUCE_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();

    public SmallRedSpruceTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
