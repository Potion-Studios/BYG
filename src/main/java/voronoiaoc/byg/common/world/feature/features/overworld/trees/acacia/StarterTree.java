...
public class StarterTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public StarterTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
        super(configIn);
