...
public class SpruceOrangeTreeLarge1 extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public SpruceOrangeTreeLarge1(Codec<NoFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 23, 1), boundsIn);
                this.treeLog(changedBlocks, worldIn, mainmutable.add(0, 23, 1), boundsIn);
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 24, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 25, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 26, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 27, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 28, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 29, 1), boundsIn);
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 30, 0), boundsIn);
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 30, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 31, 1), boundsIn);
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 32, 0), boundsIn);
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 32, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 33, 1), boundsIn);
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 34, 0), boundsIn);
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 34, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 35, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 36, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 37, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 38, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 39, 1), boundsIn);
                ...
                this.treeLog(changedBlocks, worldIn, mainmutable.add(-1, 40, 1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 25, 0), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 26, -5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 26, -4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 26, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 26, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 26, -3), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 26, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 26, 0), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 26, -5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 26, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 26, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 26, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 26, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 26, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 26, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 26, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 26, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 26, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 26, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 26, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 26, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 26, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 26, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 27, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 27, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 27, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 27, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 27, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 27, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 27, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 27, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 27, -5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 27, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 27, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 27, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 27, -1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 27, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 27, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 28, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 28, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 28, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 28, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 28, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 28, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 28, -5), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 28, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 28, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 28, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 28, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 28, -5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 28, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 28, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 28, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 28, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 28, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 28, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 28, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 28, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 28, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 28, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 28, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 28, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 28, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 28, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 28, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 28, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 28, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 29, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 29, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 29, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 29, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 29, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 29, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 29, -1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 29, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 30, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 30, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 30, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 30, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 30, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 30, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 30, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 30, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 30, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 30, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 30, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 30, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 30, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 30, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 30, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 30, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 30, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 30, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 30, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 30, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 30, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 30, -1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 30, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 30, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 30, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 30, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 31, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 31, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 31, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 31, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 31, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 31, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 31, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 31, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 31, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 31, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 31, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 31, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 31, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 31, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 31, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 31, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 31, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 31, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 31, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 31, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 31, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 32, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 32, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 32, -4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 32, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 32, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 32, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 32, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 32, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 32, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 32, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 32, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 32, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 32, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 32, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 33, -2), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 33, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 33, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 33, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 33, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 33, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 33, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 33, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 34, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 34, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 34, -4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 34, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 34, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 34, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 34, 0), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 35, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 35, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 35, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 35, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 35, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 35, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 36, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 36, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 36, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 36, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 37, -1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 39, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 40, -1), boundsIn);
            }
        }
        return true;
    }
