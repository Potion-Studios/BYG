...
public class IrisGiant extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public IrisGiant(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, WorldGenLevel worldIn, Random rand, BlockPos pos, BoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < 256) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), Blocks.GRASS_BLOCK)) {
                ...
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(0, 6, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(1, 6, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-2, 6, 0), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(-1, 6, 0), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(1, 6, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(2, 6, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-1, 6, 1), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(0, 6, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(1, 6, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(0, 6, 2), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(0, 7, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-1, 7, -2), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(0, 7, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(1, 7, -2), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(1, 7, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(2, 7, -1), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(-3, 7, 0), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(-2, 7, 0), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(2, 7, 0), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(3, 7, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-2, 7, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-1, 7, 1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(1, 7, 2), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(0, 7, 3), boundsIn);
                this.pollen(changedBlocks, worldIn, mainmutable.offset(0, 7, 0), boundsIn);
                this.pollen(changedBlocks, worldIn, mainmutable.offset(1, 7, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-1, 8, -3), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(0, 8, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(1, 8, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, 8, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(3, 8, -1), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(-3, 8, 0), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(3, 8, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, 8, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(3, 8, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-1, 8, 3), boundsIn);
                this.leafs2(changedBlocks, worldIn, mainmutable.offset(0, 8, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(1, 8, 3), boundsIn);
                this.pollen(changedBlocks, worldIn, mainmutable.offset(0, 8, 0), boundsIn);
    ...
    private void leafs(Set<BlockPos> blockPos, WorldGenLevel reader, BlockPos pos, BoundingBox boundingBox) {
        ...
        if (isAir(reader, blockpos)) {
            this.setFinalBlockState(blockPos, reader, blockpos, BYGBlockList.PURPLE_PETAL.defaultBlockState(), boundingBox);
        }
    }
