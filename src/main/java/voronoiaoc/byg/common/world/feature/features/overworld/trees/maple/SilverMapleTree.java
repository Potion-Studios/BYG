...
public class SilverMapleTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    private static final BlockState LEAVES = BYGBlockList.SILVER_MAPLE_LEAVES.getDefaultState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.getDefaultState();

    public SilverMapleTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
        super(configIn);
