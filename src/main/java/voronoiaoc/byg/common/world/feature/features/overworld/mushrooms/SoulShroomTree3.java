    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeStemBranch(STEM, worldIn, mainmutable.add(4, 12, -3));
                this.soulShroomSporeEnd(worldIn, mainmutable.add(5, 8, -5));
                this.soulShroomSporeEnd(worldIn, mainmutable.add(-5, 9, -4));
                this.soulShroomSporeEnd(worldIn, mainmutable.add(-4, 9, -2));
                this.soulShroomSporeEnd(worldIn, mainmutable.add(3, 9, -4));
                this.soulShroomSporeEnd(worldIn, mainmutable.add(4, 9, -1));
                this.soulShroomSpore(worldIn, mainmutable.add(5, 9, -5));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-4, 10, -5));
                ...
                this.soulShroomSporeEnd(worldIn, mainmutable.add(-1, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(1, 10, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(1, 10, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(1, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(2, 10, 1));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(2, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(2, 10, 5));
                this.soulShroomSpore(worldIn, mainmutable.add(3, 10, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 10, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 10, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 10, 5));
                this.soulShroomSpore(worldIn, mainmutable.add(4, 10, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 10, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 10, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 10, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 10, 5));
                this.soulShroomSpore(worldIn, mainmutable.add(5, 10, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 10, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 10, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 10, 4));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(2, 11, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(2, 11, 4));
                this.soulShroomSpore(worldIn, mainmutable.add(3, 11, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 11, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 11, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 11, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 11, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 11, 5));
                this.soulShroomSpore(worldIn, mainmutable.add(4, 11, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 11, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 11, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 11, 4));
                this.soulShroomSpore(worldIn, mainmutable.add(5, 11, -5));
                this.soulShroomSporeEnd(worldIn, mainmutable.add(5, 11, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 11, 3));
                this.soulShroomSporeEnd(worldIn, mainmutable.add(6, 11, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-5, 12, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-5, 12, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-4, 12, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-4, 12, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-4, 12, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-4, 12, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-4, 12, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-4, 12, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-3, 12, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-3, 12, -4));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-3, 12, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-3, 12, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-2, 12, -4));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 12, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 12, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 12, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 12, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 12, -2));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 12, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 12, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 12, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 12, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 12, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 12, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 12, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 12, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(6, 12, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(6, 12, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(6, 12, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-5, 13, 3));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-3, 13, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-3, 13, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-3, 13, 5));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 13, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 13, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 13, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 13, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 13, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 13, -2));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 13, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 13, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 13, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 13, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 13, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(6, 13, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-4, 14, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-4, 14, 3));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(6, 14, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-3, 15, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 15, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 15, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 15, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 15, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 15, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 15, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 15, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 15, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(5, 15, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-3, 16, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(4, 16, -3));
