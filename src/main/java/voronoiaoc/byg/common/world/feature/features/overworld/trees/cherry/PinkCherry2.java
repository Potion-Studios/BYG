...
public class PinkCherry2 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public PinkCherry2(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    private void leafs(Set<BlockPos> blockPos, WorldGenLevel reader, BlockPos pos, BoundingBox boundingBox) {
        ...
        if (isAir(reader, blockpos)) {
            this.setFinalBlockState(blockPos, reader, blockpos, BYGBlockList.PINK_CHERRY_LEAVES.defaultBlockState(), boundingBox);
        }
    }
