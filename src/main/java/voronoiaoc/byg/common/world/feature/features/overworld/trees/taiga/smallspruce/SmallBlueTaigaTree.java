...
public class SmallBlueTaigaTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public SmallBlueTaigaTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
