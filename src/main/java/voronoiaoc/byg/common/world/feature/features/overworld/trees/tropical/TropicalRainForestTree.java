...
//                    placeLog(LOG, changedBlocks, worldIn, blockpos2.west(2).up(1), boundsIn);
//                    placeLog(LOG, changedBlocks, worldIn, blockpos2.east(2).up(1), boundsIn);
//                    placeLog(LOG, changedBlocks, worldIn, blockpos2.north(2).up(1), boundsIn);
//                    placeLog(LOG, changedBlocks, worldIn, blockpos2.south(2).up(1), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.west(2).up(2), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.east(2).up(2), boundsIn);
                    ...
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.west(2).up(3), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.east(2).up(3), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.north(2).up(3), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.south(2).up(3), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.west(2).up(4), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.east(2).up(4), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.north(2).up(4), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.south(2).up(4), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.west(2).up(5), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.east(2).up(5), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.north(2).up(5), boundsIn);
                    placeLog(LOG, changedBlocks, worldIn, blockpos2.south(2).up(5), boundsIn);
                    if (rand.nextInt(4) == 2) {
