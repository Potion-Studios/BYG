...
public class MapleTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    private static final BlockState LEAVES = BYGBlockList.MAPLE_LEAVES.getDefaultState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.getDefaultState();

    public MapleTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
        super(configIn);
