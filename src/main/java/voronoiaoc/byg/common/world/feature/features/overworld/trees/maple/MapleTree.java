...
public class MapleTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public MapleTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    private void leafs(Set<BlockPos> blockPos, WorldGenLevel reader, BlockPos pos, BoundingBox boundingBox) {
        ...
        if (isAir(reader, blockpos)) {
            this.setFinalBlockState(blockPos, reader, blockpos, BYGBlockList.MAPLE_LEAVES.defaultBlockState(), boundingBox);
        }
    }
