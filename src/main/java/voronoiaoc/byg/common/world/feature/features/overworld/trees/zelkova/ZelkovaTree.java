...
public class ZelkovaTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public ZelkovaTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
        super(configIn);
    ...
    public boolean place(Set<BlockPos> changedBlocks, IWorldGenerationReader worldIn, Random rand, BlockPos position, MutableBoundingBox boundsIn) {
        ...
        int randTreeHeight = rand.nextInt(5) + 13;
        //Positions
