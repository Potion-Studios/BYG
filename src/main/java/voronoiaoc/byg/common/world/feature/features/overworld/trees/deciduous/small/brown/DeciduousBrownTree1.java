package voronoiaoc.byg.common.world.feature.features.overworld.trees.deciduous.small.brown;
...
public class DeciduousBrownTree1 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public DeciduousBrownTree1(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    private void leafs(Set<BlockPos> blockPos, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
        if (isAir(reader, pos)) {
            this.setFinalBlockState(blockPos, reader, pos, BYGBlockList.BROWN_OAK_LEAVES.getDefaultState(), boundingBox);
        }
    }
