...
public class GiantYellowSpruceTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    //BYGBlockRenders used for the tree.
    private static final BlockState LOG = Blocks.SPRUCE_LOG.defaultBlockState();
    private static final BlockState LEAVES = BYGBlockList.YELLOW_SPRUCE_LEAVES.defaultBlockState();
    private static final BlockState LEAVES2 = BYGBlockList.YELLOW_SPRUCE_LEAVES.defaultBlockState();
    private static final BlockState BEEHIVE = Blocks.BEEHIVE.defaultBlockState();

    public GiantYellowSpruceTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
