...
public class GiantYellowSpruceTree extends BYGAbstractTreeFeature<DefaultFeatureConfig> {
    ...
    public GiantYellowSpruceTree(Codec<DefaultFeatureConfig> configIn) {
        super(configIn);
