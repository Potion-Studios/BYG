...
public class ColorfulDeciduousShrubs extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {
    ...
    public ColorfulDeciduousShrubs(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
