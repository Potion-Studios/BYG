...
public class SpruceYellowTreeMedium1 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceYellowTreeMedium1(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
