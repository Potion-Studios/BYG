...
//
//public class RedwoodTree1 extends BYGAbstractTreeFeature<DefaultFeatureConfig> {
//
//    public RedwoodTree1(Codec<DefaultFeatureConfig> configIn) {
//        super(configIn);
//    }
//
...
//                this.treeBranch(changedBlocks, worldIn, mainmutable.add(1, 2, 1), boundsIn);
//                this.treeBranch(changedBlocks, worldIn, mainmutable.add(0, 2, 2), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 1, -4), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 1, -3), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 1, -3), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 1, -3), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 1, -3), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 1, -2), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 1, -2), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(2, 1, -2), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 1, -2), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 1, -1), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 1, -1), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(-4, 1, 0), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(4, 1, 0), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 1, 1), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(3, 1, 1), boundsIn);
//                this.leafs(changedBlocks, worldIn, mainmutable.add(-3, 1, 2), boundsIn);
...
//        if (canTreePlaceHere(reader, pos)) {
//            this.setFinalBlockState(setlogblock, reader, pos, BYGBlockList.REDWOOD_LEAVES.getDefaultState(), boundingBox);
//        }
//    }
//
//    //Leaves Placement
