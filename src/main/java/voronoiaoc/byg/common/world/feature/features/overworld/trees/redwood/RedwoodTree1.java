        ...
        if (posY >= 1 && posY + randTreeHeight + 1 < 256) {
            ...
            if (!isDesiredGround(worldIn, blockpos, Blocks.GRASS_BLOCK)) {
                ...
                for (int buildTrunk = 0; buildTrunk < randTreeHeight; ++buildTrunk) {
                    ...
                    if (buildTrunk <= randTreeHeight - 25) {
                    ...
                    if (buildTrunk <= randOuterEdgeHeight) {
                    ...
                    BlockPos.Mutable branch4PosMutable = new BlockPos.Mutable().set(branchPos4);
                    for (int i = 2; i <= 4; i++) {
                        BlockPos.Mutable mutable = new BlockPos.Mutable().set(branch4PosMutable);
                        if (i > 2) {
