...
public class BlueGlowshroom2Huge extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public BlueGlowshroom2Huge(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn) {
        super(configIn);
    }
