...
public class SpruceYellowTreeMedium4 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceYellowTreeMedium4(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
