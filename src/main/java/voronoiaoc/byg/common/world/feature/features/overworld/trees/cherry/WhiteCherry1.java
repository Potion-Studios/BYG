...
public class WhiteCherry1 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public WhiteCherry1(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, WorldGenLevel worldIn, Random rand, BlockPos pos, BoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), Blocks.GRASS_BLOCK)) {
                ...
                return false;
            } else if (!this.doesSaplingHaveSpaceToGrow(worldIn, pos, randTreeHeight, 18, 5, 5, isSapling)) {
                return false;
            } else {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight - 7, 4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 7, 4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight - 7, 4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 7, 4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 7, 5), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 7, 6), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(5, randTreeHeight - 10, -4), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(5, randTreeHeight - 10, -3), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 10, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(5, randTreeHeight - 10, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 10, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 10, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 10, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 10, 6), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 9, -5), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(6, randTreeHeight - 9, -3), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(6, randTreeHeight - 9, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight - 9, -1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight - 9, 0), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(3, randTreeHeight - 9, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 9, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(5, randTreeHeight - 9, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(6, randTreeHeight - 9, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight - 9, 6), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 9, 6), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 9, 6), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-4, randTreeHeight - 9, 7), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(7, randTreeHeight - 8, -2), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-7, randTreeHeight - 8, 0), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(5, randTreeHeight - 7, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(6, randTreeHeight - 7, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(7, randTreeHeight - 7, -3), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 6, 8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 6, 8), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight - 6, 8), boundsIn);
