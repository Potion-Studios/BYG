...
public class BlueEnchantedTree3 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public BlueEnchantedTree3(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    private void treeBranch(Set<BlockPos> setlogblock, WorldGenLevel reader, BlockPos pos, BoundingBox boundingBox) {
        if (canLogPlaceHereWater(reader, pos)) {
            this.setFinalBlockState(setlogblock, reader, pos, BYGBlockList.BLUE_ENCHANTED_LEAVES.defaultBlockState(), boundingBox);
        }
    }
