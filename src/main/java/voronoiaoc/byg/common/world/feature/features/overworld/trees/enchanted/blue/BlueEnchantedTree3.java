...
public class BlueEnchantedTree3 extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public BlueEnchantedTree3(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn) {
        super(configIn);
    }
