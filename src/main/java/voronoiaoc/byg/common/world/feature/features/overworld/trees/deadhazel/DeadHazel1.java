...
public class DeadHazel1 extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public DeadHazel1(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, IWorldGenerationReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            ...
            if (!isDesiredGround(worldIn, blockpos, Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(5, randTreeHeight + 4, -1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(4, randTreeHeight + 4, 0), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-1, randTreeHeight + 4, 1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-1, randTreeHeight + 4, 2), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(1, randTreeHeight + 4, 4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(1, randTreeHeight + 4, 5), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(2, randTreeHeight + 5, -4), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight + 5, 4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-5, randTreeHeight + 6, 1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(7, randTreeHeight + 3, -2), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, randTreeHeight + 4, 6), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, randTreeHeight + 4, 6), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, randTreeHeight + 4, 7), boundsIn);
