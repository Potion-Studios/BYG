...
public class DeadHazel1 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public DeadHazel1(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, WorldGenLevel worldIn, Random rand, BlockPos pos, BoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(5, randTreeHeight + 4, -1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight + 4, 0), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight + 4, 1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight + 4, 2), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight + 4, 4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight + 4, 5), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight + 5, 4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight + 6, 1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(7, randTreeHeight + 3, -2), boundsIn);
