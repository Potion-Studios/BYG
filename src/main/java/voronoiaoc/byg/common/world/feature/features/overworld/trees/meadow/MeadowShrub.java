...
public class MeadowShrub extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public MeadowShrub(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
        super(configIn);
