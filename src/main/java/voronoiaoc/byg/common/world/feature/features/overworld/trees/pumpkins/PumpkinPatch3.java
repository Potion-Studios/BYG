...
public class PumpkinPatch3 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {
    ...
    public PumpkinPatch3(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
        ...
        if (posY >= 1 && posY + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                for (int groundUpLogRemover = 0; groundUpLogRemover < randTreeHeight; ++groundUpLogRemover) {
                    ...
                    placeTrunk(LOG, changedBlocks, worldIn, blockpos2.west().south().down(), boundsIn);
