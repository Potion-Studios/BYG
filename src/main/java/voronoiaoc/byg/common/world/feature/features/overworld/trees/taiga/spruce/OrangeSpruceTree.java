...
public class OrangeSpruceTree extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {
    ...
    public OrangeSpruceTree(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
                                ...
                                for (int posXLeafWidth2 = -leavessquarespos2; posXLeafWidth2 <= leavessquarespos2; ++posXLeafWidth2) {//has to do with leaves
                                    for (int posZLeafWidthL2 = -leavessquarespos2; posZLeafWidthL2 <= leavessquarespos2; ++posZLeafWidthL2) {
                                        ...
                                        if (leavesAdder == 1) {
                                            ...
                                            placeLeaves(LEAVES, worldIn, posX1 + posXLeafWidth2, topTrunkHeight - 5, posZ1 + posZLeafWidthL2, boundsIn, changedBlocks);
