...
public class OrangeSpruceTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    private static final BlockState LEAVES3 = BYGBlockList.ORANGE_SPRUCE_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();


    public OrangeSpruceTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
