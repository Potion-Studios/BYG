...
public class SpruceOrangeTreeMedium1 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceOrangeTreeMedium1(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
