...
public class SmallOrangeSpruceTree extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {
    ...
    public SmallOrangeSpruceTree(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
