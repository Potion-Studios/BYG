...
public class SmallOrangeSpruceTree extends BYGAbstractTreeFeature<DefaultFeatureConfig> {
    ...
    public SmallOrangeSpruceTree(Codec<DefaultFeatureConfig> configIn) {
        super(configIn);
