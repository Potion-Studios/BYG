...
public class GreenEnchantedTree3 extends BYGAbstractTreeFeature<DefaultFeatureConfig> {

    public GreenEnchantedTree3(Codec<DefaultFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getDimensionHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, blockpos, Blocks.GRASS_BLOCK)) {
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, randTreeHeight - 14, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, randTreeHeight - 14, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, randTreeHeight - 13, -5), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(2, randTreeHeight - 12, 5), boundsIn);
