...
public class GreenEnchantedTree2 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public GreenEnchantedTree2(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, WorldGenLevel worldIn, Random rand, BlockPos pos, BoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight - 17, 0), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight - 17, 0), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 17, 1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 16, 1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight - 16, 2), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 13, -2), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight - 13, -1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight - 13, 0), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 11, -2), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 10, -1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 18, -1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 18, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 18, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight - 18, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 18, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight - 18, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 18, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(3, randTreeHeight - 18, 1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight - 17, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 17, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-5, randTreeHeight - 17, -1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 17, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 17, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(3, randTreeHeight - 17, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 17, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 17, 1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 17, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-1, randTreeHeight - 17, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(0, randTreeHeight - 17, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(1, randTreeHeight - 17, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 17, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(3, randTreeHeight - 17, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 17, 2), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-2, randTreeHeight - 13, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 13, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(-3, randTreeHeight - 13, 5), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(3, randTreeHeight - 12, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(2, randTreeHeight - 12, 6), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 10, -5), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.offset(3, randTreeHeight - 10, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(4, randTreeHeight - 10, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.offset(5, randTreeHeight - 10, -2), boundsIn);
