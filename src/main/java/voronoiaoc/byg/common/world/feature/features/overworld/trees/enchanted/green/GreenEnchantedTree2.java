...
public class GreenEnchantedTree2 extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public GreenEnchantedTree2(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn) {
        super(configIn);
    }
