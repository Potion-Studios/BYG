...
public class PumpkinPatch2 extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public PumpkinPatch2(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
        super(configIn);
