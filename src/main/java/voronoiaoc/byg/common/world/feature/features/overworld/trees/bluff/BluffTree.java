...
public class BluffTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public BluffTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
        super(configIn);
