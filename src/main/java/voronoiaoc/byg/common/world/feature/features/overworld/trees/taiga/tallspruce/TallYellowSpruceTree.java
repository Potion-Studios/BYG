...
public class TallYellowSpruceTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public TallYellowSpruceTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
