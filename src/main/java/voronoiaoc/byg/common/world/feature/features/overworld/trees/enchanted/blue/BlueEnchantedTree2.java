    ...
    protected boolean place(Set<BlockPos> changedBlocks, IWorldGenerationReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn) {
        ...
        if (pos.getY() >= 1 && pos.getY() + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            ...
            if (!isDesiredGround(worldIn, blockpos, Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(2, 10, 6), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-5, 11, 3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-3, 11, 6), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-1, 11, 6), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(2, 11, 6), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-5, 12, 3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-3, 12, 6), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-1, 12, 6), boundsIn);
