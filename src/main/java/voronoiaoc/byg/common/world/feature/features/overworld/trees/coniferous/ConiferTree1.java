...
public class ConiferTree1 extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public ConiferTree1(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    private void leafs(Set<BlockPos> blockPos, IWorldGenerationReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
        if (isAir(reader, pos)) {
            this.setFinalBlockState(blockPos, reader, pos, BYGBlockList.FIR_LEAVES.getDefaultState(), boundingBox);
        }
    }
