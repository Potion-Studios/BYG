...
public class AspenTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    //BYGBlockRenders used for the tree.
    private static final BlockState LOG = BYGBlockList.ASPEN_LOG.defaultBlockState();
    private static final BlockState LEAVES = BYGBlockList.ASPEN_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();
    Random random = new Random();

    public AspenTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
