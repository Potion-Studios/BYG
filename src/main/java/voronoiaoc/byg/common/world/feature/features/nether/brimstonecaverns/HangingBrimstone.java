...
public class HangingBrimstone extends Feature<NoFeatureConfig> {
    private static final Direction[] field_236426_a_ = Direction.values();

    public HangingBrimstone(Codec<NoFeatureConfig> p_i232004_1_) {
        super(p_i232004_1_);
    }
    ...
    public boolean func_241855_a(ISeedReader p_241855_1_, ChunkGenerator p_241855_2_, Random p_241855_3_, BlockPos p_241855_4_, NoFeatureConfig p_241855_5_) {
        if (!p_241855_1_.isAirBlock(p_241855_4_)) {
            ...
            if (!blockstate.isIn(Blocks.NETHERRACK) && !blockstate.isIn(BYGBlockList.BRIMSTONE)) {
                return false;
            } else {
    ...
    private void func_236428_a_(IWorld p_236428_1_, Random p_236428_2_, BlockPos p_236428_3_) {
        p_236428_1_.setBlockState(p_236428_3_, BYGBlockList.BRIMSTONE.getDefaultState(), 2);
        ...
        for (int i = 0; i < 200; ++i) {
            ...
            if (p_236428_1_.isAirBlock(blockpos$mutable)) {
                ...
                if (j == 1) {
                    p_236428_1_.setBlockState(blockpos$mutable, BYGBlockList.BRIMSTONE.getDefaultState(), 2);
                }
            }
        }
        ...
        for (int i = 0; i <= p_236427_3_; ++i) {
            if (p_236427_0_.isAirBlock(p_236427_2_)) {
                if (i == p_236427_3_ || !p_236427_0_.isAirBlock(p_236427_2_.down())) {
                    p_236427_0_.setBlockState(p_236427_2_, BYGBlockList.BRIMSTONE.getDefaultState(), 2);
                    break;
                }
