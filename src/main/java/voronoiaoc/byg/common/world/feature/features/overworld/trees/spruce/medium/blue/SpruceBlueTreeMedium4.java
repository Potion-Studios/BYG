...
public class SpruceBlueTreeMedium4 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceBlueTreeMedium4(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
