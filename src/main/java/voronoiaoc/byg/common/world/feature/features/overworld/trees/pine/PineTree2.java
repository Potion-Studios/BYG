...
public class PineTree2 extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public PineTree2(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
        ...
        if (posY >= 1 && posY + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), Blocks.GRASS_BLOCK)) {
                ...
                for (int groundUpLogRemover = 0; groundUpLogRemover < randTreeHeight; ++groundUpLogRemover) {
                    ...
                    this.treelog(changedBlocks, worldIn, blockpos2.north().below(4), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.north().below(9), boundsIn);

                    this.treelog(changedBlocks, worldIn, blockpos2.south().below(3), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.south().below(9), boundsIn);

                    this.treelog(changedBlocks, worldIn, blockpos2.east().below(10), boundsIn);


                    this.treelog(changedBlocks, worldIn, blockpos2.west().below(7), boundsIn);
                    this.treelog(changedBlocks, worldIn, blockpos2.west().below(10), boundsIn);
                }
