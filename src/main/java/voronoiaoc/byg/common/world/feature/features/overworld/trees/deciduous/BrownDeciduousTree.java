...
public class BrownDeciduousTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    private static final BlockState LOG = Blocks.DARK_OAK_LOG.defaultBlockState();
    private static final BlockState LEAVES = BYGBlockList.BROWN_OAK_LEAVES.defaultBlockState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.defaultBlockState();

    public BrownDeciduousTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
