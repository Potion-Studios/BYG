...
public class YellowDeciduousTree extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public YellowDeciduousTree(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
