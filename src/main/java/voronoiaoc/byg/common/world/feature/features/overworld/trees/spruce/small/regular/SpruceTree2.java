package voronoiaoc.byg.common.world.feature.features.overworld.trees.spruce.small.regular;
...
public class SpruceTree2 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceTree2(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
