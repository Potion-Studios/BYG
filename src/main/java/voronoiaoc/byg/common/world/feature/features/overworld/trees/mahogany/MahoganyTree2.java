    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(0, 3, 3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(3, 3, 0), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-5, 4, 0), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-4, 4, 0), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-3, 4, -1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-3, 4, 1), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-1, 4, -3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(-1, 4, 3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(0, 4, -5), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(0, 4, -4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(0, 4, 4), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(1, 4, -3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(1, 4, 3), boundsIn);
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(3, 4, -1), boundsIn);
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(2, 8, -2), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-7, 4, -2), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-7, 4, -1), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-7, 4, 0), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-7, 4, 1), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-6, 4, -3), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-6, 4, -2), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-6, 4, -1), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-6, 4, 0), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-6, 4, 1), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-6, 4, 2), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-6, 4, 3), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-5, 4, -5), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-5, 4, -4), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-5, 4, 3), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-5, 4, 4), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-4, 4, -5), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-4, 4, -4), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-4, 4, -3), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-4, 4, 3), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-4, 4, 4), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-3, 4, -6), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-3, 4, 4), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-3, 4, 5), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-2, 4, -6), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-2, 4, -5), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-2, 4, 4), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-2, 4, 5), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-1, 4, -7), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-1, 4, -6), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-1, 4, 5), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-1, 4, 6), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(0, 4, -7), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(0, 4, -6), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(0, 4, 2), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(0, 4, 3), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(0, 4, 5), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(0, 4, 6), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(1, 4, -7), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(1, 4, -6), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(1, 4, -5), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(1, 4, 5), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(1, 4, 6), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(2, 4, -7), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(2, 4, -6), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(2, 4, -5), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(2, 4, -4), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(2, 4, -3), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(5, 4, -2), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(5, 4, -1), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(5, 4, 0), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(5, 4, 1), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(5, 4, 2), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(6, 4, -4), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(6, 4, -3), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(6, 4, -2), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(6, 4, -1), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(6, 4, 0), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-5, 5, -1), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-2, 5, 2), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-2, 5, 3), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-1, 5, -5), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-4, 7, -4), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-3, 7, -5), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-3, 7, -4), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-3, 7, -3), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-3, 7, 1), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-2, 7, -5), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-1, 7, -5), boundsIn);
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(0, 9, -3), boundsIn);
