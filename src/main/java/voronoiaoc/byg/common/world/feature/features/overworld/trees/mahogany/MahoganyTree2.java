...
public class MahoganyTree2 extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public MahoganyTree2(Codec<NoFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(2, 8, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-7, 4, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-7, 4, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-7, 4, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-7, 4, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-6, 4, -3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-6, 4, -2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-6, 4, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-6, 4, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-6, 4, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-6, 4, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-6, 4, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-5, 4, -5), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-5, 4, 3), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-5, 4, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-4, 4, -5), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 4, 4), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-2, 4, 5), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 4, -7), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 4, -6), boundsIn);
