...
public class SythianFungusTree3 extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public SythianFungusTree3(Codec<NoFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    public boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, blockpos, BYGBlockList.SYTHIAN_NYLIUM)) {
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 5, 0), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-2, 5, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 5, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 5, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 5, 1), boundsIn);
                ...
                this.vines(changedBlocks, worldIn, mainmutable.add(0, 6, -2), boundsIn);
                this.vinesplant(changedBlocks, worldIn, mainmutable.add(1, 6, -2), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-1, 6, 1), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(0, 6, 1), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(-1, 6, 2), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 7, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 7, 2), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(0, 8, -2), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 9, -1), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(2, 9, -1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 9, 0), boundsIn);
                this.shroomlight(changedBlocks, worldIn, mainmutable.add(1, 9, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 9, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 9, 1), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(-1, 9, 2), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 9, 2), boundsIn);
