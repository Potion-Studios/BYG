package voronoiaoc.byg.common.world.feature.features.overworld.trees.spruce.small.blue;
...
public class SpruceBlueTree2 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceBlueTree2(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
