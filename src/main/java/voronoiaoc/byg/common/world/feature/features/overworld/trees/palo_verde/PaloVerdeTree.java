...
public class PaloVerdeTree extends BYGAbstractTreeFeature<DefaultFeatureConfig> {
    ...
    public PaloVerdeTree(Codec<DefaultFeatureConfig> configIn, int beeHiveChance) {
        super(configIn);
