...
public class WillowTreeM2 extends BYGAbstractTreeFeature<DefaultFeatureConfig> {
    ...
    //Leaves Placement
    private void stem(Set<BlockPos> blockPos, ServerWorldAccess reader, BlockPos pos, BlockBox boundingBox) {
        BlockPos.Mutable blockpos = new BlockPos.Mutable().set(pos);
    ...
    //Leaves Placement
    private void glowshroom(Set<BlockPos> blockPos, ServerWorldAccess reader, BlockPos pos, BlockBox boundingBox) {
        BlockPos.Mutable blockpos = new BlockPos.Mutable().set(pos);
        if (isAir(reader, blockpos)) {
