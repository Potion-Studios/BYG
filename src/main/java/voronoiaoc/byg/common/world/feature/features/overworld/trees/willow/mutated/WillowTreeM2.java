...
public class WillowTreeM2 extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public WillowTreeM2(Codec<NoFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    private void stem(Set<BlockPos> blockPos, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
        if (isAir(reader, pos)) {
            this.setFinalBlockState(blockPos, reader, pos, BYGBlockList.YELLOW_GLOWSHROOM_STEM.getDefaultState(), boundingBox);
        }
    }
    ...
    private void glowshroom(Set<BlockPos> blockPos, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
        if (isAir(reader, pos)) {
            this.setFinalBlockState(blockPos, reader, pos, BYGBlockList.BLUE_GLOWSHROOM_BLOCK.getDefaultState(), boundingBox);
        }
    }
