...
public class GreenEnchantedGroveTree extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {
    ...
    public GreenEnchantedGroveTree(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
