...
public class AngelicaGiant extends BYGAbstractTreeFeature<DefaultFeatureConfig> {

    public AngelicaGiant(Codec<DefaultFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < 256) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(changedBlocks, worldIn, mainmutable.add(3, 5, -2), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 11, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 11, 2), boundsIn);
                this.pollen(changedBlocks, worldIn, mainmutable.add(-1, 11, 1), boundsIn);
                this.pollen(changedBlocks, worldIn, mainmutable.add(0, 11, 1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 12, 2), boundsIn);
                this.pollen(changedBlocks, worldIn, mainmutable.add(0, 12, -1), boundsIn);
                ...
                this.leafs(changedBlocks, worldIn, mainmutable.add(1, 13, 0), boundsIn);
                this.leafs(changedBlocks, worldIn, mainmutable.add(0, 13, 1), boundsIn);
                this.pollen(changedBlocks, worldIn, mainmutable.add(0, 13, 0), boundsIn);
    ...
    private void leafs(Set<BlockPos> blockPos, StructureWorldAccess reader, BlockPos pos, BlockBox boundingBox) {
        ...
        if (isAir(reader, blockpos)) {
            this.setFinalBlockState(blockPos, reader, blockpos, BYGBlockList.WHITE_PETAL.getDefaultState(), boundingBox);
        }
    }
