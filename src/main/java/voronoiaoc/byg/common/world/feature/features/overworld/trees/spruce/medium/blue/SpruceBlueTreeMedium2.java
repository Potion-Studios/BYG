...
public class SpruceBlueTreeMedium2 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceBlueTreeMedium2(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
