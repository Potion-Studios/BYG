package voronoiaoc.byg.common.world.feature.features.overworld.trees.spruce.small.orange;
...
public class SpruceOrangeTree2 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public SpruceOrangeTree2(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
