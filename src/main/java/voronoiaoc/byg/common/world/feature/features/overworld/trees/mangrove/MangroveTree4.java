...
public class MangroveTree4 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public MangroveTree4(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, blockpos, Blocks.GRASS_BLOCK, BYGBlockList.MOSSY_STONE)) {
                ...
                BlockPos.Mutable rootMutable9 = new BlockPos.Mutable().setPos(mainmutable.add(-1, 0, 3));
                BlockPos.Mutable rootMutable10 = new BlockPos.Mutable().setPos(mainmutable.add(-1, 0, 3));
                BlockPos.Mutable rootMutable11 = new BlockPos.Mutable().setPos(mainmutable.add(-1, 0, 3));
                BlockPos.Mutable rootMutable12 = new BlockPos.Mutable().setPos(mainmutable.add(-1, 0, 3));
                ...
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-3, randTreeHeight + 2, 6), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight + 2, 6), boundsIn);
                placeLeaves(LEAVES, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight + 3, -6), boundsIn);
