    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, 14, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 14, 1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 15, -1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 15, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, 15, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 15, 1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 16, -1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 16, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, 16, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 16, 1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 17, -1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 17, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, 17, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 17, 1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 18, -1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 18, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, 18, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 18, 1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 19, -1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 19, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, 19, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 19, 1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 20, -1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 20, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, 20, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 20, 1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 21, -1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 21, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, 21, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 21, 1), boundsIn);
