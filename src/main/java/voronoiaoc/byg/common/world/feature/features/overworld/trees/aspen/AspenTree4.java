    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 0, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 0, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 0, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 0, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 1, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 1, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 1, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 1, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 2, -1), boundsIn);
                ...
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 3, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 3, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 3, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 3, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 4, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 4, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 4, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 4, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 5, -1), boundsIn);
                ...
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 6, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 6, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 6, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 7, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 7, 1), boundsIn);
                ...
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 8, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 8, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 8, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 9, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 9, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 9, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 9, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 10, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 10, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 10, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 10, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 11, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 11, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 11, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 11, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 12, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 12, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 12, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 12, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 13, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 13, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 13, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 13, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 14, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 14, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 14, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 14, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 15, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 15, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 15, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 15, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 16, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 16, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 16, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 16, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 17, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 17, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 17, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 17, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 18, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 18, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 18, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 18, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 19, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 19, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 19, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 19, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 20, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 20, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 20, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 20, 1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 21, -1), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(-1, 21, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(1, 21, 0), boundsIn);
                placeTrunk(LOG, changedBlocks, worldIn, mainmutable.add(0, 21, 1), boundsIn);
