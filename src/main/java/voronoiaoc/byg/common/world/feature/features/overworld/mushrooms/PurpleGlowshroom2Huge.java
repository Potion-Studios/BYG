...
public class PurpleGlowshroom2Huge extends BYGAbstractTreeFeature<NoneFeatureConfiguration> {

    public PurpleGlowshroom2Huge(Codec<NoneFeatureConfiguration> configIn) {
        super(configIn);
    }
