...
public class PurpleGlowshroom2Huge extends BYGAbstractTreeFeature<DefaultFeatureConfig> {

    public PurpleGlowshroom2Huge(Codec<DefaultFeatureConfig> configIn) {
        super(configIn);
    }
