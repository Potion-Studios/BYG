...
public class PurpleGlowshroom2Huge extends BYGAbstractTreeFeature<NoFeatureConfig> {

    public PurpleGlowshroom2Huge(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn) {
        super(configIn);
    }
