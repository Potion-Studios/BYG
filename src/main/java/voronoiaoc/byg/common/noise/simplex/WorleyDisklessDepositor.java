package voronoiaoc.byg.common.noise.simplex;//package voronoiaoc.byg.common.world.worldtype.noise.simplex;
//
...
//        HashMap<DisklessDepositNoiseKey, WorleyNoise> noiseInstanceMap = new HashMap<>();
//
...
//                WorleyNoise noiseInstance = noiseInstanceMap.get(key);
