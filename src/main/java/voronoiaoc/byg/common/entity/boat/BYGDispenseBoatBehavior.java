...
//        double d0 = source.getX() + (double) ((float) direction.getXOffsetPos() * 1.125F);
//        double d1 = source.getY() + (double) ((float) direction.getYOffsetPos() * 1.125F);
//        double d2 = source.getZ() + (double) ((float) direction.getZOffsetPos() * 1.125F);
