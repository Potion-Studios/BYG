...
public class WitheringWoods extends Biome implements BiomeTools {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("withering_woods", new ConfiguredSurfaceBuilder<>(BYGSBList.WITHERING_WOODS_SB, BYGSBList.BYGSBConfigList.MAGMATIC_STONE));
