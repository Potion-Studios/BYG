...
public class SeasonalTaiga extends BYGBiomeBuilder implements BiomeTools  {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("seasonal_taiga", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
    ...
    public Biome getHill(INoiseRandom rand) {
        return (rand.random(2) == 0) ? BYGBiomeList.SEASONALTAIGAHILLS : BYGBiomeList.SEASONALGIANTTAIGA;
    }
