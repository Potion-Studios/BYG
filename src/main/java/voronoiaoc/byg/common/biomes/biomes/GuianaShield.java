...
public class GuianaShield extends Biome implements BiomeTools {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("guiana_shield", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new SurfaceBuilderBaseConfiguration(BYGBlockList.OVERGROWN_STONE.defaultBlockState(), Blocks.STONE.defaultBlockState(), Blocks.STONE.defaultBlockState())));
    ...
    static {
        ...
        GENERATION_SETTINGS.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, BYGConfiguredFeatures.ORE_AMETRINE);
