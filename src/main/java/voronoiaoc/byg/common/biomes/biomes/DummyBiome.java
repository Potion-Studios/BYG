...
public class DummyBiome extends Biome {
    ...
    static final Biome.Category CATEGORY = Category.TAIGA;
    ...
    public DummyBiome() {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, BYGFeatureList.LARGE_PINE_TREE1.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.COUNT_EXTRA_HEIGHTMAP.configure(new AtSurfaceWithExtraConfig(15, 0.1F, 2))));
