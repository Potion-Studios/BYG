...
public class DeadSea extends Biome implements BiomeTools, BiomeFog {
    ...
    static {
        ...
        BiomeDefaultFeatures.addOceanCarvers(GENERATION_SETTINGS);
        ...
        SPAWN_SETTINGS.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.DROWNED, 5, 1, 1));
        ...
        SPAWN_SETTINGS.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.WITCH, 15, 1, 1));
