...
public class SeasonalForest extends BYGBiomeBuilder implements BiomeTools  {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("seasonal_forest", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
    ...
    public HashMap<Biome, Integer> getHills() {
        ...
        map.put(BYGBiomeList.SEASONALFORESTHILLS, 4);
        return map;
    }
