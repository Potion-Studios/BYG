...
public class Grove extends Biome implements BiomeTools {
    ...
    public Grove() {
        ...
        DefaultBiomeFeatures.method_28440(this);BYGTreeFeatures.addGroveTrees(this);
    ...
    public Biome getHill() {
        ...
        return (rand.nextInt(5) == 0) ? BYGBiomeList.FRESHWATERLAKE : BYGBiomeList.FLOWERING_GROVE;
    }
