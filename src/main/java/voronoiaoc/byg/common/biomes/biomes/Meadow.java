...
public class Meadow extends Biome implements BiomeTools {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("meadow", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new SurfaceBuilderBaseConfiguration(BYGBlockList.MEADOW_GRASSBLOCK.defaultBlockState(), BYGBlockList.MEADOW_DIRT.defaultBlockState(), BYGBlockList.MEADOW_DIRT.defaultBlockState())));
