...
public class LushTundra extends Biome implements BiomeTools {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("lush_tundra", new ConfiguredSurfaceBuilder<>(BYGSBList.LUSH_TUNDRA_SB, SurfaceBuilder.CONFIG_GRASS));
    ...
    static {
        GENERATION_SETTINGS.addStructureStart(StructureFeatures.VILLAGE_SNOWY);
