...
public class RedDesert extends BYGBiomeBuilder implements BiomeTools  {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("red_desert", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.RED_SAND.getDefaultState(), Blocks.RED_SAND.getDefaultState(), Blocks.RED_SANDSTONE.getDefaultState())));
    ...
    static {
        GENERATION_SETTINGS.func_242516_a(StructureFeatures.field_244155_u); //Desert Village
        GENERATION_SETTINGS.func_242516_a(StructureFeatures.field_244135_a); //Pillager Outpost
        GENERATION_SETTINGS.func_242516_a(StructureFeatures.field_244160_z); //Ruined Portal Desert
