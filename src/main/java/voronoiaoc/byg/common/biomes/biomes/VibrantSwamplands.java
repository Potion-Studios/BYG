...
public class VibrantSwamplands extends BYGBiomeBuilder implements BiomeTools  {
    ...
    static {
        ...
        DefaultBiomeFeatures.func_243723_ag(GENERATION_SETTINGS);
        DefaultBiomeFeatures.func_243702_P(GENERATION_SETTINGS);
