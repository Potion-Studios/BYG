...
public class SierraRange extends BYGBiomeBuilder implements BiomeTools {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("sierra_range", new ConfiguredSurfaceBuilder<>(BYGSBList.ERODED_SIERRA_SB, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
