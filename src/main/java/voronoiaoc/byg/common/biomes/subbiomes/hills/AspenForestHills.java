...
public class AspenForestHills extends Biome {
    ...
    public int getGrassColor(double x, double z) {
        double color = BIOME_INFO_NOISE.getValue(x * 0.0225D, z * 0.0225D, false);
