...
public class DeciduousForestHills extends Biome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("deciduous_forest_hills", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS));
    ...
    public int getGrassColor(double x, double z) {
        double lvt_5_1_ = BIOME_INFO_NOISE.getValue(x * 0.0225D, z * 0.0225D, false);
