...
public class WoodedRedRockMountains extends Biome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("wooded_red_rock_mountain", new ConfiguredSurfaceBuilder<>(BYGSBList.RED_ROCK_SB, SurfaceBuilder.CONFIG_GRASS));
    ...
    static {
        ...
        BYGTreeFeatures.addPaloVerdeTrees(GENERATION_SETTINGS);
        BiomeDefaultFeatures.addBadlandsTrees(GENERATION_SETTINGS);
