...
public class FloweringMeadow extends Biome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("flowering_meadow", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new SurfaceBuilderBaseConfiguration(BYGBlockList.MEADOW_GRASSBLOCK.defaultBlockState(), BYGBlockList.MEADOW_DIRT.defaultBlockState(), BYGBlockList.MEADOW_DIRT.defaultBlockState())));
