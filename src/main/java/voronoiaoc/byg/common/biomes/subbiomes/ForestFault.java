...
public class ForestFault extends BYGBiomeBuilder implements BiomeTools {
    ...
    public ForestFault() {
        ...
        GENERATION_SETTINGS.func_242513_a(GenerationStage.Decoration.UNDERGROUND_ORES, BYGConfiguredFeatures.ORE_PENDORITE);
