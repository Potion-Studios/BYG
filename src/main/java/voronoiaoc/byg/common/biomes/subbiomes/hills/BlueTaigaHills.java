...
public class BlueTaigaHills extends Biome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("blue_taiga_hills", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS));
...
//        GENERATION_SETTINGS.carver(GenerationStep.Carving.AIR, Biome.createCarver(BYGFeatureList.CAVE, new ProbabilityConfig(0.25F)));
