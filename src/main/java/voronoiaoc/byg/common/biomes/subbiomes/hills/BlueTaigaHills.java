...
public class BlueTaigaHills extends BYGBiomeBuilder implements BiomeTools {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("blue_taiga_hills", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
...
//        GENERATION_SETTINGS.carver(GenerationStep.Carving.AIR, Biome.createCarver(BYGFeatureList.field_235027_b_, new ProbabilityConfig(0.25F)));
