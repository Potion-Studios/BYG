...
public class WoodedMeadow extends Biome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("wooded_meadow", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new SurfaceBuilderBaseConfiguration(BYGBlockList.MEADOW_GRASSBLOCK.defaultBlockState(), BYGBlockList.MEADOW_DIRT.defaultBlockState(), BYGBlockList.MEADOW_DIRT.defaultBlockState())));
