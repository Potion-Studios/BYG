...
public class TropicalFungalRainforestHills extends BYGBiomeBuilder implements BiomeTools {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("tropical_fungal_rainforest_hills", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
    ...
    static {
        ...
        DefaultBiomeFeatures.func_243703_Q(GENERATION_SETTINGS);
        DefaultBiomeFeatures.func_243703_Q(GENERATION_SETTINGS);
        DefaultBiomeFeatures.func_243703_Q(GENERATION_SETTINGS);
        DefaultBiomeFeatures.func_243703_Q(GENERATION_SETTINGS);
        DefaultBiomeFeatures.func_243703_Q(GENERATION_SETTINGS);
