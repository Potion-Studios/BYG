...
public class DeciduousClearing extends Biome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("deciduous_clearing", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS));
...
//    }
    ...
    public int getGrassColor(double p_225528_1_, double p_225528_3_) {
        double lvt_5_1_ = BIOME_INFO_NOISE.getValue(p_225528_1_ * 0.0225D, p_225528_3_ * 0.0225D, false);
    ...
    static {
        ...
        BYGTreeFeatures.addDeciduousSparseTrees(GENERATION_SETTINGS);
