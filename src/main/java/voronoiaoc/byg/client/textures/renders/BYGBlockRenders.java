...
public class BYGBlockRenders {
    public static void renderCutOuts() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(BYGBlockList.EMBUR_ROOTS, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BYGBlockList.TALL_EMBUR_ROOTS, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BYGBlockList.EMBUR_WART, RenderLayer.getCutout());
