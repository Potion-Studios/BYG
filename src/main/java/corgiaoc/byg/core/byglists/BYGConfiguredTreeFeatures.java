...
import corgiaoc.byg.common.world.feature.placements.AtOceanFloorWithExtra;
import corgiaoc.byg.common.world.feature.placements.UnderGroundPlacement;
...
public class BYGConfiguredTreeFeatures {
    ...
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> JOSHUA_TREE1 = newConfiguredFeature("joshua_tree1", BYGFeatureList.JOSHUA_TREE1.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.OAK_LOG).setLeavesBlock(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlockList.RIPE_JOSHUA_LEAVES.getDefaultState(), 1).addWeightedBlockstate(BYGBlockList.JOSHUA_LEAVES.getDefaultState(), 10)).setMaxHeight(6).setMinHeight(3).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> JOSHUA_TREE2 = newConfiguredFeature("joshua_tree2", BYGFeatureList.JOSHUA_TREE2.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.OAK_LOG).setLeavesBlock(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlockList.RIPE_JOSHUA_LEAVES.getDefaultState(), 1).addWeightedBlockstate(BYGBlockList.JOSHUA_LEAVES.getDefaultState(), 10)).setMaxHeight(6).setMinHeight(3).build()));
    ...
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> MANGROVE_TREE2 = newConfiguredFeature("mangrove_tree2", BYGFeatureList.MANGROVE_TREE2.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlockList.MANGROVE_LOG).setLeavesBlock(BYGBlockList.MANGROVE_LEAVES).setMaxHeight(17).setMinHeight(11).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> MANGROVE_TREE3 = newConfiguredFeature("mangrove_tree3", BYGFeatureList.MANGROVE_TREE3.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlockList.MANGROVE_LOG).setLeavesBlock(BYGBlockList.MANGROVE_LEAVES).setMaxHeight(16).setMinHeight(12).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> MANGROVE_TREE4 = newConfiguredFeature("mangrove_tree4", BYGFeatureList.MANGROVE_TREE4.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlockList.MANGROVE_LOG).setLeavesBlock(BYGBlockList.MANGROVE_LEAVES).setMaxHeight(15).setMinHeight(10).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> MANGROVE_TREE5 = newConfiguredFeature("mangrove_tree5", BYGFeatureList.MANGROVE_TREE5.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlockList.MANGROVE_LOG).setLeavesBlock(BYGBlockList.MANGROVE_LEAVES).setMaxHeight(17).setMinHeight(11).build()));
    ...
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> BLUE_GLOWSHROOM_HUGE = newConfiguredFeature("huge_blue_glowshroom", BYGFeatureList.BLUE_GLOWSHROOM_HUGE.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.YELLOW_GLOWSHROOM_STEM).setMushroomBlock(BYGBlockList.BLUE_GLOWSHROOM_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> PURPLE_GLOWSHROOM_HUGE = newConfiguredFeature("huge_purple_glowshroom", BYGFeatureList.PURPLE_GLOWSHROOM_HUGE.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.RED_GLOWSHROOM_STEM).setMushroomBlock(BYGBlockList.PURPLE_GLOWSHROOM_BLOCK).setMinHeight(6).setMaxHeight(12).build()));

    //MiniMushrooms
    public static final ConfiguredFeature<?, ?> GREEN_MUSHROOM_MINI = newConfiguredFeature("mini_green_mushroom", BYGFeatureList.MINI_GREEN_MUSHROOM.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.WHITE_MUSHROOM_STEM).setMushroomBlock(BYGBlockList.GREEN_MUSHROOM_BLOCK).setMinHeight(3).setMaxHeight(3).build()));
    public static final ConfiguredFeature<?, ?> WOOD_BLEWIT_MINI = newConfiguredFeature("mini_wood_blewit", BYGFeatureList.MINI_WOOD_BLEWIT.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.BROWN_MUSHROOM_STEM).setMushroomBlock(BYGBlockList.BLEWIT_MUSHROOM_BLOCK).setMinHeight(2).setMaxHeight(3).build()));
    public static final ConfiguredFeature<?, ?> WEEPING_MILKCAP_MINI = newConfiguredFeature("mini_weeping_milkcap", BYGFeatureList.MINI_WEEPING_MILKCAP.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.MUSHROOM_STEM).setMushroomBlock(BYGBlockList.MILKCAP_MUSHROOM_BLOCK).setMinHeight(2).setMaxHeight(3).build()));
    ...
    public static final ConfiguredFeature<?, ?> RED_MUSHROOM_MINI = newConfiguredFeature("mini_red_mushroom", BYGFeatureList.MINI_RED_MUSHROOM.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.MUSHROOM_STEM).setMushroomBlock(Blocks.RED_MUSHROOM_BLOCK).setMinHeight(2).setMaxHeight(3).build()));
    public static final ConfiguredFeature<?, ?> BROWN_MUSHROOM_MINI = newConfiguredFeature("mini_brown_mushroom", BYGFeatureList.MINI_BROWN_MUSHROOM.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.MUSHROOM_STEM).setMushroomBlock(Blocks.BROWN_MUSHROOM_BLOCK).setMinHeight(2).setMaxHeight(3).build()));


    //Nether Mushrooms
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> EMBUR_MUSHROOM = newConfiguredFeature("embur_mushroom1", BYGFeatureList.EMBUR_MUSHROOM.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.EMBUR_PEDU).setMushroomBlock(BYGBlockList.EMBUR_GEL_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> EMBUR_MUSHROOM2 = newConfiguredFeature("embur_mushroom2", BYGFeatureList.EMBUR_MUSHROOM2.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.EMBUR_PEDU).setMushroomBlock(BYGBlockList.EMBUR_GEL_BLOCK).setMinHeight(6).setMaxHeight(12).build()));

    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> CRIMSON_FUNGUS1 = newConfiguredFeature("crimson_fungus1", BYGFeatureList.CRIMSON_FUNGUS_TREE1.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.CRIMSON_STEM).setMushroomBlock(Blocks.NETHER_WART_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> CRIMSON_FUNGUS2 = newConfiguredFeature("crimson_fungus2", BYGFeatureList.CRIMSON_FUNGUS_TREE2.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.CRIMSON_STEM).setMushroomBlock(Blocks.NETHER_WART_BLOCK).setMinHeight(6).setMaxHeight(12).build()));

    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> WARPED_FUNGUS1 = newConfiguredFeature("warped_fungus1", BYGFeatureList.WARPED_FUNGUS_TREE1.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.WARPED_STEM).setMushroomBlock(Blocks.WARPED_WART_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> WARPED_FUNGUS2 = newConfiguredFeature("warped_fungus2", BYGFeatureList.WARPED_FUNGUS_TREE2.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.WARPED_STEM).setMushroomBlock(Blocks.WARPED_WART_BLOCK).setMinHeight(6).setMaxHeight(12).build()));

    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> SYTHIAN_FUNGUS_TREE1 = newConfiguredFeature("sythian_fungus_tree1", BYGFeatureList.SYTHIAN_FUNGUS_TREE1.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.SYTHIAN_STEM).setMushroomBlock(BYGBlockList.SYTHIAN_WART_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> SYTHIAN_FUNGUS_TREE2 = newConfiguredFeature("sythian_fungus_tree2", BYGFeatureList.SYTHIAN_FUNGUS_TREE2.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.SYTHIAN_STEM).setMushroomBlock(BYGBlockList.SYTHIAN_WART_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> SYTHIAN_FUNGUS_TREE3 = newConfiguredFeature("sythian_fungus_tree3", BYGFeatureList.SYTHIAN_FUNGUS_TREE3.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.SYTHIAN_STEM).setMushroomBlock(BYGBlockList.SYTHIAN_WART_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> SYTHIAN_FUNGUS_TREE4 = newConfiguredFeature("sythian_fungus_tree4", BYGFeatureList.SYTHIAN_FUNGUS_TREE4.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.SYTHIAN_STEM).setMushroomBlock(BYGBlockList.SYTHIAN_WART_BLOCK).setMinHeight(6).setMaxHeight(12).build()));

    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> SOUL_SHROOM_TREE1 = newConfiguredFeature("soul_shroom_tree1", BYGFeatureList.SOUL_SHROOM_TREE1.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.SOUL_SHROOM_STEM).setMushroomBlock(BYGBlockList.SOUL_SHROOM_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> SOUL_SHROOM_TREE2 = newConfiguredFeature("soul_shroom_tree2", BYGFeatureList.SOUL_SHROOM_TREE2.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.SOUL_SHROOM_STEM).setMushroomBlock(BYGBlockList.SOUL_SHROOM_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> SOUL_SHROOM_TREE3 = newConfiguredFeature("soul_shroom_tree3", BYGFeatureList.SOUL_SHROOM_TREE3.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(BYGBlockList.SOUL_SHROOM_STEM).setMushroomBlock(BYGBlockList.SOUL_SHROOM_BLOCK).setMinHeight(6).setMaxHeight(12).build()));

    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> DEATH_CAP_TREE1 = newConfiguredFeature("death_cap_tree1", BYGFeatureList.DEATH_CAP_TREE1.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.MUSHROOM_STEM).setMushroomBlock(BYGBlockList.DEATH_CAP_MUSHROOM_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> DEATH_CAP_TREE2 = newConfiguredFeature("death_cap_tree2", BYGFeatureList.DEATH_CAP_TREE2.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.MUSHROOM_STEM).setMushroomBlock(BYGBlockList.DEATH_CAP_MUSHROOM_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    public static final ConfiguredFeature<BYGMushroomFeatureConfig, ?> DEATH_CAP_TREE3 = newConfiguredFeature("death_cap_tree3", BYGFeatureList.DEATH_CAP_TREE3.withConfiguration(new BYGMushroomFeatureConfig.Builder().setStemBlock(Blocks.MUSHROOM_STEM).setMushroomBlock(BYGBlockList.DEATH_CAP_MUSHROOM_BLOCK).setMinHeight(6).setMaxHeight(12).build()));
    ...
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> WITHERING_OAK_TREE3 = newConfiguredFeature("withering_oak_tree3", BYGFeatureList.WITHERING_OAK_TREE3.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlockList.WITHERING_OAK_LOG).setLeavesBlock(BYGBlockList.WITHERING_OAK_LEAVES).setMaxHeight(30).setMinHeight(22).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> WITHERING_OAK_TREE4 = newConfiguredFeature("withering_oak_tree4", BYGFeatureList.WITHERING_OAK_TREE4.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlockList.WITHERING_OAK_LOG).setLeavesBlock(BYGBlockList.WITHERING_OAK_LEAVES).setMaxHeight(30).setMinHeight(22).build()));
