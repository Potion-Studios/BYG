...
import corgiaoc.byg.common.world.feature.placements.AnyWaterOrSolidSurfaceSurface;
import corgiaoc.byg.common.world.feature.placements.AtOceanFloorWithExtra;
import corgiaoc.byg.common.world.feature.placements.ObsidianSpikePlacer;
...
public class BYGConfiguredFeatures {
    ...
    public static ConfiguredFeature<?, ?> VALLE_DE_LUNA_POINTY_ROCK = newConfiguredFeature("valle_de_luna_pointy_rock", BYGFeatureList.POINTY_ROCK.withConfiguration(new PointyRockFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlockList.WHITE_SAND.getDefaultState(), 5).addWeightedBlockstate(BYGBlockList.WHITE_CUT_SANDSTONE.getDefaultState(), 5)).setRockHeight(88).build()).withPlacement(AtOceanFloorWithExtra.OCEANFLOOR.configure(new AtSurfaceWithExtraConfig(28, 0.1F, 1))));
    public static ConfiguredFeature<?, ?> VALLE_DE_LUNA_POINTY_ROCK_LARGE = newConfiguredFeature("valle_de_luna_pointy_rock_large", BYGFeatureList.POINTY_ROCK.withConfiguration(new PointyRockFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlockList.WHITE_SAND.getDefaultState(), 5).addWeightedBlockstate(BYGBlockList.WHITE_SMOOTH_SANDSTONE.getDefaultState(), 5)).setRockHeight(100).build()).withPlacement(AtOceanFloorWithExtra.OCEANFLOOR.configure(new AtSurfaceWithExtraConfig(4, 0.1F, 1))));


    public static ConfiguredFeature<?, ?> ORE_PERVADED_NETHERRACK = newConfiguredFeature("ore_pervaded_netherrack", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241884_c, BYGBlockList.PERVADED_NETHERRACK.getDefaultState(), 14)).withPlacement(Features.Placements.NETHER_SPRING_ORE_PLACEMENT).func_242728_a().func_242731_b(16));
    public static ConfiguredFeature<?, ?> ORE_ANTHRACITE = newConfiguredFeature("ore_anthracite", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241884_c, BYGBlockList.ANTHRACITE_ORE.getDefaultState(), 14)).withPlacement(Features.Placements.NETHER_SPRING_ORE_PLACEMENT).func_242728_a().func_242731_b(16));
    ...
    public static ConfiguredFeature<?, ?> GRANITE_BOULDER = newConfiguredFeature("granite_boulder", BYGFeatureList.STACKABLE_BOULDERS.withConfiguration(new BYGBoulderFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(Blocks.GRANITE.getDefaultState(), 3).addWeightedBlockstate(Blocks.POLISHED_GRANITE.getDefaultState(), 2)).setMinStackHeight(1).setMaxHeight(1).setMinRadius(5).setMaxRadius(9).build()).withPlacement(AtOceanFloorWithExtra.OCEANFLOOR.configure(new AtSurfaceWithExtraConfig(1, 0.1F, 1))));

    public static ConfiguredFeature<?, ?> RED_ROCK_BOULDER = newConfiguredFeature("red_rock_boulder", BYGFeatureList.STACKABLE_BOULDERS.withConfiguration(new BYGBoulderFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlockList.RED_ROCK.getDefaultState(), 3).addWeightedBlockstate(BYGBlockList.RED_ROCK.getDefaultState(), 9).addWeightedBlockstate(Blocks.RED_CONCRETE.getDefaultState(), 1)).setMinStackHeight(7).setMaxHeight(12).setMinRadius(8).setMaxRadius(12).build()));
    public static ConfiguredFeature<?, ?> WHITE_SANDSTONE_BOULDER = newConfiguredFeature("white_sandstone_boulder", BYGFeatureList.STACKABLE_BOULDERS.withConfiguration(new BYGBoulderFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlockList.WHITE_SANDSTONE.getDefaultState(), 3).addWeightedBlockstate(BYGBlockList.WHITE_SMOOTH_SANDSTONE.getDefaultState(), 2).addWeightedBlockstate(BYGBlockList.WHITE_SMOOTH_SANDSTONE.getDefaultState(), 3).addWeightedBlockstate(BYGBlockList.WHITE_SAND.getDefaultState(), 5)).setMinStackHeight(3).setMaxHeight(12).setMinRadius(13).setMaxRadius(20).setRadiusDivisor(1.1).flattenTopBoulder().build()).withPlacement(AtOceanFloorWithExtra.OCEANFLOOR.configure(new AtSurfaceWithExtraConfig(0, 0.04F, 1))));
//    public static ConfiguredFeature<?, ?> WHITE_SANDSTONE_BOULDER_W_FLAT_TOP = newConfiguredFeature("white_sandstone_boulder_w_flat_top", BYGFeatureList.STACKABLE_BOULDERS.withConfiguration(new BYGBoulderFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlockList.WHITE_SANDSTONE.getDefaultState(), 3).addWeightedBlockstate(BYGBlockList.WHITE_SANDSTONE.getDefaultState(), 2).addWeightedBlockstate(BYGBlockList.WHITE_SMOOTH_SANDSTONE.getDefaultState(), 3).addWeightedBlockstate(BYGBlockList.WHITE_SAND.getDefaultState(), 5)).setMinStackHeight(3).setMaxHeight(12).setMinRadius(13).setMaxRadius(20).setRadiusDivisor(1.1).flattenTopBoulder().build()).withPlacement(AtOceanFloorWithExtra.OCEANFLOOR.configure(new AtSurfaceWithExtraConfig(0, 0.01F, 1))));
//    public static ConfiguredFeature<?, ?> WHITE_SANDSTONE_BOULDER_XL = newConfiguredFeature("white_sandstone_boulder_xl", BYGFeatureList.STACKABLE_BOULDERS.withConfiguration(new BYGBoulderFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlockList.WHITE_SANDSTONE.getDefaultState(), 3).addWeightedBlockstate(BYGBlockList.WHITE_SANDSTONE.getDefaultState(), 2).addWeightedBlockstate(BYGBlockList.WHITE_SMOOTH_SANDSTONE.getDefaultState(), 3).addWeightedBlockstate(BYGBlockList.WHITE_SAND.getDefaultState(), 5)).setMinStackHeight(4).setMaxHeight(8).setMinRadius(25).setMaxRadius(28).setRadiusDivisor(1.1).build()).withPlacement(AtOceanFloorWithExtra.OCEANFLOOR.configure(new AtSurfaceWithExtraConfig(0, 0.005F, 1))));
