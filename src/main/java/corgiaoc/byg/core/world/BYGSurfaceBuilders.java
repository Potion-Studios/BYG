...
public class BYGSurfaceBuilders {
    ...
    public static final SurfaceBuilder<SurfaceBuilderConfig> CANYONS = WorldGenRegistrationHelper.createSurfaceBuilder("canyons", new CanyonSurfaceBuilder(SurfaceBuilderConfig.field_237203_a_));
    ...
    public static class Configs {
        ...
        public static final SurfaceBuilderConfig END_SAND = new SurfaceBuilderConfig(BYGBlocks.END_SAND.getDefaultState(), Blocks.END_STONE_BRICKS.getDefaultState(), Blocks.END_STONE_BRICKS.getDefaultState());
