...
public class BYGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> CHAINS = WorldGenRegistrationHelper.createConfiguredFeature("chains", BYGFeatures.CHAIN.withConfiguration(new ChainFeatureConfig.Builder().setMinLength(2).setMaxLength(7).setXAxisBlock(BYGBlocks.SOAPSTONE).setZAxisBlock(BYGBlocks.SOAPSTONE).setWhitelist(ImmutableList.of(Blocks.NETHERRACK)).build()).func_242733_d(128).func_242728_a().func_242731_b(4));
