...
public class BYGConfiguredFeatures {
    ...
    public static ConfiguredFeature<?, ?> OBBY_SPIKE = WorldGenRegistrationHelper.createConfiguredFeature("obsidian_spire", BYGFeatures.OBBYSPIKES.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.NOPE.configure(new NoPlacementConfig())));
