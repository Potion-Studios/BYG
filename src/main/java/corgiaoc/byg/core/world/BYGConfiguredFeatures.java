...
public class BYGConfiguredFeatures {
    ...
    public static ConfiguredFeature<?, ?> IVIS_SPIKES = WorldGenRegistrationHelper.createConfiguredFeature("ivis_spikes1", BYGFeatures.TALL_POINTED_ROCK.withConfiguration(new PointyRockFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(Blocks.OBSIDIAN.getDefaultState(), 24).addWeightedBlockstate(Blocks.CRYING_OBSIDIAN.getDefaultState(), 1)).setSeed(120).setHeightMultiplier(0.4).build()));
    public static ConfiguredFeature<?, ?> IVIS_SPIKES2 = WorldGenRegistrationHelper.createConfiguredFeature("ivis_spikes2", BYGFeatures.TALL_POINTED_ROCK.withConfiguration(new PointyRockFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(Blocks.OBSIDIAN.getDefaultState(), 24).addWeightedBlockstate(Blocks.CRYING_OBSIDIAN.getDefaultState(), 1)).setSeed(15676).setHeightMultiplier(0.8).build()));
...
//    public static ConfiguredFeature<?, ?> WHITE_SANDSTONE_BOULDER_XL = WorldGenRegistrationHelper.createConfiguredFeature("white_sandstone_boulder_xl", BYGDefaultBiomeFeatures.STACKABLE_BOULDERS.withConfiguration(new BYGBoulderFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlocks.WHITE_SANDSTONE.getDefaultState(), 3).addWeightedBlockstate(BYGBlocks.WHITE_SANDSTONE.getDefaultState(), 2).addWeightedBlockstate(BYGBlocks.WHITE_SMOOTH_SANDSTONE.getDefaultState(), 3).addWeightedBlockstate(BYGBlocks.WHITE_SAND.getDefaultState(), 5)).setMinStackHeight(4).setMaxHeight(8).setMinRadius(25).setMaxRadius(28).setRadiusDivisor(1.1).build()).withPlacement(BYGDecorators.OCEANFLOOR.configure(new AtSurfaceWithExtraConfig(0, 0.005F, 1))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_SOUL_SOIL_PILLARS = WorldGenRegistrationHelper.createConfiguredFeature("soul_soil_pillars", BYGFeatures.PILLARS.withConfiguration(new SimpleBlockProviderConfig(new SimpleBlockStateProvider(Blocks.SOUL_SOIL.getDefaultState()))).func_242733_d(128).func_242728_a().func_242731_b(50));
    public static final ConfiguredFeature<?, ?> RANDOM_FROST_MAGMA_PILLARS = WorldGenRegistrationHelper.createConfiguredFeature("frost_magma_pillars", BYGFeatures.PILLARS.withConfiguration((new SimpleBlockProviderConfig(new SimpleBlockStateProvider(BYGBlocks.FROST_MAGMA.getDefaultState())))).func_242733_d(128).func_242728_a().func_242731_b(50));
    public static final ConfiguredFeature<?, ?> RANDOM_MAGMA_PILLARS = WorldGenRegistrationHelper.createConfiguredFeature("magma_pillars", BYGFeatures.PILLARS.withConfiguration((new SimpleBlockProviderConfig(new SimpleBlockStateProvider(Blocks.MAGMA_BLOCK.getDefaultState())))).func_242733_d(128).func_242728_a().func_242731_b(65));
    public static final ConfiguredFeature<?, ?> RANDOM_BRIMSTONE_PILLARS = WorldGenRegistrationHelper.createConfiguredFeature("brimstone_pillars", BYGFeatures.PILLARS.withConfiguration((new SimpleBlockProviderConfig(new SimpleBlockStateProvider(BYGBlocks.BRIMSTONE.getDefaultState())))).func_242733_d(128).func_242728_a().func_242731_b(80));
