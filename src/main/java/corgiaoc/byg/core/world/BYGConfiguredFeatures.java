...
public class BYGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ALLIUM_BUSH = createConfiguredFeature("allium_bush", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.ALLIUM_FLOWER_BUSH.defaultBlockState()), new SimpleBlockPlacer())).tries(100).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ALLIUM_PINK_BUSH = createConfiguredFeature("pink_allium_bush", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.PINK_ALLIUM_FLOWER_BUSH.defaultBlockState()), new SimpleBlockPlacer())).tries(100).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ALLIUM_TALL_BUSH = createConfiguredFeature("tall_allium_bush", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.TALL_ALLIUM.defaultBlockState()), new DoublePlantBlockPlacer())).tries(100).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ALLIUM_TALL_PINK_BUSH = createConfiguredFeature("tall_pink_allium_bush", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.TALL_PINK_ALLIUM.defaultBlockState()), new DoublePlantBlockPlacer())).tries(100).noProjection().build()));

    public static final ConfiguredFeature<?, ?> AMARANTH = createConfiguredFeature("amaranth", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.AMARANTH.defaultBlockState()), new SimpleBlockPlacer())).tries(100).noProjection().build()));
    public static final ConfiguredFeature<?, ?> AMARANTH_MAGENTA = createConfiguredFeature("magenta_amaranth", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.MAGENTA_AMARANTH.defaultBlockState()), new SimpleBlockPlacer())).tries(100).noProjection().build()));
    public static final ConfiguredFeature<?, ?> AMARANTH_ORANGE = createConfiguredFeature("orange_amaranth", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.ORANGE_AMARANTH.defaultBlockState()), new SimpleBlockPlacer())).tries(100).noProjection().build()));
    public static final ConfiguredFeature<?, ?> AMARANTH_PURPLE = createConfiguredFeature("purple_amaranth", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.PURPLE_AMARANTH.defaultBlockState()), new SimpleBlockPlacer())).tries(100).noProjection().build()));
    public static final ConfiguredFeature<?, ?> AMARANTH_CYAN = createConfiguredFeature("cyan_amaranth", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.CYAN_AMARANTH.defaultBlockState()), new SimpleBlockPlacer())).tries(100).noProjection().build()));
    ...
    public static final ConfiguredFeature<?, ?> BEEHIVES = createConfiguredFeature("beehives", BYGFeatures.BEEHIVE.configured(new NoFeatureConfig()).range(256).squared().count(6));
    ...
    public static final ConfiguredFeature<?, ?> CALIFORNIA_POPPY = createConfiguredFeature("california_poppy", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.CALIFORNIA_POPPY.defaultBlockState()), new SimpleBlockPlacer())).tries(10).noProjection().build()));
    ...
    public static final ConfiguredFeature<?, ?> PRAIRIE_GRASS_PATCH = createConfiguredFeature("prairie_grass_patch", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.PRAIRIE_GRASS.defaultBlockState()), new SimpleBlockPlacer())).tries(100).noProjection().build()));
    ...
    public static final ConfiguredFeature<?, ?> ROSE_BUSH = createConfiguredFeature("rose_bush", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.ROSE_BUSH.defaultBlockState()), new DoublePlantBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> DELPHINIUM = createConfiguredFeature("delphinium", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.DELPHINIUM.defaultBlockState()), new DoublePlantBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> JAPANESE_ORCHID = createConfiguredFeature("japanese_orchid", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.JAPANESE_ORCHID.defaultBlockState()), new DoublePlantBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> FOXGLOVE = createConfiguredFeature("foxglove", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.FOXGLOVE.defaultBlockState()), new DoublePlantBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> AZALEA = createConfiguredFeature("azalea", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.AZALEA.defaultBlockState()), new DoublePlantBlockPlacer())).tries(64).noProjection().build()));

    public static final ConfiguredFeature<?, ?> FLOWERING_INDIGO_JACARANDA_BUSH = createConfiguredFeature("flowering_indigo_jacaranda_bush", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.FLOWERING_INDIGO_JACARANDA_BUSH.defaultBlockState()), new SimpleBlockPlacer())).tries(32).build()));
    public static final ConfiguredFeature<?, ?> INDIGO_JACARANDA_BUSH = createConfiguredFeature("indigo_jacaranda_bush", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.INDIGO_JACARANDA_BUSH.defaultBlockState()), new SimpleBlockPlacer())).tries(32).build()));
    public static final ConfiguredFeature<?, ?> FLOWERING_JACARANDA_BUSH = createConfiguredFeature("flowering_jacaranda_bush", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.FLOWERING_JACARANDA_BUSH.defaultBlockState()), new SimpleBlockPlacer())).tries(32).build()));
    public static final ConfiguredFeature<?, ?> JACARANDA_BUSH = createConfiguredFeature("jacaranda_bush", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.JACARANDA_BUSH.defaultBlockState()), new SimpleBlockPlacer())).tries(32).build()));
    ...
    public static final ConfiguredFeature<?, ?> CROCUS = createConfiguredFeature("crocus", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.CROCUS.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> IRIS = createConfiguredFeature("iris", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.IRIS.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ANEMONE_WHITE = createConfiguredFeature("white_anemone", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.WHITE_ANEMONE.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ANEMONE_PINK = createConfiguredFeature("pink_anemone", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.PINK_ANEMONE.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    ...
    public static final ConfiguredFeature<?, ?> ALLIUM_PINK = createConfiguredFeature("pink_allium", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.PINK_ALLIUM.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> DAISY_ORANGE = createConfiguredFeature("orange_daisy", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.ORANGE_DAISY.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> CORNFLOWER_RED = createConfiguredFeature("red_cornflower", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.RED_CORNFLOWER.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> SAGE_WHITE = createConfiguredFeature("white_sage", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.WHITE_SAGE.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> SAGE_PURPLE = createConfiguredFeature("purple_sage", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.PURPLE_SAGE.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> DAFFODIL_YELLOW = createConfiguredFeature("yellow_daffodil", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.YELLOW_DAFFODIL.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    ...
    public static final ConfiguredFeature<?, ?> LOLIPOP_FLOWER = createConfiguredFeature("lolipop_flower", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.LOLIPOP_FLOWER.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ORCHID_RED = createConfiguredFeature("red_orchid", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.RED_ORCHID.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ORCHID_PINK = createConfiguredFeature("pink_orchid", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.PINK_ORCHID.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ORCHID_PURPLE = createConfiguredFeature("purple_orchid", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.PURPLE_ORCHID.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> LEATHER_FLOWER_PEACH = createConfiguredFeature("peach_leather_flower", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.PEACH_LEATHER_FLOWER.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> LEATHER_FLOWER_VIOLET = createConfiguredFeature("violet_leather_flower", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.VIOLET_LEATHER_FLOWER.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));

    public static final ConfiguredFeature<?, ?> DAFFODIL_PINK = createConfiguredFeature("pink_daffodil", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.PINK_DAFFODIL.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> DAFFODIL = createConfiguredFeature("daffodil", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.DAFFODIL.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ROSE_BLACK = createConfiguredFeature("black_rose", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.BLACK_ROSE.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ROSE_CYAN = createConfiguredFeature("cyan_rose", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.CYAN_ROSE.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> ROSE_OSIRIA = createConfiguredFeature("osiria_rose", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.ORSIRIA_ROSE.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    public static final ConfiguredFeature<?, ?> FAIRY_SLIPPER = createConfiguredFeature("fairy_slipper", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.FAIRY_SLIPPER.defaultBlockState()), new SimpleBlockPlacer())).tries(64).noProjection().build()));
    ...
    public static final ConfiguredFeature<?, ?> OVERWORLD_LAKE = createConfiguredFeature("overworld_lake", BYGFeatures.OVERWORLD_LAKE.configured(IFeatureConfig.NONE).decorated(Placement.WATER_LAKE.configured(new ChanceConfig(25))));
    public static final ConfiguredFeature<?, ?> DENSE_OVERWORLD_LAKE = createConfiguredFeature("dense_overworld_lake", BYGFeatures.OVERWORLD_LAKE.configured(IFeatureConfig.NONE).decorated(Placement.WATER_LAKE.configured(new ChanceConfig(2))));
    ...
    public static final ConfiguredFeature<?, ?> GLOWSHROOM_CAVES = createConfiguredFeature("glow_caves", BYGFeatures.NOISY_CAVE_SPHERE.configured((new NoisySphereConfig.Builder().setMinXRadius(20).setMaxXRadius(30).setMinYRadius(10).setMaxYRadius(16).setMinZRadius(14).setMaxZRadius(20).setBlock(Blocks.CAVE_AIR).setFluidStartY(12).build())).decorated(Placement.RANGE.configured(new TopSolidRangeConfig(25, 0, 40)).count(1)));
    ...
    public static final ConfiguredFeature<?, ?> SUBZERO_CRYSTAL = createConfiguredFeature("subzero_crystal", BYGFeatures.SUBZERO_CRYSTAL.configured(new NoFeatureConfig()).range(128).squared().count(90));
    ...
    public static final ConfiguredFeature<?, ?> JAPANESE_ORCHIDS = createConfiguredFeature("japanese_orchids",  JAPANESE_ORCHID.decorated(Features.Placements.ADD_32).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(2));
    ...
    public static final ConfiguredFeature<?, ?> DEFAULT_LILY_PAD = createConfiguredFeature("default_lily_pad",  Features.PATCH_WATERLILLY.decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE.count(3)));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_JACARANDA_BUSHES = createConfiguredFeature("jacaranda_bushes", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            JACARANDA_BUSH)).decorated(Placement.COUNT_MULTILAYER.configured(new FeatureSpreadConfig(2))));
    ...
    public static final ConfiguredFeature<BYGTreeConfig, ?> JACARANDA_TREE1 = createConfiguredFeature("jacaranda_tree1", BYGFeatures.JACARANDA_TREE1.configured(new BYGTreeConfig.Builder().setTrunkBlock(BYGBlocks.JACARANDA_LOG).setLeavesBlock(new WeightedBlockStateProvider().add(BYGBlocks.FLOWERING_JACARANDA_LEAVES.defaultBlockState(), 10).add(BYGBlocks.JACARANDA_LEAVES.defaultBlockState(), 40)).setMaxHeight(15).setMinHeight(9).build()));
    public static final ConfiguredFeature<BYGTreeConfig, ?> JACARANDA_TREE2 = createConfiguredFeature("jacaranda_tree2", BYGFeatures.JACARANDA_TREE2.configured(new BYGTreeConfig.Builder().setTrunkBlock(BYGBlocks.JACARANDA_LOG).setLeavesBlock(new WeightedBlockStateProvider().add(BYGBlocks.FLOWERING_JACARANDA_LEAVES.defaultBlockState(), 10).add(BYGBlocks.JACARANDA_LEAVES.defaultBlockState(), 40)).setMaxHeight(12).setMinHeight(7).build()));
    public static final ConfiguredFeature<BYGTreeConfig, ?> INDIGO_JACARANDA_TREE1 = createConfiguredFeature("indigo_jacaranda_tree1", BYGFeatures.JACARANDA_TREE1.configured(new BYGTreeConfig.Builder().copy(JACARANDA_TREE1.config).setLeavesBlock(new WeightedBlockStateProvider().add(BYGBlocks.FLOWERING_INDIGO_JACARANDA_LEAVES.defaultBlockState(), 10).add(BYGBlocks.INDIGO_JACARANDA_LEAVES.defaultBlockState(), 40)).build()));
    public static final ConfiguredFeature<BYGTreeConfig, ?> INDIGO_JACARANDA_TREE2 = createConfiguredFeature("indigo_jacaranda_tree2", BYGFeatures.JACARANDA_TREE2.configured(new BYGTreeConfig.Builder().copy(JACARANDA_TREE2.config).setLeavesBlock(new WeightedBlockStateProvider().add(BYGBlocks.FLOWERING_INDIGO_JACARANDA_LEAVES.defaultBlockState(), 10).add(BYGBlocks.INDIGO_JACARANDA_LEAVES.defaultBlockState(), 40)).build()));
    ...
    public static final ConfiguredFeature<BYGTreeConfig, ?> WITHERING_OAK_TREE5 = createConfiguredFeature("withering_oak_tree5", BYGFeatures.WITHERING_OAK_TREE5.configured(new BYGTreeConfig.Builder().setTrunkBlock(BYGBlocks.WITHERING_OAK_LOG).setLeavesBlock(BYGBlocks.WITHERING_OAK_LEAVES).setMaxHeight(30).setMinHeight(22).build()));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_ANCIENT_TREE = createConfiguredFeature("ancient_forest_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(10, 0.2F, 5))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_BAYOU_TREE = createConfiguredFeature("bayou_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(5, 0.3F, 2))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_CORAL_MANGROVE = createConfiguredFeature("mg_coral", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(20, 0.3F, 2))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_BLUFF_TREE = createConfiguredFeature("bluff_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(10, 0.45F, -4))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_CONIFER_TREE = createConfiguredFeature("conifer_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(15, 0.4F, -3))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_JACARANDA_TREE = createConfiguredFeature("jacaranda_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(20, 0.1F, -5))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_RAINFOREST_FUNGAL_TREE = createConfiguredFeature("fungal_rainforest_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(20, 0.25F, -5))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_SKYRIS_TREE = createConfiguredFeature("skyris_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(2, 0.45F, 2))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_BAOBAB_TREE = createConfiguredFeature("baobab_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(0, 0.45F, 1))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_MEADOW_TREE = createConfiguredFeature("meadow_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(2, 0.4F, 4))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_MARSH_TREE = createConfiguredFeature("marsh_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(2, 0.35F, 2))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_ENCHANTED_TREE = createConfiguredFeature("enchanted_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(7, 0.4F, -2))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_ZELKOVA_TREE = createConfiguredFeature("zelkova_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(13, 0.4F, -3))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_DENSE_PALM_TREE = createConfiguredFeature("palm_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            PALM_TREE2.weighted(0.35F)),
            PALM_TREE1)).decorated(Features.Placements.HEIGHTMAP_SQUARE).decorated(Placement.COUNT_EXTRA.configured(
            new AtSurfaceWithExtraConfig(7, 0.3F, -3))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_CHERRY_TREE = createConfiguredFeature("cherry_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(14, 0.35F, -4))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_HOLLY_TREE = createConfiguredFeature("holly_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(20, 0.35F, -5))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_ORCHARD_TREE = createConfiguredFeature("orchard_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(1, 0.35F, 1))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_SEASONAL_BIRCH_FOREST_TREE = createConfiguredFeature("seasonal_birch_forest_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            new AtSurfaceWithExtraConfig(8, 0.3F, -4))));
