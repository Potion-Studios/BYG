...
public class BYGConfiguredFeatures {
    ...
    public static class OreConfigs {
        ...
        public static final ConfiguredFeature<?, ?> ORE_PENDORITE = createConfiguredFeature("ore_pendorite", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES, BYGBlocks.PENDORITE_ORE.defaultBlockState(), 4)).range(120).squared().count(18));
