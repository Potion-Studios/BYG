...
public class BYGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> EMBUR_ROOTS = WorldGenRegistrationHelper.createConfiguredFeature("embur_roots", BYGFeatures.EMBUR_ROOTS.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG));
    ...
    public static final ConfiguredFeature<?, ?> EMBUR_WART = WorldGenRegistrationHelper.createConfiguredFeature("embur_wart", BYGFeatures.EMBUR_WART.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG));
    public static final ConfiguredFeature<?, ?> EMBUR_SPROUTS = WorldGenRegistrationHelper.createConfiguredFeature("embur_sprouts", BYGFeatures.EMBUR_SPROUTS.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG));
