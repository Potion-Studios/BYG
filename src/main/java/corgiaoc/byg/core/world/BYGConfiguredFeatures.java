...
public class BYGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> TINY_LILY_PAD = createConfiguredFeature("tiny_lily_pad", Feature.RANDOM_PATCH.configured((new RandomPatchConfiguration.GrassConfigurationBuilder(new SimpleStateProvider(BYGBlocks.TINY_LILYPADS.defaultBlockState()), new SimpleBlockPlacer())).tries(10).build()));
    public static final ConfiguredFeature<?, ?> WATER_SILK = createConfiguredFeature("water_silk", Feature.RANDOM_PATCH.configured((new RandomPatchConfiguration.GrassConfigurationBuilder(new SimpleStateProvider(BYGBlocks.WATER_SILK.defaultBlockState()), new SimpleBlockPlacer())).tries(128).build()));
    ...
    public static class SpreadableBlockConfigs {
        ...
        public static final RandomPatchConfiguration MEADOW_CONFIG = new RandomPatchConfiguration.GrassConfigurationBuilder(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BYGBlocks.CLOVER_PATCH.defaultBlockState(), 15).add(Blocks.GRASS.defaultBlockState(), 55).add(Blocks.PINK_TULIP.defaultBlockState(), 15).add(BYGBlocks.MAGENTA_TULIP.defaultBlockState(), 15).add(BYGBlocks.CYAN_TULIP.defaultBlockState(), 15).add(BYGBlocks.WHITE_ANEMONE.defaultBlockState(), 15).add(BYGBlocks.ROSE.defaultBlockState(), 10)), new DoubleBlockPlacer()).build();
