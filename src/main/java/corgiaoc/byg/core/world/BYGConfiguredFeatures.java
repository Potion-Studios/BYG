...
public class BYGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ODDITY_BUSH = createConfiguredFeature("oddity_bush", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.ODDITY_BUSH.getDefaultState()), new SimpleBlockPlacer())).tries(32).build()));
    ...
    public static final ConfiguredFeature<?, ?> IMPARIUS_BUSH = createConfiguredFeature("imparius_bush", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.IMPARIUS_BUSH.getDefaultState()), new SimpleBlockPlacer())).tries(32).build()));
    ...
    public static final ConfiguredFeature<?, ?> END_STONE_BRICK_SPIKE = createConfiguredFeature("end_stone_brick_spike1", BYGFeatures.TALL_POINTED_ROCK.withConfiguration(new PointyRockConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(Blocks.END_STONE_BRICKS.getDefaultState(), 24).addWeightedBlockstate(Blocks.END_STONE.getDefaultState(), 1)).setSeed(120).setHeightMultiplier(0.3).build()));
    public static final ConfiguredFeature<?, ?> END_STONE_BRICK_SPIKE2 = createConfiguredFeature("end_stone_brick_spike2", BYGFeatures.TALL_POINTED_ROCK.withConfiguration(new PointyRockConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(Blocks.END_STONE_BRICKS.getDefaultState(), 24).addWeightedBlockstate(Blocks.END_STONE.getDefaultState(), 1)).setSeed(15676).setHeightMultiplier(0.4).build()));
    public static final ConfiguredFeature<?, ?> END_STONE_BOULDER = createConfiguredFeature("end_stone_boulder", BYGFeatures.STACKABLE_BOULDERS.withConfiguration(new BoulderConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(Blocks.END_STONE.getDefaultState(), 3).addWeightedBlockstate(Blocks.END_STONE_BRICKS.getDefaultState(), 2)).setMinStackHeight(1).setMaxHeight(1).setMinRadius(4).setMaxRadius(8).build()).withPlacement(BYGDecorators.OCEAN_FLOOR_COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(0, 0.1F, 1))));
    ...
    public static final ConfiguredFeature<?, ?> CANYON_RIVER = createConfiguredFeature("ahhhh", BYGFeatures.CANYON_RIVER.withConfiguration(new NoFeatureConfig()).withPlacement(Placement.NOPE.configure(new NoPlacementConfig())));
    ...
    public static final ConfiguredFeature<?, ?> IMPARIUS_BUSHES = createConfiguredFeature("imparius_bushes",  IMPARIUS_BUSH.withPlacement(Placement.COUNT_MULTILAYER.configure(new FeatureSpreadConfig(5))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_IMPARIUS_MUSHROOM = createConfiguredFeature("imparius_mushrooms", Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(
            IMPARIUS_MUSHROOM3.withChance(0.25F),
