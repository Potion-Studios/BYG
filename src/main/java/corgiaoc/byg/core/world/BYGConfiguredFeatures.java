...
public class BYGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> PURPUR_PEAK = WorldGenRegistrationHelper.createConfiguredFeature("purpur_peaks", BYGFeatures.PURPUR_PEAK.withConfiguration(new SimpleBlockProviderConfig(new WeightedBlockStateProvider().addWeightedBlockstate(BYGBlocks.PURPUR_STONE.getDefaultState(), 10).addWeightedBlockstate(Blocks.PURPUR_BLOCK.getDefaultState(), 5))).withPlacement(BYGDecorators.OCEAN_FLOOR_COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(0, 0.25F, 1))));
    ...
    public static final ConfiguredFeature<?, ?> RANDOM_CRYPTIC_FIRE_PATCH = WorldGenRegistrationHelper.createConfiguredFeature("patch_cryptic_fire", Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(
            ...
            CRYPTIC_FIRE)).withPlacement(Placement.field_242897_C.configure(new FeatureSpreadConfig(1))));
