...
public class BYGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ODDITY_BUSH = createConfiguredFeature("oddity_bush", Feature.SIMPLE_BLOCK.withConfiguration(new BlockWithContextConfig(BYGBlocks.ODDITY_BUSH.getDefaultState(), ImmutableList.of(BYGBlocks.END_SAND.getDefaultState(), Blocks.END_STONE_BRICKS.getDefaultState(), Blocks.END_STONE.getDefaultState()), ImmutableList.of(Blocks.AIR.getDefaultState()), ImmutableList.of(Blocks.AIR.getDefaultState(), Blocks.END_STONE.getDefaultState(), Blocks.END_STONE_BRICKS.getDefaultState(), BYGBlocks.END_SAND.getDefaultState()))));
