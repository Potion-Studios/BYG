...
public class BYGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> TINY_LILY_PAD = createConfiguredFeature("tiny_lily_pad", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BYGBlocks.TINY_LILYPADS.defaultBlockState()), new OnWaterOnlyBlockPlacer())).tries(10).build()));
