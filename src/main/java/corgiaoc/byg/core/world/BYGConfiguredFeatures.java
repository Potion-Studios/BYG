...
public class BYGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> WEEPING_ROOTS_PLANT = WorldGenRegistrationHelper.createConfiguredFeature("weeping_roots_plant", BYGFeatures.WEEPING_ROOTS_PLANT.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG));
