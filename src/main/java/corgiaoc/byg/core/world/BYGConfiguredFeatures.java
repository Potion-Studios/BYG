...
public class BYGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> OVERWORLD_LAKE = createConfiguredFeature("overworld_lake", BYGFeatures.OVERWORLD_LAKE.configured(IFeatureConfig.NONE).decorated(Placement.WATER_LAKE.configured(new ChanceConfig(15))));
