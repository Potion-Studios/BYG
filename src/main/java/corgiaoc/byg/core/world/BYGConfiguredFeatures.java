...
public class BYGConfiguredFeatures {
    ...
    //Giant Flowers
    public static final ConfiguredFeature<BYGGiantFlowerFeatureConfig, ?> GIANT_ANGELICA_FLOWER = WorldGenRegistrationHelper.createConfiguredFeature("giant_angelica", BYGFeatures.GIANT_ANGELICA_FLOWER.withConfiguration(new BYGGiantFlowerFeatureConfig.Builder().setStemBlock(BYGBlocks.PLANT_STEM).setPetalBlock(BYGBlocks.WHITE_PETAL).setMaxHeight(18).setMinHeight(12).build()));
    public static final ConfiguredFeature<BYGGiantFlowerFeatureConfig, ?> GIANT_DANDELION_FLOWER = WorldGenRegistrationHelper.createConfiguredFeature("giant_dandelion", BYGFeatures.GIANT_DANDELION_FLOWER.withConfiguration(new BYGGiantFlowerFeatureConfig.Builder().setStemBlock(BYGBlocks.PLANT_STEM).setPetalBlock(BYGBlocks.RED_PETAL).setPetal2Block(BYGBlocks.YELLOW_PETAL).setMaxHeight(12).setMinHeight(6).build()));
    public static final ConfiguredFeature<BYGGiantFlowerFeatureConfig, ?> GIANT_IRIS_FLOWER = WorldGenRegistrationHelper.createConfiguredFeature("giant_iris", BYGFeatures.GIANT_IRIS_FLOWER.withConfiguration(new BYGGiantFlowerFeatureConfig.Builder().setStemBlock(BYGBlocks.PLANT_STEM).setPetalBlock(BYGBlocks.PURPLE_PETAL).setPetal2Block(BYGBlocks.YELLOW_PETAL).setMaxHeight(12).setMinHeight(6).build()));
    public static final ConfiguredFeature<BYGGiantFlowerFeatureConfig, ?> GIANT_ROSE_FLOWER = WorldGenRegistrationHelper.createConfiguredFeature("giant_rose", BYGFeatures.GIANT_ROSE_FLOWER.withConfiguration(new BYGGiantFlowerFeatureConfig.Builder().setStemBlock(BYGBlocks.PLANT_STEM).setPetalBlock(BYGBlocks.RED_PETAL).setMaxHeight(12).setMinHeight(6).build()));
    ...
    public static final ConfiguredFeature<?, ?> CHAINS = WorldGenRegistrationHelper.createConfiguredFeature("chains", BYGFeatures.CHAINS.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG));
    ...
    public static final ConfiguredFeature<?, ?> WAILING_GRASS = WorldGenRegistrationHelper.createConfiguredFeature("wailing_grass", Feature.SIMPLE_BLOCK.withConfiguration(new BlockWithContextConfig(BYGBlocks.WAILING_VINES.getDefaultState(), ImmutableList.of(BYGBlocks.OVERGROWN_NETHERRACK.getDefaultState(), Blocks.SOUL_SAND.getDefaultState(), Blocks.SOUL_SOIL.getDefaultState()), ImmutableList.of(Blocks.AIR.getDefaultState()), ImmutableList.of(Blocks.AIR.getDefaultState(), Blocks.NETHERRACK.getDefaultState(), BYGBlocks.OVERGROWN_NETHERRACK.getDefaultState(), Blocks.SOUL_SAND.getDefaultState(), Blocks.SOUL_SOIL.getDefaultState()))));
    ...
    public static final ConfiguredFeature<?, ?> NETHER_BRISTLE = WorldGenRegistrationHelper.createConfiguredFeature("nether_bristle", BYGFeatures.NETHER_BRISTLE.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG));
    ...
    public static final ConfiguredFeature<?, ?> EMBUR_ROOTS_TALL = WorldGenRegistrationHelper.createConfiguredFeature("tall_embur_roots", BYGFeatures.TALL_EMBUR_ROOTS.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG));
    public static final ConfiguredFeature<?, ?> EMBUR_GEL_VINES = WorldGenRegistrationHelper.createConfiguredFeature("embur_gel_vines", BYGFeatures.EMBUR_GEL_VINES.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG));
    ...
    public static final ConfiguredFeature<?, ?> IVIS_SPIKES = WorldGenRegistrationHelper.createConfiguredFeature("ivis_spikes1", BYGFeatures.TALL_POINTED_ROCK.withConfiguration(new PointyRockFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(Blocks.OBSIDIAN.getDefaultState(), 24).addWeightedBlockstate(Blocks.CRYING_OBSIDIAN.getDefaultState(), 1)).setSeed(120).setHeightMultiplier(0.4).build()));
    public static final ConfiguredFeature<?, ?> IVIS_SPIKES2 = WorldGenRegistrationHelper.createConfiguredFeature("ivis_spikes2", BYGFeatures.TALL_POINTED_ROCK.withConfiguration(new PointyRockFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(Blocks.OBSIDIAN.getDefaultState(), 24).addWeightedBlockstate(Blocks.CRYING_OBSIDIAN.getDefaultState(), 1)).setSeed(15676).setHeightMultiplier(0.8).build()));
    ...
    public static final ConfiguredFeature<?, ?> EMBUR_LAKE = WorldGenRegistrationHelper.createConfiguredFeature("embur_lake", BYGFeatures.EMBURLAKE.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.field_242907_l.configure(new TopSolidRangeConfig(32, 0, 4)).func_242728_a()).func_242731_b(15));
    public static final ConfiguredFeature<?, ?> STACKED_BOULDERS = WorldGenRegistrationHelper.createConfiguredFeature("stacked_boulders", BYGFeatures.STACKABLE_BOULDERS.withConfiguration(new BYGBoulderFeatureConfig.Builder().setBlock(new WeightedBlockStateProvider().addWeightedBlockstate(Blocks.STONE.getDefaultState(), 3).addWeightedBlockstate(Blocks.DIORITE.getDefaultState(), 2)).setMinStackHeight(10).setMaxHeight(15).setMinRadius(8).setMaxRadius(28).build()).withPlacement(BYGDecorators.OCEAN_FLOOR.configure(new AtSurfaceWithExtraConfig(0, 0.15F, 1))));
    ...
    public static final ConfiguredFeature<?, ?> VOLCANO = WorldGenRegistrationHelper.createConfiguredFeature("volcano", BYGFeatures.VOLCANO.withConfiguration(DecoratedFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.NOPE.configure(new NoPlacementConfig())));
    ...
    public static final ConfiguredFeature<?, ?> HANGING_SOUL_SHROOM_SPORES = WorldGenRegistrationHelper.createConfiguredFeature("hanging_soul_shroom_spores", BYGFeatures.HANGING_FEATURE.withConfiguration(new SimpleHangingFeatureConfig.Builder().setBaseBlock(BYGBlocks.SOUL_SHROOM_BLOCK).setBlock(BYGBlocks.SOUL_SHROOM_SPORE).setEndBlock(BYGBlocks.SOUL_SHROOM_SPORE_END.getDefaultState().with(AbstractTopPlantBlock.AGE, 23)).setMinLength(1).setMaxLength(8).setWhitelist(ImmutableList.of(Blocks.SOUL_SOIL, Blocks.SOUL_SAND)).build()).func_242733_d(128).func_242728_a().func_242731_b(45));
    public static final ConfiguredFeature<?, ?> HANGING_SYTHIAN_ROOTS = WorldGenRegistrationHelper.createConfiguredFeature("hanging_sythian_roots", BYGFeatures.HANGING_FEATURE.withConfiguration(new SimpleHangingFeatureConfig.Builder().setBaseBlock(BYGBlocks.SYTHIAN_WART_BLOCK).setBlock(BYGBlocks.HANGING_SYTHIAN_ROOTS).setEndBlock(BYGBlocks.HANGING_SYTHIAN_ROOTS_PLANT.getDefaultState().with(AbstractTopPlantBlock.AGE, 23)).setMinLength(1).setMaxLength(8).setWhitelist(ImmutableList.of(Blocks.NETHERRACK, BYGBlocks.SYTHIAN_WART_BLOCK)).build()).func_242733_d(128).func_242728_a().func_242731_b(80));
    ...
    //Birch
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_TREE1 = WorldGenRegistrationHelper.createConfiguredFeature("birch_tree1", BYGFeatures.BIRCH_TREE1.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.BIRCH_LOG).setLeavesBlock(BYGBlocks.BROWN_BIRCH_LEAVES).setMaxHeight(11).setMinHeight(8).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_TREE2 = WorldGenRegistrationHelper.createConfiguredFeature("birch_tree2", BYGFeatures.BIRCH_TREE2.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.BIRCH_LOG).setLeavesBlock(BYGBlocks.BROWN_BIRCH_LEAVES).setMaxHeight(11).setMinHeight(8).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_TREE3 = WorldGenRegistrationHelper.createConfiguredFeature("birch_tree3", BYGFeatures.BIRCH_TREE3.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.BIRCH_LOG).setLeavesBlock(BYGBlocks.BROWN_BIRCH_LEAVES).setMaxHeight(11).setMinHeight(8).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_TREE4 = WorldGenRegistrationHelper.createConfiguredFeature("birch_tree3", BYGFeatures.BIRCH_TREE4.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.BIRCH_LOG).setLeavesBlock(BYGBlocks.BROWN_BIRCH_LEAVES).setMaxHeight(11).setMinHeight(8).build()));


    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_BROWN_TREE1 = WorldGenRegistrationHelper.createConfiguredFeature("brown_birch_tree1", BYGFeatures.BIRCH_TREE1.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE1.config).setLeavesBlock(BYGBlocks.BROWN_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_BROWN_TREE2 = WorldGenRegistrationHelper.createConfiguredFeature("brown_birch_tree2", BYGFeatures.BIRCH_TREE2.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE2.config).setLeavesBlock(BYGBlocks.BROWN_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_BROWN_TREE3 = WorldGenRegistrationHelper.createConfiguredFeature("brown_birch_tree3", BYGFeatures.BIRCH_TREE3.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE3.config).setLeavesBlock(BYGBlocks.BROWN_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_BROWN_TREE4 = WorldGenRegistrationHelper.createConfiguredFeature("brown_birch_tree4", BYGFeatures.BIRCH_TREE4.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE4.config).setLeavesBlock(BYGBlocks.BROWN_BIRCH_LEAVES).build()));


    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_ORANGE_TREE1 = WorldGenRegistrationHelper.createConfiguredFeature("orange_birch_tree1", BYGFeatures.BIRCH_TREE1.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE1.config).setLeavesBlock(BYGBlocks.ORANGE_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_ORANGE_TREE2 = WorldGenRegistrationHelper.createConfiguredFeature("orange_birch_tree2", BYGFeatures.BIRCH_TREE2.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE2.config).setLeavesBlock(BYGBlocks.ORANGE_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_ORANGE_TREE3 = WorldGenRegistrationHelper.createConfiguredFeature("orange_birch_tree3", BYGFeatures.BIRCH_TREE3.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE3.config).setLeavesBlock(BYGBlocks.ORANGE_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_ORANGE_TREE4 = WorldGenRegistrationHelper.createConfiguredFeature("orange_birch_tree4", BYGFeatures.BIRCH_TREE4.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE4.config).setLeavesBlock(BYGBlocks.ORANGE_BIRCH_LEAVES).build()));

    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_RED_TREE1 = WorldGenRegistrationHelper.createConfiguredFeature("red_birch_tree1", BYGFeatures.BIRCH_TREE1.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE1.config).setLeavesBlock(BYGBlocks.RED_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_RED_TREE2 = WorldGenRegistrationHelper.createConfiguredFeature("red_birch_tree2", BYGFeatures.BIRCH_TREE2.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE2.config).setLeavesBlock(BYGBlocks.RED_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_RED_TREE3 = WorldGenRegistrationHelper.createConfiguredFeature("red_birch_tree3", BYGFeatures.BIRCH_TREE3.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE3.config).setLeavesBlock(BYGBlocks.RED_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_RED_TREE4 = WorldGenRegistrationHelper.createConfiguredFeature("red_birch_tree4", BYGFeatures.BIRCH_TREE4.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE4.config).setLeavesBlock(BYGBlocks.RED_BIRCH_LEAVES).build()));

    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_YELLOW_TREE1 = WorldGenRegistrationHelper.createConfiguredFeature("yellow_birch_tree1", BYGFeatures.BIRCH_TREE1.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE1.config).setLeavesBlock(BYGBlocks.YELLOW_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_YELLOW_TREE2 = WorldGenRegistrationHelper.createConfiguredFeature("yellow_birch_tree2", BYGFeatures.BIRCH_TREE2.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE2.config).setLeavesBlock(BYGBlocks.YELLOW_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_YELLOW_TREE3 = WorldGenRegistrationHelper.createConfiguredFeature("yellow_birch_tree3", BYGFeatures.BIRCH_TREE3.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE3.config).setLeavesBlock(BYGBlocks.YELLOW_BIRCH_LEAVES).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> BIRCH_YELLOW_TREE4 = WorldGenRegistrationHelper.createConfiguredFeature("yellow_birch_tree4", BYGFeatures.BIRCH_TREE4.withConfiguration(new BYGTreeFeatureConfig.Builder().copy(BIRCH_TREE4.config).setLeavesBlock(BYGBlocks.YELLOW_BIRCH_LEAVES).build()));
    ...
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> MANGROVE_TREE1 = WorldGenRegistrationHelper.createConfiguredFeature("mangrove_tree1", BYGFeatures.MANGROVE_TREE1.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlocks.MANGROVE_LOG).setLeavesBlock(BYGBlocks.MANGROVE_LEAVES).setMaxHeight(15).setMinHeight(10).setWhitelist(ImmutableList.of(BYGBlocks.MOSSY_STONE)).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> MANGROVE_TREE2 = WorldGenRegistrationHelper.createConfiguredFeature("mangrove_tree2", BYGFeatures.MANGROVE_TREE2.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlocks.MANGROVE_LOG).setLeavesBlock(BYGBlocks.MANGROVE_LEAVES).setMaxHeight(17).setMinHeight(11).setWhitelist(ImmutableList.of(BYGBlocks.MOSSY_STONE)).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> MANGROVE_TREE3 = WorldGenRegistrationHelper.createConfiguredFeature("mangrove_tree3", BYGFeatures.MANGROVE_TREE3.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlocks.MANGROVE_LOG).setLeavesBlock(BYGBlocks.MANGROVE_LEAVES).setMaxHeight(16).setMinHeight(12).setWhitelist(ImmutableList.of(BYGBlocks.MOSSY_STONE)).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> MANGROVE_TREE4 = WorldGenRegistrationHelper.createConfiguredFeature("mangrove_tree4", BYGFeatures.MANGROVE_TREE4.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlocks.MANGROVE_LOG).setLeavesBlock(BYGBlocks.MANGROVE_LEAVES).setMaxHeight(15).setMinHeight(10).setWhitelist(ImmutableList.of(BYGBlocks.MOSSY_STONE)).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> MANGROVE_TREE5 = WorldGenRegistrationHelper.createConfiguredFeature("mangrove_tree5", BYGFeatures.MANGROVE_TREE5.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlocks.MANGROVE_LOG).setLeavesBlock(BYGBlocks.MANGROVE_LEAVES).setMaxHeight(17).setMinHeight(11).setWhitelist(ImmutableList.of(BYGBlocks.MOSSY_STONE)).build()));
    ...
    //Oak
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> OAK_TREE1 = WorldGenRegistrationHelper.createConfiguredFeature("oak_tree1", BYGFeatures.OAK_TREE1.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.OAK_LOG).setLeavesBlock(Blocks.OAK_LEAVES).setMaxHeight(18).setMinHeight(13).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> OAK_TREE2 = WorldGenRegistrationHelper.createConfiguredFeature("oak_tree2", BYGFeatures.OAK_TREE2.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.OAK_LOG).setLeavesBlock(Blocks.OAK_LEAVES).setMaxHeight(18).setMinHeight(13).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> OAK_TREE3 = WorldGenRegistrationHelper.createConfiguredFeature("oak_tree3", BYGFeatures.OAK_TREE3.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.OAK_LOG).setLeavesBlock(Blocks.OAK_LEAVES).setMaxHeight(18).setMinHeight(13).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> OAK_TREE_LARGE1 = WorldGenRegistrationHelper.createConfiguredFeature("large_oak_tree1", BYGFeatures.OAK_TREE_LARGE1.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.OAK_LOG).setLeavesBlock(Blocks.OAK_LEAVES).setMaxHeight(18).setMinHeight(13).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> OAK_TREE_LARGE2 = WorldGenRegistrationHelper.createConfiguredFeature("large_oak_tree2", BYGFeatures.OAK_TREE_LARGE2.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.OAK_LOG).setLeavesBlock(Blocks.OAK_LEAVES).setMaxHeight(18).setMinHeight(13).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> OAK_TREE_LARGE3 = WorldGenRegistrationHelper.createConfiguredFeature("large_oak_tree3", BYGFeatures.OAK_TREE_LARGE3.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(Blocks.OAK_LOG).setLeavesBlock(Blocks.OAK_LEAVES).setMaxHeight(18).setMinHeight(13).build()));
    ...
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> LAMENT_WEEPING_TREE1 = WorldGenRegistrationHelper.createConfiguredFeature("lament_weeping_tree1", BYGFeatures.LAMENT_WEEPING_TREE1.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlocks.LAMENT_LOG).setLeavesBlock(BYGBlocks.LAMENT_LEAVES).setMaxHeight(30).setMinHeight(22).setWhitelist(ImmutableList.of(Blocks.LAVA)).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> LAMENT_WEEPING_TREE2 = WorldGenRegistrationHelper.createConfiguredFeature("lament_weeping_tree2", BYGFeatures.LAMENT_WEEPING_TREE2.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlocks.LAMENT_LOG).setLeavesBlock(BYGBlocks.LAMENT_LEAVES).setMaxHeight(30).setMinHeight(22).setWhitelist(ImmutableList.of(Blocks.LAVA)).build()));
    public static final ConfiguredFeature<BYGTreeFeatureConfig, ?> LAMENT_WEEPING_TREE3 = WorldGenRegistrationHelper.createConfiguredFeature("lament_weeping_tree3", BYGFeatures.LAMENT_WEEPING_TREE3.withConfiguration(new BYGTreeFeatureConfig.Builder().setTrunkBlock(BYGBlocks.LAMENT_LOG).setLeavesBlock(BYGBlocks.LAMENT_LEAVES).setMaxHeight(30).setMinHeight(22).setWhitelist(ImmutableList.of(Blocks.LAVA)).build()));
