...
public class BYGFeatures {
    ...
    public static final Feature<DefaultFeatureConfig> DUMMY_TREE = createFeature("dummy_tree", new SmallPineTree(DefaultFeatureConfig.CODEC.stable()));
    public static final Feature<DefaultFeatureConfig> BEEHIVE = createFeature("beehive", new BeeHiveFeature(DefaultFeatureConfig.CODEC.stable()));
    public static final Feature<DefaultFeatureConfig> HUH = createFeature("river_feature", new RiverThingy(DefaultFeatureConfig.CODEC.stable()));
    ...
    //Lakes
    public static final Feature<SingleStateFeatureConfig> FROSTED_LAKE = createFeature("frosted_lake", new FrostMagmaLakeFeature(SingleStateFeatureConfig.CODEC.stable()));
    ...
    //Wailing
    public static final Feature<DefaultFeatureConfig> WAILING_VINES = createFeature("wailing_vine", new WailingVine(DefaultFeatureConfig.CODEC.stable()));
    ...
    //QuartzDesert
    public static final Feature<BasaltColumnsFeatureConfig> QUARTZ_COLUMNS = createFeature("quartz_columns", new RawQuartzColumnFeature(BasaltColumnsFeatureConfig.CODEC.stable()));
