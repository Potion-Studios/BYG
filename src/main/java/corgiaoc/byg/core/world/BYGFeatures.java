...
//    public static List<Feature<?>> features = new ArrayList<>();
    ...
    public static final Feature<DefaultFeatureConfig> DUMMY_TREE = WorldGenRegistrationHelper.createFeature("dummy_tree", new SmallPineTree(DefaultFeatureConfig.CODEC.stable()));
    public static final Feature<DefaultFeatureConfig> BEEHIVE = WorldGenRegistrationHelper.createFeature("beehive", new BeeHiveFeature(DefaultFeatureConfig.CODEC.stable()));
    public static final Feature<DefaultFeatureConfig> HUH = WorldGenRegistrationHelper.createFeature("river_feature", new RiverThingy(DefaultFeatureConfig.CODEC.stable()));
    ...
    //Lakes
    public static final Feature<SingleStateFeatureConfig> FROSTED_LAKE = WorldGenRegistrationHelper.createFeature("frosted_lake", new FrostMagmaLakeFeature(SingleStateFeatureConfig.CODEC.stable()));
    ...
    //Wailing
    public static final Feature<DefaultFeatureConfig> WAILING_VINES = WorldGenRegistrationHelper.createFeature("wailing_vine", new WailingVine(DefaultFeatureConfig.CODEC.stable()));
    ...
    //QuartzDesert
    public static final Feature<BasaltColumnsFeatureConfig> QUARTZ_COLUMNS = WorldGenRegistrationHelper.createFeature("quartz_columns", new RawQuartzColumnFeature(BasaltColumnsFeatureConfig.CODEC.stable()));
