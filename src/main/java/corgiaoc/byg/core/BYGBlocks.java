...
public class BYGBlocks {
    ...
    public static final Block ARAUCARIA_SAPLING = createSapling(new TreeSpawners.Araucaria(), "araucaria_sapling");
    public static final Block ASPEN_SAPLING = createSapling(new TreeSpawners.Aspen(), "aspen_sapling");
    public static final Block BAOBAB_SAPLING = createSapling(new TreeSpawners.Baobab(), "baobab_sapling");
    public static final Block BLUE_ENCHANTED_SAPLING = createSapling(new TreeSpawners.BlueEnchanted(), "blue_enchanted_sapling");
    public static final Block BLUE_SPRUCE_SAPLING = createSapling(new TreeSpawners.BlueSpruce(), "blue_spruce_sapling");
    public static final Block BROWN_BIRCH_SAPLING = createSapling(new TreeSpawners.BrownBirch(), "brown_birch_sapling");
    public static final Block BROWN_OAK_SAPLING = createSapling(new TreeSpawners.BrownOak(), "brown_oak_sapling");
    public static final Block BROWN_ZELKOVA_SAPLING = createSapling(new TreeSpawners.BrownZelkova(), "brown_zelkova_sapling");
    public static final Block CIKA_SAPLING = createSapling(new TreeSpawners.Cika(), "cika_sapling");
    public static final Block CYPRESS_SAPLING = createSapling(new TreeSpawners.Cypress(), "cypress_sapling");
    public static final Block EBONY_SAPLING = createSapling(new TreeSpawners.Ebony(), "ebony_sapling");
    public static final Block FIR_SAPLING = createSapling(new TreeSpawners.Fir(), "fir_sapling");
    public static final Block GREEN_ENCHANTED_SAPLING = createSapling(new TreeSpawners.GreenEnchanted(), "green_enchanted_sapling");
    public static final Block HOLLY_SAPLING = createSapling(new TreeSpawners.Holly(), "holly_sapling");
    public static final Block JACARANDA_SAPLING = createSapling(new TreeSpawners.Jacaranda(), "jacaranda_sapling");
    public static final Block INDIGO_JACARANDA_SAPLING = createSapling(new TreeSpawners.IndigoJacaranda(), "indigo_jacaranda_sapling");
    public static final Block JOSHUA_SAPLING = createSapling(new TreeSpawners.Joshua(), "joshua_sapling");
    public static final Block MAHOGANY_SAPLING = createSapling(new TreeSpawners.Mahogony(), "mahogany_sapling");
    public static final Block MANGROVE_SAPLING = createSapling(new TreeSpawners.Mangrove(), "mangrove_sapling");
    public static final Block MAPLE_SAPLING = createSapling(new TreeSpawners.Maple(), "maple_sapling");
    public static final Block ORANGE_BIRCH_SAPLING = createSapling(new TreeSpawners.OrangeBirch(), "orange_birch_sapling");
    public static final Block ORANGE_OAK_SAPLING = createSapling(new TreeSpawners.OrangeOak(), "orange_oak_sapling");
    public static final Block ORANGE_SPRUCE_SAPLING = createSapling(new TreeSpawners.OrangeSpruce(), "orange_spruce_sapling");
    public static final Block ORCHARD_SAPLING = createSapling(new TreeSpawners.Orchard(), "orchard_sapling");
    public static final Block PALO_VERDE_SAPLING = createSapling(new TreeSpawners.PaloVerde(), "palo_verde_sapling");
    public static final Block PINE_SAPLING = createSapling(new TreeSpawners.Pine(), "pine_sapling");
    public static final Block PINK_CHERRY_SAPLING = createSapling(new TreeSpawners.PinkCherry(), "pink_cherry_sapling");
    public static final Block RAINBOW_EUCALYPTUS_SAPLING = createSapling(new TreeSpawners.RainbowEucalyptus(), "rainbow_eucalyptus_sapling");
    public static final Block RED_BIRCH_SAPLING = createSapling(new TreeSpawners.RedBirch(), "red_birch_sapling");
    public static final Block RED_MAPLE_SAPLING = createSapling(new TreeSpawners.RedMaple(), "red_maple_sapling");
    public static final Block RED_OAK_SAPLING = createSapling(new TreeSpawners.RedOak(), "red_oak_sapling");
    public static final Block RED_SPRUCE_SAPLING = createSapling(new TreeSpawners.RedSpruce(), "red_spruce_sapling");
    public static final Block REDWOOD_SAPLING = createSapling(new TreeSpawners.Redwood(), "redwood_sapling");
    public static final Block SILVER_MAPLE_SAPLING = createSapling(new TreeSpawners.SilverMaple(), "silver_maple_sapling");
    public static final Block SKYRIS_SAPLING = createSapling(new TreeSpawners.Skyris(), "skyris_sapling");
    public static final Block WHITE_CHERRY_SAPLING = createSapling(new TreeSpawners.WhiteCherry(), "white_cherry_sapling");
    public static final Block WILLOW_SAPLING = createSapling(new TreeSpawners.Willow(), "willow_sapling");
    public static final Block WITCH_HAZEL_SAPLING = createSapling(new TreeSpawners.WitchHazel(), "witch_hazel_sapling");
    public static final Block YELLOW_BIRCH_SAPLING = createSapling(new TreeSpawners.YellowBirch(), "yellow_birch_sapling");
    public static final Block YELLOW_SPRUCE_SAPLING = createSapling(new TreeSpawners.YellowSpruce(), "yellow_spruce_sapling");
    public static final Block ZELKOVA_SAPLING = createSapling(new TreeSpawners.Zelkova(), "zelkova_sapling");
    public static final Block PALM_SAPLING = createSapling(new TreeSpawners.Palm(), "palm_sapling");
    public static final Block LAMENT_SAPLING = createSapling(new TreeSpawners.Lament(), "lament_sapling");
    public static final Block WITHERING_OAK_SAPLING = createSapling(new TreeSpawners.WitheringOak(), "withering_oak_sapling");
    public static final Block ETHER_SAPLING = createSapling(new TreeSpawners.Ether(), "ether_sapling");
    public static final Block NIGHTSHADE_SAPLING = createSapling(new TreeSpawners.Nightshade(), "nightshade_sapling");
...
//    public static final Block SHULKREN_PHYLIUM = createEndSpreadable(Blocks.END_STONE, BYGConfiguredFeatures.SpreadableBlockConfigs.VERMILION_SCULK_CONFIG, "shulkren_phylium");
    ...
    static Block createCrystal(String id) {
        Block crystal = new CrystalBlock(Block.Properties.create(Material.ROCK).sound(SoundType.GLASS).hardnessAndResistance(0.1f).notSolid().doesNotBlockMovement().setLightLevel((state) -> 6));
        Registry.register(Registry.BLOCK, new ResourceLocation(BYG.MOD_ID, id), crystal);
        return crystal;
    }

    static Block createDullCrystal(String id) {
        Block crystal = new CrystalBlock(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.1f).notSolid().doesNotBlockMovement());
        Registry.register(Registry.BLOCK, new ResourceLocation(BYG.MOD_ID, id), crystal);
        return crystal;
    }
    ...
    static Block createSapling(TreeSpawner tree, String id) {
