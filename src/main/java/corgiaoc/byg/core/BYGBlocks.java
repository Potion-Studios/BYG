...
import corgiaoc.byg.core.world.SpreadableBlockConfigs;
...
public class BYGBlocks {
    ...
    public static final Block OVERGROWN_CRIMSON_BLACKSTONE = createNetherStoneSpreadable(Blocks.BLACKSTONE, SpreadableBlockConfigs.OVERGROWN_BLACKSTONE_CONFIG, "overgrown_crimson_blackstone");
    public static final Block MYCELIUM_NETHERRACK = createNetherSpreadable(Blocks.NETHERRACK, SpreadableBlockConfigs.MYCELIUM_NETHERRACK_CONFIG, "mycelium_netherrack");
    public static final Block OVERGROWN_NETHERRACK = createNetherSpreadable(Blocks.NETHERRACK, SpreadableBlockConfigs.OVERGROWN_NETHERRACK_CONFIG, "overgrown_netherrack");
    public static final Block IVIS_PHYLIUM = createEndStoneSpreadable(Blocks.END_STONE, SpreadableBlockConfigs.IVIS_CONFIG, "ivis_phylium");
    public static final Block EMBUR_NYLIUM = createNetherSpreadable(BLUE_NETHERRACK, SpreadableBlockConfigs.EMBUR_ROOTS, "embur_nylium");
    public static final Block SYTHIAN_NYLIUM = createNetherSpreadable(Blocks.NETHERRACK, SpreadableBlockConfigs.SYTHIAN_CONFIG, "sythian_nylium");
    public static final Block MEADOW_GRASSBLOCK = createDirtSpreadable(MEADOW_DIRT, SpreadableBlockConfigs.MEADOW_CONFIG, "meadow_grass_block");
    public static final Block NIGHTSHADE_PHYLIUM = createEndStoneSpreadable(Blocks.END_STONE, SpreadableBlockConfigs.NIGHTSHADE_CONFIG, "nightshade_phylium");
    ...
    static Block createCraftingTable(String id) {
        Block createBlock = new BYGCraftingTableBlock(AbstractBlock.Settings.copy(Blocks.CRAFTING_TABLE));
        Registry.register(Registry.BLOCK, new Identifier(BYG.MOD_ID, id), createBlock);
    ...
    static Block createFlower(String id) {
        ...
        createPottedBlock(createBlock, id);
        blocksList.add(createBlock);
        flowerIDs.add(new Identifier(BYG.MOD_ID, id));
        return createBlock;
    }
...
//        blocksList.add(createBlock);
    ...
    static Block createBlock(Block block, String id) {
        Registry.register(Registry.BLOCK, new Identifier(BYG.MOD_ID, id), block);
