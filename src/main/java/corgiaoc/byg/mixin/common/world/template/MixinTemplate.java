//package voronoiaoc.byg.mixin.common.world.template;
//
...
//
//
//    @Shadow @Final private List<Template.Palette> blocks;
//
//    @Shadow @Final private List<Template.EntityInfo> entities;
//
//    @Shadow private BlockPos size;
//
//    @Shadow protected abstract void addEntitiesToWorld(IServerWorld p_237143_1_, BlockPos p_237143_2_, PlacementSettings placementIn);
//
//    /**
//     * @author
//     */
...
//                    Block blockCheck = world.getBlockState(pos).getBlock();
//                    int modifiedY = featureY;
//                    //|| pos.getX() == 0 && pos.getZ() == 1 || pos.getX() == 0 && pos.getZ() == -1 || pos.getX() == 1 && pos.getZ() == 0 || pos.getX() == -1 && pos.getZ() == 0
//                    if (blockCheck.getRegistryName().toString().contains("stem") && pos.getX() == 0 && pos.getZ() == 0) {
//                        trunkLogList.add("this.treeLog(changedBlocks, worldIn, mainmutable.add(" + featureX + ", " + modifiedY + ", " + realZ + "), boundsIn);");
//                    }
//
//                    else if (blockCheck.getRegistryName().toString().contains("stem")) {
//                        treeBranchList.add("placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(" + featureX + ", " + modifiedY + ", " + realZ + "), boundsIn);");
//                    }
//
//                    if (blockCheck.getRegistryName().toString().contains("wood_blewit")) {
//                        treeLeaveList.add("this.leafs(changedBlocks, worldIn, mainmutable.add(" + featureX + ", " + modifiedY + ", " + realZ + "), boundsIn);");
//                    }
//
//                });
