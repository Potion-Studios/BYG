...
//                    }
                    ...
                    if (blockCheck.getRegistryName().toString().contains("log") && pos.getX() == 0 && pos.getZ() == 0) {
                        trunkLogList.add("placeStem(STEM, worldIn, mainmutable.setPos(pos).move(" + featureX + ", " + modifiedY + ", " + realZ + "));");
                    } else if (blockCheck.getRegistryName().toString().contains("log")) {
                        treeBranchList.add("placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(" + featureX + ", " + modifiedY + ", " + realZ + "));");
                    }

                    if (blockCheck.getRegistryName().toString().contains("wart")) {
                        treeLeaveList.add("placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(" + featureX + ", " + modifiedY + ", " + realZ + "));");
                    }

                    if (blockCheck.getRegistryName().toString().contains("shroomlight")) {
                        treeLeaveList.add("placeShroomlight(worldIn, mainmutable.setPos(pos).move(" + featureX + ", " + modifiedY + ", " + realZ + "));");
                    }

                    if (blockCheck.getRegistryName().toString().contains("stone")) {
                        treeLeaveList.add("placeHangingBody(worldIn, mainmutable.setPos(pos).move(" + featureX + ", " + modifiedY + ", " + realZ + "));");
                    }

                    if (blockCheck.getRegistryName().toString().contains("granite")) {
                        treeLeaveList.add("placeHangingEnd(worldIn, mainmutable.setPos(pos).move(" + featureX + ", " + modifiedY + ", " + realZ + "));");
                    }
                });
