...
public class WarpedCactusBlock extends Block {
    ...
    public WarpedCactusBlock(Settings properties) {
        super(properties);
    ...
    public boolean canPlaceAt(BlockState state, WorldView worldIn, BlockPos pos) {
        ...
        return worldIn.getBlockState(pos.down()).getBlock() == BYGBlocks.NYLIUM_SOUL_SOIL || worldIn.getBlockState(pos.down()).getBlock() == BYGBlocks.NYLIUM_SOUL_SAND || worldIn.getBlockState(pos.down()).getBlock() == BYGBlocks.WARPED_CACTUS && !worldIn.getBlockState(pos.up()).getMaterial().isLiquid();
    }
