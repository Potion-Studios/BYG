...
public class SkyrisVillagePools {
   ...
   static {
      ...
      JigsawPatternRegistry.func_244094_a(new JigsawPattern(new ResourceLocation("byg:village/skyris/streets"),
              ...
              ImmutableList.of(Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_corner_01"), 3),
                      Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_corner_02"), 3),
                      Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_straight_01"), 4),
                      Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_straight_02"), 4),
                      Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_straight_03"), 3),
                      Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_crossroad_01"), 3),
                      Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_crossroad_02"), 3),
                      Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_crossroad_03"), 3),
                      Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_square_01"), 3),
                      Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_square_02"), 3),
                      Pair.of(JigsawPiece.func_242849_a("byg:village/skyris/streets/skyris_turn_01"), 3)), JigsawPattern.PlacementBehaviour.TERRAIN_MATCHING));
