...
public class SkyrisVillagePools {
   public static final StructureTemplatePool SkyrisVillageJigsaw = Pools.register(new StructureTemplatePool(new ResourceLocation("byg:village/skyris/town_centers"),
   ...
   static {
      ...
      Pools.register(new StructureTemplatePool(new ResourceLocation("byg:village/skyris/decor"),
              ...
              ImmutableList.of(Pair.of(StructurePoolElement.legacy("byg:village/skyris/skyris_lamp_1"), 10),
                      Pair.of(StructurePoolElement.feature(Features.PATCH_BERRY_DECORATED), 4),
