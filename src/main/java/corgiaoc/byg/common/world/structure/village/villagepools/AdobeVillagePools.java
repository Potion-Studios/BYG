...
public class AdobeVillagePools {
   public static final JigsawPattern ADOBE_VILLAGE_JIGSAW = JigsawPatternRegistry.register(new JigsawPattern(new ResourceLocation("byg:village/adobe/town_centers"),
           ...
           ImmutableList.of(Pair.of(JigsawPiece.legacy("byg:village/adobe/town_centers/adobe_meeting_point_1", ProcessorLists.MOSSIFY_10_PERCENT), 30),
                   ...
                   Pair.of(JigsawPiece.legacy("byg:village/adobe/town_centers/adobe_meeting_point_3", ProcessorLists.MOSSIFY_10_PERCENT), 35)), JigsawPattern.PlacementBehaviour.RIGID));
   ...
   static {
      //Normal
      JigsawPatternRegistry.register(new JigsawPattern(new ResourceLocation("byg:village/adobe/streets"),
              new ResourceLocation("byg:village/adobe/terminators"),
              ImmutableList.of(Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_corner_01"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_corner_02"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_straight_01"), 4),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_straight_02"), 4),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_straight_03"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_crossroad_01"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_crossroad_02"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_crossroad_03"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_square_01"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_square_02"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/streets/adobe_turn_01"), 3)), JigsawPattern.PlacementBehaviour.TERRAIN_MATCHING));
      
      JigsawPatternRegistry.register(new JigsawPattern(new ResourceLocation("byg:village/adobe/houses"),
              new ResourceLocation("byg:village/adobe/terminators"),
              ImmutableList.of(Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_small_house_1"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_small_house_2"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_small_house_3"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_small_house_4"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_small_house_5"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_small_house_6"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_small_house_7"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_medium_house_1"), 4),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_medium_house_2"), 4),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_medium_house_3"), 4),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_butcher_shop_1"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_fletcher_house_1"), 2),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_shepherd_house_1"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_armorer_1"), 1),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_fisher_1"), 2),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_tannery_1"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_cartographer_house_1"), 2),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_library_1"), 2),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_mason_1"), 2),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_weaponsmith_1"), 2),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_temple_1"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_temple_2"), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_large_farm_1", ProcessorLists.FARM_DESERT), 4),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_farm_1", ProcessorLists.FARM_DESERT), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_farm_2", ProcessorLists.FARM_DESERT), 3),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_animal_pen_1"), 2),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/houses/adobe_animal_pen_2"), 2),
      ...
      JigsawPatternRegistry.register(new JigsawPattern(new ResourceLocation("byg:village/adobe/decor"),
              new ResourceLocation("empty"),
              ImmutableList.of(Pair.of(JigsawPiece.legacy("byg:village/adobe/adobe_lamp_1"), 10),
                      Pair.of(JigsawPiece.feature(Features.PATCH_CACTUS_DECORATED), 3),
                      Pair.of(JigsawPiece.feature(Features.PILE_HAY), 2),
                      Pair.of(JigsawPiece.empty(), 6)), JigsawPattern.PlacementBehaviour.RIGID));
      
      JigsawPatternRegistry.register(new JigsawPattern(new ResourceLocation("byg:village/adobe/villagers"),
              new ResourceLocation("empty"),
              ImmutableList.of(Pair.of(JigsawPiece.legacy("byg:village/adobe/villagers/baby"), 1),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/villagers/baby"), 1),
                      Pair.of(JigsawPiece.legacy("byg:village/adobe/villagers/unemployed"), 10)), JigsawPattern.PlacementBehaviour.RIGID));
