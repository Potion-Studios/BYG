...
public class SkyrisHighlands extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("skyris_highlands", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new SurfaceBuilderBaseConfiguration(Blocks.GRASS_BLOCK.defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.DIRT.defaultBlockState())));
    ...
    public WeightedList<Biome> getHills() {
        ...
        biomeWeightedList.add(BYGBiomes.SKYRIS_HIGHLANDS_CLEARING, 4);
        biomeWeightedList.add(BYGBiomes.SKYRIS_PEAKS, 5);
        biomeWeightedList.add(BYGBiomes.SKYRIS_STEEPS, 1);
    ...
    public String[] getBiomeDictionary() {
        return new String[]{"CONIFEROUS", "COLD", "MOUNTAIN", "OVERWORLD"};
    }
    ...
    static {
        GENERATION_SETTINGS.addStructureStart(BYGConfiguredStructures.VILLAGE_SKYRIS);
