...
public class BorealForestHills extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeUtil.newConfiguredSurfaceBuilder("boreal_forest_hills", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.BOREAL_SB, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
