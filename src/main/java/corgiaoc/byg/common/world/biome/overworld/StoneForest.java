...
public class StoneForest extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeUtil.newConfiguredSurfaceBuilder("stone_forest", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.STONE_FOREST_SB, new SurfaceBuilderConfig(BYGBlocks.OVERGROWN_STONE.getDefaultState(), Blocks.STONE.getDefaultState(), Blocks.STONE.getDefaultState())));
...
//        this.addStructureFeature(DefaultBiomeFeatures.JUNGLE_PYRAMID);
    ...
    public Biome getHills(INoiseRandom rand) {
        return BYGBiomes.POINTY_STONE_FOREST;
    }
}