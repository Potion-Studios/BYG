...
public class ShatteredGlacier extends BYGBiome {
    ...
    static {
        ...
        GENERATION_SETTINGS.addFeature(GenerationStage.Decoration.TOP_LAYER_MODIFICATION, BYGConfiguredFeatures.BLACK_ICE_SNOW);
        ...
        SPAWN_SETTINGS.addSpawn(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.SNOW_GOLEM, 1, 1, 2));
