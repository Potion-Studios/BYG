...
public class CherryBlossomForest extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = RegistrationHelper.createConfiguredSurfaceBuilder("cherry_blossom_forest", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(), Blocks.DIRT.getDefaultState(), Blocks.DIRT.getDefaultState())));
    ...
    public Biome randomSubBiome(INoiseRandom random) {
        ...
        if (randomPicker == 0)
            return BYGBiomes.CHERRY_BLOSSOM_CLEARING;
