...
public class SnowyConiferousForest extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = RegistrationHelper.createConfiguredSurfaceBuilder("snowy_coniferous_forest", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.CONIFEROUS_SB, BYGSurfaceBuilders.BYGSBConfigList.PEATGRASS_CF));
    ...
    public HashMap<Biome, Integer> getHills() {
        ...
        map.put(BYGBiomes.SNOWYCONIFERFORESTHILLS, 1);
    ...
    public Biome randomSubBiome(INoiseRandom random) {
        ...
        if (randomPicker == 0)
            return BYGBiomes.SNOWYCONIFERFORESTHILLS;
