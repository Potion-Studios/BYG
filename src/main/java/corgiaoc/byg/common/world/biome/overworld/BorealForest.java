...
public class BorealForest extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("boreal_forest", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.BOREAL, SurfaceBuilder.GRASS_CONFIG));
    ...
    public WeightedList<Biome> getHills() {
        ...
        biomeWeightedList.add(BYGBiomes.BOREAL_FOREST_HILLS, 4);
        biomeWeightedList.add(BYGBiomes.BOREAL_CLEARING, 3);
    ...
    static {
        ...
        BYGDefaultBiomeFeatures.addBorealTrees(GENERATION_SETTINGS);
