...
public class GreatLakeIsles extends BYGBiome {
    static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = RegistrationHelper.createConfiguredSurfaceBuilder("great_lake_isles", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.GREAT_LAKE_ISLE_SB, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
