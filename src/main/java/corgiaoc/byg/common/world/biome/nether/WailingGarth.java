...
public class WailingGarth extends BYGNetherBiome {
    ...
    public WailingGarth() {
        super(WEATHER, CATEGORY, DEPTH, SCALE, (new BiomeAmbience.Builder()).setWaterColor(WATER_COLOR).setWaterFogColor(WATER_FOG_COLOR)
                ...
                .setAdditionsSound(new SoundAdditionsAmbience(BYGSounds.SoundRegistry.AMBIENT_WAILING_GARTH_ADDITIONS, 0.0111D))
    ...
    static {
        ...
        GENERATION_SETTINGS.withStructure(StructureFeatures.NETHER_FOSSIL); //Nether Fossils
