...
public class SnowyRockyBlackBeach extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeUtil.newConfiguredSurfaceBuilder("snowy_rock_black_beach", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.ROCKYBLACKBEACH_SB, BYGSurfaceBuilders.BYGSBConfigList.BLACKSAND));
