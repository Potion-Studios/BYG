...
public class BasaltBarrera extends BYGSubBiome {
    ...
    static final Biome.Precipitation PRECIPITATION = Biome.Precipitation.RAIN;
    ...
    static final Biome.ClimateSettings WEATHER = BiomeClimateSettingsAccess.create(PRECIPITATION, TEMPERATURE, Biome.TemperatureModifier.NONE, DOWNFALL);
