...
public class QuartzDesert extends BYGNetherBiome {
    ...
    public QuartzDesert() {
        super(WEATHER, CATEGORY, DEPTH, SCALE, (new BiomeEffects.Builder()).waterColor(WATER_COLOR).waterFogColor(WATER_FOG_COLOR)
                ...
                .particleConfig(new BiomeParticleConfig(ParticleTypes.WHITE_ASH, 0.01428F))
    ...
    static {
        ...
        GENERATION_SETTINGS.structureFeature(ConfiguredStructureFeatures.NETHER_FOSSIL); //Nether Fossils
        BYGDefaultBiomeFeatures.addQuartzDesertVegetations(GENERATION_SETTINGS);
