...
public class FrozenLake extends BYGSubBiome {
    ...
    public String[] getBiomeDictionary() {
        return new String[]{"SNOWY", "WET", "WATER", "OVERWORLD"};
    }
