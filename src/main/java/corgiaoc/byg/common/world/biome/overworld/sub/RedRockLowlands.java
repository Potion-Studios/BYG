...
public class RedRockLowlands extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = RegistrationHelper.createConfiguredSurfaceBuilder("red_rock_lowlands", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.RED_ROCKLOWLAND_SB, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
