...
public class RedRockLowlands extends BYGSubBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("red_rock_lowlands", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.RED_ROCK_LOWLANDS, SurfaceBuilder.CONFIG_GRASS));
