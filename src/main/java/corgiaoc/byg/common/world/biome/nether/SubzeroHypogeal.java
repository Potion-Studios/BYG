...
public class SubzeroHypogeal extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeUtil.newConfiguredSurfaceBuilder("subzero_hypogeal", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.SUBZERO_HYPOGEAL_SB, BYGSurfaceBuilders.BYGSBConfigList.FROST_MAGMA));
