...
public class SeasonalTaiga extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("seasonal_taiga", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG));
    ...
    public Biome getHills(LayerRandomnessSource rand) {
        return (rand.nextInt(2) == 0) ? BYGBiomes.SEASONAL_TAIGA_HILLS : BYGBiomes.SEASONAL_GIANT_TAIGA;
    }
