package corgiaoc.byg.common.world.biome.sub.clearings;
...
public class ZelkovaClearing extends BYGSubBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("zelkova_clearing", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(), Blocks.DIRT.getDefaultState(), Blocks.DIRT.getDefaultState())));
    ...
    static {
        ...
        BYGDefaultBiomeFeatures.addSparseZelkovaTrees(GENERATION_SETTINGS);
