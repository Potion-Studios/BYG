...
public class BrimstoneCaverns extends BYGBiome {
    static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = RegistrationHelper.createConfiguredSurfaceBuilder("brimstone_caverns", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.BRIMSTONE_CAVERNS_SB, BYGSurfaceBuilders.BYGSBConfigList.BRIMSTONE));
