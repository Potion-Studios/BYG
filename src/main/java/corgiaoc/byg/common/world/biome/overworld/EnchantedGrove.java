...
public class EnchantedGrove extends BYGBiome {
    ...
    public Biome getHills(INoiseRandom rand) {
        return (rand.random(5) == 0) ? BYGBiomes.FRESH_WATER_LAKE : BYGBiomes.FLOWERING_ENCHANTED_GROVE;
    }
    ...
    public WeightedList<Biome> getHills() {
        ...
        biomeWeightedList.func_226313_a_(BYGBiomes.FLOWERING_ENCHANTED_GROVE, 8);
