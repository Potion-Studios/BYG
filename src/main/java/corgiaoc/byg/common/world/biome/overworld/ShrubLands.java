...
public class ShrubLands extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("shrublands", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_CONFIG));
    ...
    public Biome getHills(LayerRandomnessSource rand) {
        return (rand.nextInt(5) == 0) ? BYGBiomes.POLLUTED_LAKE : BYGBiomes.SHRUBLANDS;
    }
    ...
    public WeightedList<Biome> getHills() {
        ...
        biomeWeightedList.add(BYGBiomes.POLLUTED_LAKE, 3);
        biomeWeightedList.add(this.getBiome(), 7);
        return biomeWeightedList;
    }

    @Override
    public Object getBiomeDictionary() {
        return null; //new BiomeDictionary.Type[]{BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.DRY, BiomeDictionary.Type.SPARSE, BiomeDictionary.Type.OVERWORLD};
    }
