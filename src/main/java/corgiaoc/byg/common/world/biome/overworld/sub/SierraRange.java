...
public class SierraRange extends BYGSubBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("sierra_range", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.ERODED_SIERRA, SurfaceBuilder.GRASS_CONFIG));
