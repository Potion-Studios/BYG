...
public class SierraRange extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = RegistrationHelper.createConfiguredSurfaceBuilder("sierra_range", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.ERODED_SIERRA_SB, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
