...
public class TropicalFungalRainForest extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("tropical_fungal_rainforest", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS));
    ...
    public Biome randomSubBiome(INoiseRandom random) {
        ...
        if (randomPicker == 0)
            return BYGBiomes.TROPICAL_FUNGAL_RAINFOREST_HILLS;
        else if (randomPicker == 1)
            return BYGBiomes.FUNGAL_PATCH;
    ...
    public WeightedList<Biome> getHills() {
        ...
        biomeWeightedList.add(BYGBiomes.FUNGAL_PATCH, 4);
        biomeWeightedList.add(BYGBiomes.TROPICAL_FUNGAL_RAINFOREST_HILLS, 3);
    ...
    public String[] getBiomeDictionary() {
        return new String[]{"JUNGLE", "HOT", "DENSE", "MAGICAL", "OVERWORLD"};
    }
    ...
    static {
        ...
        GENERATION_SETTINGS.addStructureStart(BYGConfiguredStructures.VILLAGE_TROPICAL);
        ...
        BYGDefaultBiomeFeatures.addFungalRainForestTrees(GENERATION_SETTINGS);
        DefaultBiomeFeatures.addDefaultMushrooms(GENERATION_SETTINGS);
        DefaultBiomeFeatures.addDefaultMushrooms(GENERATION_SETTINGS);
        BYGDefaultBiomeFeatures.addTropFungalMushrooms(GENERATION_SETTINGS);
        ...
        SPAWN_SETTINGS.addSpawn(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.OCELOT, 2, 1, 1));
