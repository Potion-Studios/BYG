...
public class TropicalFungalRainForest extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = RegistrationHelper.createConfiguredSurfaceBuilder("tropical_fungal_rainforest", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
    ...
    public HashMap<Biome, Integer> getHills() {
        ...
        map.put(BYGBiomes.TROPICALFUNGALRAINFORESTHILLS, 1);
        map.put(BYGBiomes.FUNGAL_PATCH, 2);
    ...
    public Biome randomSubBiome(INoiseRandom random) {
        ...
        if (randomPicker == 0)
            return BYGBiomes.TROPICALFUNGALRAINFORESTHILLS;
