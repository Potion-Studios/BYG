...
public class RedOakForestHills extends BYGSubBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("red_oak_forest_hills", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS));
    ...
    static {
        ...
        DefaultBiomeFeatures.addOtherBirchTrees(GENERATION_SETTINGS);
        DefaultBiomeFeatures.addOtherBirchTrees(GENERATION_SETTINGS);
