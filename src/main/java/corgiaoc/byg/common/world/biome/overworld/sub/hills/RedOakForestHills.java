...
public class RedOakForestHills extends BYGSubBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("red_oak_forest_hills", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
    ...
    public BiomeDictionary.Type[] getBiomeDictionary() {
        return new BiomeDictionary.Type[]{BiomeDictionary.Type.HILLS, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.OVERWORLD};
    }
    ...
    static {
        ...
        BYGDefaultBiomeFeatures.addRedOakForestTrees(GENERATION_SETTINGS);
        DefaultBiomeFeatures.withForestBirchTrees(GENERATION_SETTINGS);
        DefaultBiomeFeatures.withForestBirchTrees(GENERATION_SETTINGS);
