...
public class WitheringWoods extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeUtil.newConfiguredSurfaceBuilder("withering_woods", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.WITHERING_WOODS_SB, BYGSurfaceBuilders.BYGSBConfigList.MAGMATIC_STONE));
