...
public class MagmaWastes extends Biome implements BiomeTools {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeHelper.newConfiguredSurfaceBuilder("magma_wastes", new ConfiguredSurfaceBuilder<>(BYGSBList.MAGMA_WASTES_SB, BYGSBList.BYGSBConfigList.MAGMATIC_STONE));
    ...
    static {
        ...
        BYGTreeFeatures.addSparseWitheringOakTrees(GENERATION_SETTINGS);
