...
public class MagmaWastes extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeUtil.newConfiguredSurfaceBuilder("magma_wastes", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.MAGMA_WASTES_SB, BYGSurfaceBuilders.BYGSBConfigList.MAGMATIC_STONE));
