...
public class WoodLands extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("woodlands", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new TernarySurfaceConfig(Blocks.GRASS_BLOCK.getDefaultState(), Blocks.DIRT.getDefaultState(), Blocks.DIRT.getDefaultState())));
    ...
    public Biome getHills(LayerRandomnessSource rand) {
        return (rand.nextInt(5) == 0) ? BYGBiomes.FRESH_WATER_LAKE : BYGBiomes.FRESH_WATER_LAKE;
    }
    ...
    public Object getBiomeDictionary() {
        return null; //new BiomeDictionary.Type[]{BiomeDictionary.Type.FOREST, BiomeDictionary.Type.DENSE, BiomeDictionary.Type.MAGICAL, BiomeDictionary.Type.OVERWORLD};
    }
    ...
    static {
        GENERATION_SETTINGS.structureFeature(ConfiguredStructureFeatures.MANSION); //Mansion
        ...
        BYGDefaultBiomeFeatures.addWoodlandTrees(GENERATION_SETTINGS);
