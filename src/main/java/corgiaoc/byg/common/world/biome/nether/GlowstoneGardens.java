...
public class GlowstoneGardens extends BYGNetherBiome {
    ...
    public GlowstoneGardens() {
        super(WEATHER, CATEGORY, DEPTH, SCALE, (new BiomeSpecialEffects.Builder()).waterColor(WATER_COLOR).waterFogColor(WATER_FOG_COLOR)
                ...
                .ambientParticle(new AmbientParticleSettings(ParticleTypes.MYCELIUM, 0.01428F))
    ...
    static {
        ...
        GENERATION_SETTINGS.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Features.TWISTING_VINES); //Twisting Vines
        ...
        GENERATION_SETTINGS.addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, BYGConfiguredFeatures.ORE_PERVADED_NETHERRACK);
