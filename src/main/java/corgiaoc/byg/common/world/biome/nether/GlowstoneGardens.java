...
public class GlowstoneGardens extends BYGNetherBiome {
    ...
    public GlowstoneGardens() {
        super(WEATHER, CATEGORY, DEPTH, SCALE, (new BiomeAmbience.Builder()).waterColor(WATER_COLOR).waterFogColor(WATER_FOG_COLOR)
                ...
                .ambientParticle(new ParticleEffectAmbience(ParticleTypes.MYCELIUM, 0.01428F))
    ...
    static {
        ...
        GENERATION_SETTINGS.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Features.TWISTING_VINES); //Twisting Vines
        ...
        GENERATION_SETTINGS.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, BYGConfiguredFeatures.ORE_PERVADED_NETHERRACK);
