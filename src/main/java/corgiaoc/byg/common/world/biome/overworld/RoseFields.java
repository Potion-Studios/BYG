...
public class RoseFields extends BYGBiome {
    ...
    public RoseFields() {
        super(WEATHER, CATEGORY, DEPTH, SCALE, (new BiomeSpecialEffects.Builder()).grassColorOverride(GRASS_COLOR).foliageColorOverride(FOLIAGE_COLOR).waterColor(WATER_COLOR).waterFogColor(WATER_FOG_COLOR).fogColor(12638463).skyColor(BiomeUtil.calcSkyColor(0.8F)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build(), GENERATION_SETTINGS.build(), SPAWN_SETTINGS.build());
    }
    ...
    public String[] getBiomeDictionary() {
        return new String[]{"OVERWORLD", "PLAINS", "RARE", "LUSH"};
    }
