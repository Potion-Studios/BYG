...
public class SierraValley extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("sierra_valley", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.SIERRA_VALLEY, SurfaceBuilder.GRASS_CONFIG));
    ...
    public WeightedList<Biome> getHills() {
        ...
        biomeWeightedList.add(BYGBiomes.SIERRA_RANGE, 8);
