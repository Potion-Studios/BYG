...
public class Volcano extends BYGSubBiome {
    static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("volcano", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.VOLCANIC_FIELDS, SurfaceBuilder.GRASS_CONFIG));
...
//        GENERATION_SETTINGS.withStructure(BYGConfiguredStructures.VOLCANO_STRUCTURE);
        ...
        GENERATION_SETTINGS.feature(GenerationStep.Feature.VEGETAL_DECORATION, BYGConfiguredFeatures.RANDOM_DENSE_PALM_TREE);
