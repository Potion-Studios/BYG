...
public class Volcano extends BYGSubBiome {
    ...
    static final Biome.BiomeCategory CATEGORY = Biome.BiomeCategory.OCEAN;
...
//        GENERATION_SETTINGS.withStructure(BYGConfiguredStructures.VOLCANO_STRUCTURE);
        ...
        GENERATION_SETTINGS.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, BYGConfiguredFeatures.RANDOM_DENSE_PALM_TREE);
