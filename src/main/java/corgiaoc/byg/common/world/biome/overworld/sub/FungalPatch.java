...
public class FungalPatch extends BYGSubBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("funal_patch", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.FUNGAL_RAINFOREST, SurfaceBuilder.GRASS_CONFIG));
