...
public class FungalPatch extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = BiomeUtil.newConfiguredSurfaceBuilder("funal_patch", new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilders.FUNGAL_RAINFOREST_SB, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG));
