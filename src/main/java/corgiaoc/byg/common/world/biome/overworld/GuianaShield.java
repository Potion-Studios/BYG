...
public class GuianaShield extends BYGBiome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("guiana_shield", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(BYGBlocks.OVERGROWN_STONE.defaultBlockState(), Blocks.STONE.defaultBlockState(), Blocks.STONE.defaultBlockState())));
    ...
    public WeightedList<Biome> getHills() {
        ...
        biomeWeightedList.add(BYGBiomes.GUIANA_CLEARING, 8);
        biomeWeightedList.add(BYGBiomes.GUIANA_SPRINGS, 2);
    ...
    public String[] getBiomeDictionary() {
        return new String[]{"JUNGLE", "HOT", "DENSE", "FOREST", "MOUNTAIN", "OVERWORLD"};
    }
