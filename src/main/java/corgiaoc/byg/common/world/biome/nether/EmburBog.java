...
public class EmburBog extends BYGNetherBiome {
    ...
    public EmburBog() {
        super(WEATHER, CATEGORY, DEPTH, SCALE, (new BiomeSpecialEffects.Builder()).waterColor(WATER_COLOR).waterFogColor(WATER_FOG_COLOR)
                ...
                .ambientParticle(new AmbientParticleSettings(ParticleTypes.FLAME, 0.00228F))
    ...
    static {
        ...
        GENERATION_SETTINGS.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Features.DELTA);
        ...
        GENERATION_SETTINGS.addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, BYGConfiguredFeatures.RANDOM_EMBUR_MUSHROOM);
        ...
        SPAWN_SETTINGS.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.BLAZE, 20, 2, 4));
