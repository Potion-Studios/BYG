package corgiaoc.byg.common.world.feature.features.overworld.trees.meadow;
...
public class Shrub1 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {
    ...
    public Shrub1(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
