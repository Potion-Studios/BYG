...
public class MahoganyTree3 extends BYGAbstractTreeFeature<BYGTreeConfig> {

    public MahoganyTree3(Codec<BYGTreeConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean generate(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), config)) {
                ...
                return false;
            } else if (isCliff(worldIn, mainmutable.set(pos).move(-3, 0, 1).toImmutable(), mainmutable.set(pos).move(-2, 0, 0).toImmutable(), mainmutable.set(pos).move(-2, 0, 1).toImmutable(), mainmutable.set(pos).move(-2, 0, 2).toImmutable(), mainmutable.set(pos).move(-1, 0, -1).toImmutable(), mainmutable.set(pos).move(-1, 0, 0).toImmutable(), mainmutable.set(pos).move(-1, 0, 1).toImmutable(), mainmutable.set(pos).move(-1, 0, 2).toImmutable(), mainmutable.set(pos).move(-1, 0, 3).toImmutable(), mainmutable.set(pos).move(0, 0, 1).toImmutable(), mainmutable.set(pos).move(0, 0, 2).toImmutable(), mainmutable.set(pos).move(1, 0, 1))) {
                return false;
            } else {
                buildTrunkBase(changedBlocks, worldIn, config, rand, boundsIn, mainmutable.set(pos).move(-3, 0, 1).toImmutable(), mainmutable.set(pos).move(-2, 0, 0).toImmutable(), mainmutable.set(pos).move(-2, 0, 1).toImmutable(), mainmutable.set(pos).move(-2, 0, 2).toImmutable(), mainmutable.set(pos).move(-1, 0, -1).toImmutable(), mainmutable.set(pos).move(-1, 0, 0).toImmutable(), mainmutable.set(pos).move(-1, 0, 1).toImmutable(), mainmutable.set(pos).move(-1, 0, 2).toImmutable(), mainmutable.set(pos).move(-1, 0, 3).toImmutable(), mainmutable.set(pos).move(0, 0, 1).toImmutable(), mainmutable.set(pos).move(0, 0, 2).toImmutable(), mainmutable.set(pos).move(1, 0, 1));
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 11, -4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 11, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 11, 4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 11, 5), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(2, 11, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(2, 11, 4), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-3, 17, 2), boundsIn);
