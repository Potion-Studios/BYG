    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwEndTags(config, worldIn, pos.down(), BYGBlocks.IVIS_PHYLIUM)) {
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(3, 5, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(3, 5, 1));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-4, 6, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 6, -4));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 6, 4));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(4, 6, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-4, 7, -2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-4, 7, -1));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-4, 7, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-4, 7, 1));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-4, 7, 2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-2, 7, -4));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-2, 7, 4));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-1, 7, -4));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-1, 7, 4));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 7, -4));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 7, 4));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(1, 7, -4));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(1, 7, 4));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(2, 7, -4));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(4, 7, 1));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(4, 7, 2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-6, 8, -3));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-6, 8, 3));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-5, 8, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-3, 8, -6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-3, 8, 6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 8, -5));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 8, 5));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(3, 8, -6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(3, 8, 6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(5, 8, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(6, 8, -3));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(6, 8, 3));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-6, 9, -2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-6, 9, -1));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-6, 9, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-6, 9, 1));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-6, 9, 2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-2, 9, -6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-2, 9, 6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-1, 9, -6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-1, 9, 6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 9, -6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 9, 6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(1, 9, -6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(1, 9, 6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(2, 9, -6));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(6, 9, 1));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(6, 9, 2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-7, 10, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-6, 10, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 10, -7));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 10, -6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 10, 6));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 10, 7));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(6, 10, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(7, 10, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-7, 11, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 11, -7));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 11, 7));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(7, 11, 0));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-2, 12, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 12, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 12, 4));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(0, 12, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 12, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 12, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 12, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 12, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 12, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 12, -3));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(1, 12, -2));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(1, 12, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 12, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 12, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 12, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 12, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 12, -3));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(2, 12, 0));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(2, 12, 1));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(2, 12, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 12, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 12, 4));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-3, 13, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 13, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 13, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 13, 4));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-2, 13, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 13, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 13, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 13, 5));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-5, 15, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-5, 15, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-5, 15, 2));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-3, 15, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 15, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 15, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 15, 4));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-2, 15, -2));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-2, 15, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 15, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 15, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 15, 5));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-1, 15, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 15, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 15, 5));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-2, 16, 1));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-2, 16, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 16, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 16, 4));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-1, 16, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 16, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 16, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 16, 5));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 19, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 19, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 20, 0));
            }
        }
        return true;
    }
