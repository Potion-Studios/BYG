...
public class NoisyCaveSphere extends Feature<NoisyCaveSphereConfig> {
    ...
    @Override
    public boolean generate(StructureWorldAccess world, ChunkGenerator chunkGenerator, Random random, BlockPos position, NoisyCaveSphereConfig config) {
...
//                            airCarvingMask.set(bitIndex);
                            if (mutable2.getY() <= 25) {
                                ...
                                if (isSolidAllAround) {
                                    ...
                                    world.getFluidTickScheduler().schedule(mutable2, Fluids.LAVA, 0);
                                }
                            } else
