    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwEndTags(config, worldIn, pos.down(), BYGBlocks.SHULKREN_PHYLIUM)) {
                ...
                placeHangingEnd(worldIn, mainmutable.setPos(pos).move(-2, 7, 5));
                ...
                placeHangingBody(worldIn, mainmutable.setPos(pos).move(-2, 8, 5));
                placeHangingEnd(worldIn, mainmutable.setPos(pos).move(0, 8, -6));
                ...
                placeHangingBody(worldIn, mainmutable.setPos(pos).move(0, 9, -6));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 9, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 9, 4));
                placeHangingEnd(worldIn, mainmutable.setPos(pos).move(2, 9, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 9, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 9, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 9, -3));
                placeHangingEnd(worldIn, mainmutable.setPos(pos).move(4, 9, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(5, 9, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-5, 10, -2));
                placeHangingEnd(worldIn, mainmutable.setPos(pos).move(-5, 10, 0));
                ...
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-3, 10, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 10, 4));
                ...
                placeHangingBody(worldIn, mainmutable.setPos(pos).move(0, 10, -6));
                placeHangingEnd(worldIn, mainmutable.setPos(pos).move(0, 10, 6));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 10, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 10, -5));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(2, 10, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 10, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 10, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 10, -3));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(3, 10, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 10, -3));
                placeHangingBody(worldIn, mainmutable.setPos(pos).move(4, 10, 0));
                ...
                placeHangingBody(worldIn, mainmutable.setPos(pos).move(-5, 11, 0));
                ...
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-3, 11, -2));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-3, 11, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 11, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 11, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 11, -5));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-2, 11, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 11, -3));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-2, 11, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 11, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 11, 5));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-1, 11, 4));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 11, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 11, -4));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(2, 11, -3));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(2, 11, 3));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(2, 11, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 11, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 11, -4));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 11, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 11, -3));
                placeHangingBody(worldIn, mainmutable.setPos(pos).move(4, 11, 0));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-4, 13, 1));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-4, 13, 2));
                ...
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-2, 13, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 13, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 13, 3));
                ...
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-1, 13, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 13, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 13, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 13, 5));
                ...
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(0, 13, -3));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(0, 13, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 13, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 13, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 13, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 13, -4));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 13, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 13, 5));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(2, 13, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 13, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 13, -2));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(2, 13, -1));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(2, 13, 1));
                ...
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(0, 14, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 14, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 14, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 14, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 14, 3));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 14, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 14, -2));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(2, 14, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 14, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 14, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 14, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 14, -1));
                ...
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-2, 15, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 15, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 15, 3));
                ...
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-3, 16, -2));
                ...
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(-2, 16, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 16, 2));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 16, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 16, -3));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(1, 16, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 16, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 16, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 16, 2));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(3, 16, -2));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 17, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 17, 2));
                placeShroomlight(worldIn, mainmutable.setPos(pos).move(1, 17, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 17, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 17, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 17, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 17, 1));
