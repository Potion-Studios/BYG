...
public class EmburMushroom2 extends BYGAbstractMushroomFeature<BYGMushroomConfig> {
    ...
    protected boolean placeMushroom(StructureWorldAccess worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), BYGBlocks.EMBUR_NYLIUM)) {
                ...
                placeStemBranch(STEM, worldIn, mainmutable.set(pos).move(5, 7, 0));
                placeStemBranch(STEM, worldIn, mainmutable.set(pos).move(-2, 7, 1));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.set(pos).move(5, 9, 0));
                placeStemBranch(STEM, worldIn, mainmutable.set(pos).move(-2, 9, 1));
                placeStemBranch(STEM, worldIn, mainmutable.set(pos).move(-4, 9, 3));
                placeStemBranch(STEM, worldIn, mainmutable.set(pos).move(5, 10, 0));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.set(pos).move(5, 12, 0));
                placeStemBranch(STEM, worldIn, mainmutable.set(pos).move(-3, 12, 2));
                placeStemBranch(STEM, worldIn, mainmutable.set(pos).move(-3, 13, 2));
                placeStemBranch(STEM, worldIn, mainmutable.set(pos).move(-3, 14, 2));
                ...
                this.shroomLight(worldIn, mainmutable.set(pos).move(0, 3, -2));
                this.shroomLight(worldIn, mainmutable.set(pos).move(1, 3, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(2, 3, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(-2, 3, -1));
                this.shroomLight(worldIn, mainmutable.set(pos).move(-1, 3, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(2, 3, -1));
                ...
                this.shroomLight(worldIn, mainmutable.set(pos).move(1, 8, -2));
                ...
                this.shroomLight(worldIn, mainmutable.set(pos).move(3, 8, -1));
                ...
                this.shroomLight(worldIn, mainmutable.set(pos).move(-3, 8, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(-2, 8, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(-6, 8, 4));
                this.shroomLight(worldIn, mainmutable.set(pos).move(-5, 8, 4));
                ...
                this.shroomLight(worldIn, mainmutable.set(pos).move(5, 12, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(7, 12, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(3, 12, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(7, 12, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(3, 12, 1));
                this.shroomLight(worldIn, mainmutable.set(pos).move(5, 12, 1));
                this.shroomLight(worldIn, mainmutable.set(pos).move(6, 12, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(7, 12, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(4, 12, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(5, 12, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(6, 12, 2));
                ...
                this.shroomLight(worldIn, mainmutable.set(pos).move(-2, 14, 2));
                ...
                this.shroomLight(worldIn, mainmutable.set(pos).move(-4, 14, 3));
    ...
    //Leaves Placement
    private void shroomLight(ModifiableTestableWorld reader, BlockPos pos) {
        if (isAir(reader, pos)) {
