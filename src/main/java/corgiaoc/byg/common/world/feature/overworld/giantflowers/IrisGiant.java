    ...
    protected boolean placeFlower(ISeedReader worldIn, Random rand, BlockPos pos, boolean isFlower, BYGGiantFlowerFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 4, 3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 5, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 5, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 5, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 5, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 6, -2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 6, -1));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(0, 6, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 6, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-2, 6, 0));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(-1, 6, 0));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(1, 6, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(2, 6, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 6, 1));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(0, 6, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 6, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 6, 2));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(0, 7, -3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 7, -2));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(0, 7, -2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 7, -2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-2, 7, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 7, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 7, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(2, 7, -1));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(-3, 7, 0));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(-2, 7, 0));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(2, 7, 0));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(3, 7, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-2, 7, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 7, 1));
                ...
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 7, 2));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(0, 7, 3));
                placePollen(POLLEN, worldIn, mainmutable.setPos(pos).move(0, 7, 0));
                placePollen(POLLEN, worldIn, mainmutable.setPos(pos).move(1, 7, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 8, -3));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(0, 8, -3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 8, -3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-3, 8, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(3, 8, -1));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(-3, 8, 0));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(3, 8, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-3, 8, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(3, 8, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 8, 3));
                placePetal2(PETAL2, worldIn, mainmutable.setPos(pos).move(0, 8, 3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 8, 3));
                placePollen(POLLEN, worldIn, mainmutable.setPos(pos).move(0, 8, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 9, -3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 9, -3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-3, 9, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(3, 9, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-3, 9, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(3, 9, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 9, 3));
