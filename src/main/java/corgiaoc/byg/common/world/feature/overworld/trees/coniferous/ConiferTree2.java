    ...
    protected boolean generate(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getTopHeightLimit()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), config)) {
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 13, 1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 13, 2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, randTreeHeight - 12, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 12, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 12, -5), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 12, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight - 12, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-4, randTreeHeight - 12, -2), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight - 12, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, randTreeHeight - 12, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-5, randTreeHeight - 12, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-4, randTreeHeight - 12, -1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, randTreeHeight - 12, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(5, randTreeHeight - 12, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-5, randTreeHeight - 12, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-4, randTreeHeight - 12, 0), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 11, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 11, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight - 11, 0), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight - 10, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, randTreeHeight - 10, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-5, randTreeHeight - 10, -1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, randTreeHeight - 10, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(5, randTreeHeight - 10, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-5, randTreeHeight - 10, 0), boundsIn);
