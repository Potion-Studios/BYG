    ...
    protected boolean generate(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), config)) {
                ...
                //Stump
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 0, -5), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, 0, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-5, 0, 0), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, 0, 4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 0, 5), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 1, -4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-4, 1, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, 1, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, 1, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, 1, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 1, 4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 2, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, 2, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, 2, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 2, 3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 3, -2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 3, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, 3, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, 3, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, 3, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, 3, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 3, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 3, 2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 4, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, 4, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, 4, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, 4, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, 5, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, 5, 0), boundsIn);

                //Branches
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 7, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, randTreeHeight - 7, 1), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight, -3), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight, 2), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 7, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 7, 4), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight + 1, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, randTreeHeight + 1, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-6, randTreeHeight + 1, -3), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(5, randTreeHeight + 1, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(6, randTreeHeight + 1, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-6, randTreeHeight + 1, -1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(5, randTreeHeight + 1, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(6, randTreeHeight + 1, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-6, randTreeHeight + 1, 0), boundsIn);
