        ...
        if (posY >= 1 && posY + randTreeHeight + 1 < worldIn.getMaxBuildHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.below(), config)) {
                ...
                for (int buildTrunk = 0; buildTrunk < randTreeHeight; ++buildTrunk) {
                    ...
                    placeTrunk(config, rand, changedBlocks, worldIn, blockpos2.below(7).north().west(), boundsIn);
                    placeTrunk(config, rand, changedBlocks, worldIn, blockpos2.below(7).west(2), boundsIn);
                    placeTrunk(config, rand, changedBlocks, worldIn, blockpos2.below(6).north().west(3), boundsIn);
                    placeTrunk(config, rand, changedBlocks, worldIn, blockpos2.below(4).south(), boundsIn);
                    placeTrunk(config, rand, changedBlocks, worldIn, blockpos2.below(10).east(), boundsIn);
                }
