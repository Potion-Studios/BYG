    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, randTreeHeight - 7, -1), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, randTreeHeight - 4, -1), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 2, -3), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, randTreeHeight - 1, 0), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-5, randTreeHeight + 1, 1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight + 2, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, randTreeHeight + 2, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-6, randTreeHeight + 2, -1), boundsIn);
