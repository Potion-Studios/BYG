    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                buildTrunkBase(changedBlocks, worldIn, BYGBlockList.CHERRY_LOG, Blocks.DIRT, boundsIn, mainmutable, mainmutable2, mainmutable3, mainmutable4);
                ...
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 7, -3), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight - 7, -3), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(4, randTreeHeight - 7, -3), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 7, -2), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight - 7, -2), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 7, -1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight - 7, -1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-5, randTreeHeight - 7, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-4, randTreeHeight - 7, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-3, randTreeHeight - 7, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 7, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-1, randTreeHeight - 7, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(2, randTreeHeight - 7, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight - 7, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, randTreeHeight - 7, 2), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, randTreeHeight - 7, 3), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(2, randTreeHeight - 7, 3), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight - 7, 3), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(4, randTreeHeight - 7, 3), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 7, 4), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-1, randTreeHeight - 7, 4), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, randTreeHeight - 7, 4), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(1, randTreeHeight - 7, 4), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(4, randTreeHeight - 7, 4), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 7, 5), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 7, 6), boundsIn);

                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, randTreeHeight - 2, -2), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, randTreeHeight - 2, -1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(2, randTreeHeight - 2, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight - 2, 0), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 2, 1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(-1, randTreeHeight - 2, 1), boundsIn);

                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(2, randTreeHeight - 2, 1), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, randTreeHeight - 2, 2), boundsIn);
                placeTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, randTreeHeight - 2, 3), boundsIn);


                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 10, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, randTreeHeight - 10, -4), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, randTreeHeight - 10, -3), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, randTreeHeight - 10, 3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, randTreeHeight - 10, 3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, randTreeHeight - 10, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-3, randTreeHeight - 10, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 10, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-3, randTreeHeight - 10, 6), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, randTreeHeight - 9, -5), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(6, randTreeHeight - 9, -3), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(6, randTreeHeight - 9, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-7, randTreeHeight - 9, -1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-7, randTreeHeight - 9, 0), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, randTreeHeight - 9, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 9, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-1, randTreeHeight - 9, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight - 9, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, randTreeHeight - 9, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, randTreeHeight - 9, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(6, randTreeHeight - 9, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, randTreeHeight - 9, 6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-3, randTreeHeight - 9, 6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 9, 6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, randTreeHeight - 9, 7), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, randTreeHeight - 8, -5), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(7, randTreeHeight - 8, -3), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(7, randTreeHeight - 8, -2), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-7, randTreeHeight - 8, 0), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, randTreeHeight - 8, 3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, randTreeHeight - 8, 3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(6, randTreeHeight - 8, 3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, randTreeHeight - 8, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 8, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-1, randTreeHeight - 8, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight - 8, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, randTreeHeight - 8, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, randTreeHeight - 8, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(7, randTreeHeight - 8, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, randTreeHeight - 8, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 8, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, randTreeHeight - 8, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, randTreeHeight - 8, 5), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(7, randTreeHeight - 7, -4), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, randTreeHeight - 7, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(6, randTreeHeight - 7, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(7, randTreeHeight - 7, -3), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, randTreeHeight - 7, 1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, randTreeHeight - 7, 1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-7, randTreeHeight - 7, 2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-6, randTreeHeight - 7, 2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, randTreeHeight - 7, 2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 7, 2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-1, randTreeHeight - 7, 2), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-3, randTreeHeight - 6, 8), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, randTreeHeight - 6, 8), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-1, randTreeHeight - 6, 8), boundsIn);
