    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwEndTags(worldIn, pos.down(), config)) {
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(3, 10, 1), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(4, 12, 2), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(-3, 18, 1), boundsIn);
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(-2, 18, 1), boundsIn);
