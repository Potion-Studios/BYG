    ...
    protected boolean generate(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), config)) {
                ...
                buildTrunkBase(changedBlocks, worldIn, config, rand, boundsIn, mutable.set(pos).toImmutable(), mutable.set(pos).move(-1, 0, -2).toImmutable(), mutable.set(pos).move(0, 0, -2).toImmutable(), mutable.set(pos).move(1, 0, -2).toImmutable(), mutable.set(pos).move(-1, 0, -1).toImmutable(), mutable.set(pos).move(0, 0, -1).toImmutable(), mutable.set(pos).move(3, 0, -1).toImmutable(), mutable.set(pos).move(-2, 0, 0).toImmutable(), mutable.set(pos).move(-1, 0, 0).toImmutable(), mutable.set(pos).move(1, 0, 0).toImmutable(), mutable.set(pos).move(-1, 0, 1).toImmutable(), mutable.set(pos).move(0, 0, 1).toImmutable(), mutable.set(pos).move(1, 0, 1).toImmutable());
                mutable.set(pos);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, 0, -1), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, 1, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, 1, -1), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight + 1, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight + 1, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight + 1, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight + 1, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, randTreeHeight + 1, 0), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, randTreeHeight + 2, -4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight + 2, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight + 2, -2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight + 2, -2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight + 2, -2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight + 2, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, randTreeHeight + 2, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight + 2, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(5, randTreeHeight + 2, 1), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, randTreeHeight + 3, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight + 3, -2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, randTreeHeight + 3, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight + 3, 2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight + 3, 3), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight + 3, -4), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, randTreeHeight + 3, 2), boundsIn);
            }
        }
        return true;
    }
