    ...
    protected boolean generate(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getTopHeightLimit()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), config)) {
                ...
                buildTrunkBase(changedBlocks, worldIn, config, rand, boundsIn, mainmutable.set(pos).move(0, 0, -1).toImmutable(), mainmutable.set(pos).move(-1, 0, 0).toImmutable(), mainmutable.set(pos).move(0, 0, 0).toImmutable(), mainmutable.set(pos).move(1, 0, 0).toImmutable(), mainmutable.set(pos).move(0, 0, 1).toImmutable(), mainmutable.set(pos).move(0, 0, -2).toImmutable(), mainmutable.set(pos).move(-1, 0, -1).toImmutable(), mainmutable.set(pos).move(1, 0, -1).toImmutable(), mainmutable.set(pos).move(-2, 0, 0).toImmutable(), mainmutable.set(pos).move(2, 0, 0).toImmutable(), mainmutable.set(pos).move(-1, 0, 1).toImmutable(), mainmutable.set(pos).move(1, 0, 1).toImmutable(), mainmutable.set(pos).move(0, 0, 2));
