    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwNetherTags(worldIn, pos.down(), config)) {
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 0, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 0, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(1, 0, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(1, 0, 1), boundsIn);
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 4, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 4, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(1, 4, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-2, 5, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 5, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 5, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(2, 5, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-3, 6, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-2, 6, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 6, -3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 6, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 6, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 6, 3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(2, 6, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(3, 6, 0), boundsIn);
                ...
                this.placeShroomLights(changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 5, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 5, 3), boundsIn);
                ...
                this.placeShroomLights(changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 6, -1), boundsIn);
                this.placeShroomLights(changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 6, 1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 6, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(1, 6, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(1, 6, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(1, 6, -1), boundsIn);
                this.placeShroomLights(changedBlocks, worldIn, mainmutable.setPos(pos).move(1, 6, 1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(1, 6, 2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(1, 6, 3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(1, 6, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(2, 6, -1), boundsIn);
