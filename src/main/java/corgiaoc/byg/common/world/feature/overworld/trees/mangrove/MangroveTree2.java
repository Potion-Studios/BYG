    ...
    protected boolean generate(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), config)) {
                ...
                //Roots
                BlockPos.Mutable rootMutable = new BlockPos.Mutable().set(mainmutable.add(1, 0, -2));
                BlockPos.Mutable rootMutable2 = new BlockPos.Mutable().set(mainmutable.add(-1, 0, -1));
                BlockPos.Mutable rootMutable3 = new BlockPos.Mutable().set(mainmutable.add(1, 0, -1));
                BlockPos.Mutable rootMutable4 = new BlockPos.Mutable().set(mainmutable.add(2, 0, -1));
                BlockPos.Mutable rootMutable5 = new BlockPos.Mutable().set(mainmutable.add(-2, 0, 0));
                BlockPos.Mutable rootMutable6 = new BlockPos.Mutable().set(mainmutable.add(-1, 0, 0));
                BlockPos.Mutable rootMutable7 = new BlockPos.Mutable().set(mainmutable.add(0, 0, 1));
                BlockPos.Mutable rootMutable8 = new BlockPos.Mutable().set(mainmutable.add(1, 0, 1));
                BlockPos.Mutable rootMutable9 = new BlockPos.Mutable().set(mainmutable.add(0, 0, 2));


                buildTrunkBase(changedBlocks, worldIn, config, rand, boundsIn, rootMutable, rootMutable2, rootMutable3, rootMutable4, rootMutable5, rootMutable6, rootMutable7, rootMutable8, rootMutable9);
