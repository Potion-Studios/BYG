    ...
    protected boolean placeFlower(ISeedReader worldIn, Random rand, BlockPos pos, boolean isFlower, BYGGiantFlowerFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-2, 3, 1));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-3, 4, 2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(3, 5, -2));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 7, 2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-1, 8, -2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 8, 2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 7, -2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-2, 7, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-2, 8, -3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 8, -3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 8, -3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-2, 8, -2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 8, -2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-2, 8, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 8, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 9, -3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-2, 9, -2));
                ...
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 9, 2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 9, 3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 9, 3));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 10, -2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 10, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 10, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 10, 2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 11, -2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 11, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 11, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 11, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 11, 2));
                placePollen(POLLEN, worldIn, mainmutable.setPos(pos).move(-1, 11, 1));
                placePollen(POLLEN, worldIn, mainmutable.setPos(pos).move(0, 11, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 12, -2));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 12, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 12, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 12, 1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 12, 2));
                placePollen(POLLEN, worldIn, mainmutable.setPos(pos).move(0, 12, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 13, -1));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(-1, 13, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(1, 13, 0));
                placePetal(PETAL, worldIn, mainmutable.setPos(pos).move(0, 13, 1));
                placePollen(POLLEN, worldIn, mainmutable.setPos(pos).move(0, 13, 0));
