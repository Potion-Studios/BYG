    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwEndTags(worldIn, pos.down(), config)) {
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(-6, 7, 2), boundsIn);
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(-5, 7, 1), boundsIn);
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(-5, 7, 2), boundsIn);
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(-4, 7, 2), boundsIn);
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(-4, 7, 4), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(-3, 8, 4), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(0, 8, -3), boundsIn);
