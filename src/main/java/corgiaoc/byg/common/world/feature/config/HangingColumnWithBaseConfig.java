...
public class HangingColumnWithBaseConfig implements FeatureConfig {

    public static final Codec<HangingColumnWithBaseConfig> CODEC = RecordCodecBuilder.create((codecRecorder) -> {
        return codecRecorder.group(BlockStateProvider.TYPE_CODEC.fieldOf("base_block_provider").forGetter((config) -> {
            return config.baseBlockProvider;
        }), BlockStateProvider.TYPE_CODEC.fieldOf("block_provider").forGetter((config) -> {
            return config.blockProvider;
        }), BlockStateProvider.TYPE_CODEC.fieldOf("end_block_provider").forGetter((config) -> {
