    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), config)) {
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 12, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 12, 2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 13, -6), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 13, -6), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 13, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(5, 13, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 13, -2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 13, -2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 13, -2), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 13, 0), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 13, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 13, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(5, 13, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(6, 13, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 13, 2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(6, 13, 2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 13, 3), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 14, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 14, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(5, 14, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 14, 2), boundsIn);
