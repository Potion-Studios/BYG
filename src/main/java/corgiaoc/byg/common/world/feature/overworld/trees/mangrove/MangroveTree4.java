        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, blockpos, config)) {
                ...
                for (int buildRoot = 0; buildRoot <= 5; buildRoot++) {
                    ...
                    placeBranch(config, rand, changedBlocks, worldIn, rootMutable10, boundsIn);
                    placeBranch(config, rand, changedBlocks, worldIn, rootMutable11, boundsIn);
                    placeBranch(config, rand, changedBlocks, worldIn, rootMutable12, boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-3, randTreeHeight + 3, 3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-3, randTreeHeight + 3, 4), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-3, randTreeHeight + 2, 6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-2, randTreeHeight + 2, 6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(3, randTreeHeight + 3, -6), boundsIn);
