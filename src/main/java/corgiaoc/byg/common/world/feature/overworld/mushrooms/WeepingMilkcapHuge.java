    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 4, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 4, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 4, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 4, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 5, -4));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 5, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 5, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-4, 5, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 5, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-3, 5, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 5, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 5, 2));
