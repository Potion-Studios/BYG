    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwEndTags(config, worldIn, pos.down(), BYGBlocks.IMPARIUS_PHYLIUM)) {
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-1, 0, -2));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(1, 0, -3));
                ...
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(-2, 8, -1));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(-2, 8, 0));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(-2, 8, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 8, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 8, -3));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(-1, 8, -2));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(-1, 8, -1));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(-1, 8, 0));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(-1, 8, 1));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(-1, 8, 2));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(0, 8, -2));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(0, 8, -1));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(0, 8, 1));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(0, 8, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 8, -3));
                this.imparius_filament(worldIn, mainmutable.setPos(pos).move(1, 8, -2));
                ...
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(-2, 9, -1));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(-2, 9, 0));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(-2, 9, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 9, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 9, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 9, -3));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(-1, 9, -2));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(-1, 9, -1));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(-1, 9, 0));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(-1, 9, 1));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(-1, 9, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 9, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 9, -3));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(0, 9, -2));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(0, 9, -1));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(0, 9, 1));
                this.imparius_filament_block(worldIn, mainmutable.setPos(pos).move(0, 9, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 9, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 9, -3));
