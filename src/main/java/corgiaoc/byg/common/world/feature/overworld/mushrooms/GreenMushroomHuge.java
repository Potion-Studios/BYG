    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(3, 8, 3));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-1, 9, -1));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(3, 9, 3));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(5, 8, 0));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(6, 8, 1));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 8, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(6, 8, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 8, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 8, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(5, 8, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(6, 8, 5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 8, 6));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 8, 6));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 8, 6));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 8, 6));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(5, 8, 6));
