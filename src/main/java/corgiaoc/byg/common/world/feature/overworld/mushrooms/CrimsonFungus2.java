...
public class CrimsonFungus2 extends BYGAbstractMushroomFeature<BYGMushroomConfig> {
    ...
    protected boolean placeMushroom(StructureWorldAccess worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), BYGBlocks.OVERGROWN_CRIMSON_BLACKSTONE)) {
                ...
                this.vines(worldIn, mainmutable.set(pos).move(0, 3, 2));
                this.vines(worldIn, mainmutable.set(pos).move(-2, 4, -2));
                this.vines(worldIn, mainmutable.set(pos).move(-2, 4, 0));
                this.vines(worldIn, mainmutable.set(pos).move(-2, 4, 2));
                this.vines(worldIn, mainmutable.set(pos).move(-1, 4, -2));
                this.vinesplant(worldIn, mainmutable.set(pos).move(0, 4, 2));
                this.vines(worldIn, mainmutable.set(pos).move(2, 4, -2));
                this.vines(worldIn, mainmutable.set(pos).move(2, 4, 1));
                this.vinesplant(worldIn, mainmutable.set(pos).move(-2, 5, -2));
                this.vinesplant(worldIn, mainmutable.set(pos).move(-2, 5, 0));
                this.vines(worldIn, mainmutable.set(pos).move(-2, 5, 1));
                this.vinesplant(worldIn, mainmutable.set(pos).move(-2, 5, 2));
                this.vinesplant(worldIn, mainmutable.set(pos).move(-1, 5, -2));
                this.vines(worldIn, mainmutable.set(pos).move(-1, 5, 2));
                this.vines(worldIn, mainmutable.set(pos).move(0, 5, -2));
                ...
                this.vinesplant(worldIn, mainmutable.set(pos).move(-2, 6, -2));
                this.vines(worldIn, mainmutable.set(pos).move(-2, 6, -1));
                this.vinesplant(worldIn, mainmutable.set(pos).move(-2, 6, 0));
                this.vinesplant(worldIn, mainmutable.set(pos).move(-2, 6, 1));
                this.vinesplant(worldIn, mainmutable.set(pos).move(-2, 6, 2));
                this.vinesplant(worldIn, mainmutable.set(pos).move(-1, 6, -2));
                this.vinesplant(worldIn, mainmutable.set(pos).move(-1, 6, 2));
                ...
                this.vinesplant(worldIn, mainmutable.set(pos).move(2, 6, 0));
                this.vinesplant(worldIn, mainmutable.set(pos).move(2, 6, 1));
                this.shroomlight(worldIn, mainmutable.set(pos).move(-4, 7, 1));
                this.shroomlight(worldIn, mainmutable.set(pos).move(-4, 7, 2));
                ...
                this.vinesplant(worldIn, mainmutable.set(pos).move(-2, 7, -2));
                ...
                this.vinesplant(worldIn, mainmutable.set(pos).move(-1, 7, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(-1, 7, 3));
                this.shroomlight(worldIn, mainmutable.set(pos).move(0, 7, -4));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(3, 7, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(3, 7, 2));
                this.shroomlight(worldIn, mainmutable.set(pos).move(-4, 8, 1));
                ...
                this.vinesplant(worldIn, mainmutable.set(pos).move(-1, 8, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(-1, 8, 3));
                this.shroomlight(worldIn, mainmutable.set(pos).move(0, 8, -4));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(3, 8, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(3, 8, 1));
                this.shroomlight(worldIn, mainmutable.set(pos).move(4, 8, 0));
                this.shroomlight(worldIn, mainmutable.set(pos).move(4, 8, 1));
                ...
                this.vinesplant(worldIn, mainmutable.set(pos).move(0, 9, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(0, 9, 3));
                this.shroomlight(worldIn, mainmutable.set(pos).move(0, 9, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(1, 9, -3));
                this.vinesplant(worldIn, mainmutable.set(pos).move(1, 9, -2));
                this.vinesplant(worldIn, mainmutable.set(pos).move(1, 9, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(1, 9, 3));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(2, 10, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(3, 10, 0));
                this.shroomlight(worldIn, mainmutable.set(pos).move(-3, 11, -1));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(-1, 11, 2));
                this.shroomlight(worldIn, mainmutable.set(pos).move(0, 11, -4));
                ...
                this.shroomlight(worldIn, mainmutable.set(pos).move(-1, 12, 0));
                this.shroomlight(worldIn, mainmutable.set(pos).move(-1, 12, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(-1, 12, 2));
                this.shroomlight(worldIn, mainmutable.set(pos).move(0, 12, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(0, 12, -2));
                this.shroomlight(worldIn, mainmutable.set(pos).move(0, 12, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(0, 12, 2));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(2, 12, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(2, 12, 1));
                this.shroomlight(worldIn, mainmutable.set(pos).move(3, 12, -1));
                this.shroomlight(worldIn, mainmutable.set(pos).move(3, 12, 0));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(0, 13, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(0, 13, 2));
                this.shroomlight(worldIn, mainmutable.set(pos).move(0, 13, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(1, 13, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(1, 13, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(1, 13, 1));
                this.shroomlight(worldIn, mainmutable.set(pos).move(2, 13, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(2, 13, 0));
                this.shroomlight(worldIn, mainmutable.set(pos).move(3, 13, 0));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(0, 14, 1));
                this.shroomlight(worldIn, mainmutable.set(pos).move(0, 14, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(1, 14, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(1, 14, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.set(pos).move(1, 14, 1));
            }
    ...
    //Leaves Placement
    private void vines(StructureWorldAccess reader, BlockPos pos) {
        if (isAir(reader, pos)) {
    ...
    //Leaves Placement
    private void vinesplant(StructureWorldAccess reader, BlockPos pos) {
        if (isAir(reader, pos)) {
