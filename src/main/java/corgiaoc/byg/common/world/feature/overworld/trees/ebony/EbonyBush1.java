    ...
    protected boolean generate(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), config)) {
                ...
                return false;
            } else if (this.isCliff(worldIn, mainmutable.set(pos).move(0, 0, 0), mainmutable.set(pos).move(0, 0, -2), mainmutable.set(pos).move(-1, 0, -1), mainmutable.set(pos).move(0, 0, -1), mainmutable.set(pos).move(1, 0, -1), mainmutable.set(pos).move(-2, 0, 0), mainmutable.set(pos).move(-1, 0, 0), mainmutable.set(pos).move(1, 0, 0), mainmutable.set(pos).move(-1, 0, 1), mainmutable.set(pos).move(0, 0, 1))) {
                return false;
            } else {
