    ...
    protected boolean generate(Set<BlockPos> changedBlocks, StructureWorldAccess worldIn, Random rand, BlockPos pos, BlockBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getTopHeightLimit()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), config)) {
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 15, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, randTreeHeight - 15, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 15, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 15, 1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, randTreeHeight - 14, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, randTreeHeight - 14, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 14, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 14, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 14, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight - 14, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, randTreeHeight - 14, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, randTreeHeight - 14, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 14, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 14, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 14, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight - 14, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight - 14, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, randTreeHeight - 14, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, randTreeHeight - 14, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 14, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 14, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 14, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight - 14, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight - 14, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, randTreeHeight - 14, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, randTreeHeight - 14, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 14, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 14, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight - 14, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight - 14, 1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 13, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, randTreeHeight - 13, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-1, randTreeHeight - 13, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 13, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 13, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 13, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, randTreeHeight - 13, 0), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 12, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 12, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight - 12, -2), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 12, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 12, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 12, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight - 12, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight - 12, -1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 12, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight - 12, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-3, randTreeHeight - 12, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, randTreeHeight - 12, 0), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 11, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 11, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-2, randTreeHeight - 11, 0), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(2, randTreeHeight - 10, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight - 10, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-4, randTreeHeight - 10, -1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(3, randTreeHeight - 10, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(4, randTreeHeight - 10, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(-4, randTreeHeight - 10, 0), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(0, randTreeHeight - 8, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mutable.set(pos).move(1, randTreeHeight - 8, -4), boundsIn);
