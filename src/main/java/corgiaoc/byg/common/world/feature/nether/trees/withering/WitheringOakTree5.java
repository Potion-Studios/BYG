...
public class WitheringOakTree5 extends BYGAbstractTreeFeature<BYGTreeConfig> {

    public WitheringOakTree5(Codec<BYGTreeConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < /*worldIn.getHeight() TODO: Use world height in 1.17*/ 128) {
            if (!isDesiredGroundwNetherTags(worldIn, pos.below(), config)) {
                ...
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 4, 1), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 4, 0), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(2, 4, -1), boundsIn);
                ...
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(3, 5, -2), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-2, 6, -3), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-2, 6, 1), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-1, 6, -2), boundsIn);
                ...
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(3, 6, -2), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-3, 7, 2), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-2, 7, -3), boundsIn);
                ...
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(3, 7, -2), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-3, 8, 2), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-2, 8, -3), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 8, 3), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-3, 9, 2), boundsIn);
                ...
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 11, 1), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-1, 12, 0), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 13, 0), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 14, -1), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 15, 1), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-1, 16, 0), boundsIn);
                placeNetherBranch(pos,config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 16, 0), boundsIn);
                ...
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-2, 2, -1), boundsIn, Direction.WEST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 2, -2), boundsIn, Direction.NORTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(2, 2, 0), boundsIn, Direction.EAST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-1, 3, -1), boundsIn, Direction.WEST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-1, 3, 1), boundsIn, Direction.WEST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 3, -1), boundsIn, Direction.NORTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 3, 1), boundsIn, Direction.SOUTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-2, 4, 0), boundsIn, Direction.WEST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 4, -2), boundsIn, Direction.NORTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 4, 2), boundsIn, Direction.SOUTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(2, 4, 0), boundsIn, Direction.EAST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-1, 5, -1), boundsIn, Direction.WEST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-1, 5, 1), boundsIn, Direction.SOUTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 5, 2), boundsIn, Direction.WEST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(2, 5, -2), boundsIn, Direction.NORTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(2, 5, 2), boundsIn, Direction.EAST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-2, 6, 0), boundsIn, Direction.NORTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-2, 6, 2), boundsIn, Direction.SOUTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 6, -2), boundsIn, Direction.EAST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 6, -1), boundsIn, Direction.NORTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 6, 4), boundsIn, Direction.SOUTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(2, 6, 0), boundsIn, Direction.EAST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-4, 7, 2), boundsIn, Direction.WEST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-1, 7, 0), boundsIn, Direction.WEST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 7, 2), boundsIn, Direction.SOUTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 7, -1), boundsIn, Direction.EAST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(1, 7, 1), boundsIn, Direction.EAST);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(0, 8, 1), boundsIn, Direction.SOUTH);
                this.ArisianBloomBranch(pos, config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(-1, 9, 0), boundsIn, Direction.WEST);
            }
        }
        return true;
    }
