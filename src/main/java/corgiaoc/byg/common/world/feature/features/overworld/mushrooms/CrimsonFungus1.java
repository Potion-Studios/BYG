...
public class CrimsonFungus1 extends BYGAbstractMushroomFeature<BYGMushroomFeatureConfig> {
    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), BYGBlockList.OVERGROWN_CRIMSON_BLACKSTONE)) {
                return false;
                ...
                this.vines(worldIn, mainmutable.add(2, 3, 1));
                this.vines(worldIn, mainmutable.add(0, 4, -2));
                this.vines(worldIn, mainmutable.add(0, 4, 2));
                this.vinesplant(worldIn, mainmutable.add(2, 4, 1));
                ...
                this.vines(worldIn, mainmutable.add(-1, 6, -2));
                this.vines(worldIn, mainmutable.add(-1, 6, -1));
