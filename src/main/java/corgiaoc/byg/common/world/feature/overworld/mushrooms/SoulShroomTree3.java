    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(config, worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                this.soulShroomSporeEnd(worldIn, mainmutable.setPos(pos).move(5, 8, -5));
                this.soulShroomSporeEnd(worldIn, mainmutable.setPos(pos).move(-5, 9, -4));
                this.soulShroomSporeEnd(worldIn, mainmutable.setPos(pos).move(-4, 9, -2));
                this.soulShroomSporeEnd(worldIn, mainmutable.setPos(pos).move(3, 9, -4));
                this.soulShroomSporeEnd(worldIn, mainmutable.setPos(pos).move(4, 9, -1));
                this.soulShroomSpore(worldIn, mainmutable.setPos(pos).move(5, 9, -5));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-4, 10, -5));
                ...
                this.soulShroomSporeEnd(worldIn, mainmutable.setPos(pos).move(-1, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 10, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 10, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 10, 1));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 10, 5));
                this.soulShroomSpore(worldIn, mainmutable.setPos(pos).move(3, 10, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 10, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 10, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 10, 5));
                this.soulShroomSpore(worldIn, mainmutable.setPos(pos).move(4, 10, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 10, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 10, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 10, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 10, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 10, 5));
                this.soulShroomSpore(worldIn, mainmutable.setPos(pos).move(5, 10, -5));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(5, 10, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(5, 10, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(5, 10, 4));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 11, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 11, 4));
                this.soulShroomSpore(worldIn, mainmutable.setPos(pos).move(3, 11, -4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 11, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 11, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 11, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 11, 4));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(3, 11, 5));
                this.soulShroomSpore(worldIn, mainmutable.setPos(pos).move(4, 11, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 11, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 11, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(4, 11, 4));
                this.soulShroomSpore(worldIn, mainmutable.setPos(pos).move(5, 11, -5));
                this.soulShroomSporeEnd(worldIn, mainmutable.setPos(pos).move(5, 11, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(5, 11, 3));
                this.soulShroomSporeEnd(worldIn, mainmutable.setPos(pos).move(6, 11, -3));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(5, 15, -4));
