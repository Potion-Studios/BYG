package corgiaoc.byg.common.world.feature.features.overworld.trees.spruce.medium;
    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 4, -4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 4, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 4, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-5, 5, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 5, -1), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 6, 4), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-6, 5, -1), boundsIn);
