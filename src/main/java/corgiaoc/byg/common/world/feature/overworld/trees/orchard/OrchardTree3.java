...
public class OrchardTree3 extends BYGAbstractTreeFeature<BYGTreeConfig> {
    ...
    public BlockState randomLeaves() {
        ...
        if (randomizer == 1)
            return BYGBlocks.FLOWERING_ORCHARD_LEAVES.defaultBlockState();
        else if (randomizer == 0)
            return BYGBlocks.RIPE_ORCHARD_LEAVES.defaultBlockState();
        else
            return BYGBlocks.ORCHARD_LEAVES.defaultBlockState();
    }
