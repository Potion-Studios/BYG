    ...
    protected boolean place(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 0, -4), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 0, -3), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 0, 2), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 1, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 1, -2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 1, 2), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 2, -3), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 2, 2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 2, 3), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 3, 2), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 11, 3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 11, 4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 12, 4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 12, 4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 12, 4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 12, 5), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(5, 13, 4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 13, 5), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 13, 6), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 19, -2), boundsIn);
                ...
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 19, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 19, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 19, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 19, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 19, 2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 20, -4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 20, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 20, -3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 20, -2), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 20, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 20, -1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 20, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 20, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 20, 0), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 20, 1), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 20, 3), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 20, 4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 20, 4), boundsIn);
                placeBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 20, 5), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(7, 12, 5), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, 12, 6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(6, 12, 6), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 12, 7), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, 12, 7), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(6, 12, 7), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 12, 8), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 12, 8), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 12, 8), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(6, 13, 5), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, 19, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 19, -5), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(0, 20, -7), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, 20, -7), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 20, -6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(0, 20, -6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, 20, -6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 20, -6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 20, -6), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 20, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 20, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 20, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 20, -4), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 20, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 20, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-5, 20, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 20, -3), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 20, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, 20, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-6, 20, -1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 20, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 20, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, 20, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(6, 20, 0), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-5, 20, 1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 20, 1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 20, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 20, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(0, 20, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, 20, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 20, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 20, 4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 20, 4), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, 21, -6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 21, -6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 21, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(0, 21, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, 21, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 21, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 21, -5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 21, -4), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, 21, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 21, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 21, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 21, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 21, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 21, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 21, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(0, 21, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, 21, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 21, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 21, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 21, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 21, -2), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 21, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 21, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-5, 21, -1), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 21, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 21, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-6, 21, 0), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 21, 0), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(3, 21, 2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(4, 21, 2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(5, 21, 2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 21, 3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 21, 3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 21, 3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 21, 3), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, 21, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(2, 21, 5), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(0, 21, 6), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(1, 22, -4), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 22, 0), boundsIn);
