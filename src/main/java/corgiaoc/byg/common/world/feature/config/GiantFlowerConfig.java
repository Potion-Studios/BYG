...
public class GiantFlowerConfig implements FeatureConfig {
    ...
    public static final Codec<GiantFlowerConfig> CODEC = RecordCodecBuilder.create((codecRecorder) -> {
        ...
        }), BlockStateProvider.TYPE_CODEC.fieldOf("petal_provider").forGetter((config) -> {
            return config.petalProvider;
        }), BlockStateProvider.TYPE_CODEC.fieldOf("petal2_provider").forGetter((config) -> {
            return config.petalProvider;
        }), BlockStateProvider.TYPE_CODEC.fieldOf("petal3_provider").forGetter((config) -> {
            return config.petalProvider;
