...
public class DeathCapTree1 extends BYGAbstractMushroomFeature<BYGMushroomFeatureConfig> {

    public DeathCapTree1(Codec<BYGMushroomFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.down(), Blocks.GRASS_BLOCK)) {
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 6, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 6, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 6, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 6, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 6, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 6, -3));
