    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwNetherTags(worldIn, pos.down(), config)) {
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 2, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 2, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 2, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 2, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 2, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 2, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 2, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 2, 0), boundsIn);
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 6, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 6, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 7, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 7, 2), boundsIn);
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 7, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 7, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 8, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 8, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 8, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 8, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 8, -4), boundsIn);
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 8, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 8, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 9, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 9, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 9, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 9, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 9, -4), boundsIn);
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 9, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 9, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 10, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 10, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 10, -3), boundsIn);
