...
public abstract class BYGAbstractGiantFlowerFeature<T extends GiantFlowerConfig> extends Feature<T> {
    ...
    public boolean isAnotherFlowerLikeThisHere(TestableWorld worldReader, BlockPos blockPos, Block logBlock, Block leafBlock) {
        return worldReader.testBlockState(blockPos, (state) -> {
    ...
    public void placePetal(BlockState petalBlockState, StructureWorldAccess reader, BlockPos pos) {
        if (isAir(reader, pos)) {
            this.setFinalBlockState(reader, pos, petalBlockState);
        }
    }

    public void placePetal2(BlockState petalBlockState, StructureWorldAccess reader, BlockPos pos) {
        if (isAir(reader, pos)) {
            this.setFinalBlockState(reader, pos, petalBlockState);
        }
    }

    public void placePetal3(BlockState petalBlockState, StructureWorldAccess reader, BlockPos pos) {
        if (isAir(reader, pos)) {
            this.setFinalBlockState(reader, pos, petalBlockState);
        }
    }
    ...
    public boolean doesFlowerHaveSpaceToGrow(TestableWorld reader, BlockPos pos, int treeHeight, int canopyStartHeight, int xDistance, int zDistance, boolean isSapling, BlockPos... trunkPositions) {
        int x = pos.getX();
        int y = pos.getY();
        int z = pos.getZ();
    ...
    public boolean doesFlowerHaveSpaceToGrow(TestableWorld reader, BlockPos pos, int treeHeight, int canopyStartHeight, int xNegativeDistance, int zNegativeDistance, int xPositiveDistance, int zPositiveDistance, boolean isSapling, BlockPos... trunkPositions) {
        int x = pos.getX();
        int y = pos.getY();
        int z = pos.getZ();
        BlockPos.Mutable mutable = new BlockPos.Mutable();
     ...
     */
    public boolean isAnotherFlowerNearby(TestableWorld reader, BlockPos pos, int treeHeight, int distance, boolean isSapling) {
        int x = pos.getX();
        int y = pos.getY();
        int z = pos.getZ();
        BlockPos.Mutable mutable = new BlockPos.Mutable();
    ...
    public boolean isAnotherFlowerLikeThisNearby(TestableWorld reader, BlockPos pos, int treeHeight, int distance, Block logBlock, Block leafBlock, boolean isSapling) {
        int x = pos.getX();
        int y = pos.getY();
        int z = pos.getZ();
        BlockPos.Mutable mutable = new BlockPos.Mutable();
    ...
    protected abstract boolean placeFlower(StructureWorldAccess worldIn, Random rand, BlockPos pos, boolean isFlower, T config);
