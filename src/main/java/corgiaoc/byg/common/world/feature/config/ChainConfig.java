...
public class ChainConfig implements FeatureConfig {

    public static final Codec<ChainConfig> CODEC = RecordCodecBuilder.create((codecRecorder) -> {
        return codecRecorder.group(BlockStateProvider.TYPE_CODEC.fieldOf("x_axis_block_provider").forGetter((config) -> {
            return config.xAxisBlockProvider;
        }), BlockStateProvider.TYPE_CODEC.fieldOf("z_axis_block_provider").forGetter((config) -> {
