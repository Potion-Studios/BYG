...
public class TallEmburRoots extends Feature<NoFeatureConfig> {
    ...
    public boolean func_241855_a(ISeedReader worldIn, ChunkGenerator generator, Random rand, BlockPos pos, NoFeatureConfig config) {
        if (!worldIn.isAirBlock(pos) || worldIn.getBlockState(pos.down()).getBlock() != BYGBlocks.EMBUR_NYLIUM) {
            ...
            worldIn.setBlockState(pos, BYGBlocks.TALL_EMBUR_ROOTS.getDefaultState(), 10);
            worldIn.setBlockState(pos.offset(Direction.UP), BYGBlocks.TALL_EMBUR_ROOTS.getDefaultState().with(HALF, DoubleBlockHalf.UPPER), 10);
            return true;
        }
    }
