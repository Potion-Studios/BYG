...
public abstract class BYGAbstractMushroomFeature<T extends BYGMushroomConfig> extends Feature<T> {
     ...
     */
    public static boolean isDesiredGroundwDirtTag(BYGMushroomConfig config, TestableWorld reader, BlockPos pos, Block... desiredGroundBlock) {
    ...
    public static boolean isDesiredGroundwEndTags(BYGMushroomConfig config, TestableWorld reader, BlockPos pos, Block... desiredGroundBlock) {
        if (config.isPlacementForced())
            return true;
