    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwNetherTags(worldIn, pos.down(), config)) {
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 0, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 0, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 0, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 0, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 1, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 1, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 1, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 1, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 2, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 2, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 2, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 2, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 2, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 2, 3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 2, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 2, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 3, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 3, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 3, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 3, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 3, 3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 3, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 4, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 4, -3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 4, 3), boundsIn);
