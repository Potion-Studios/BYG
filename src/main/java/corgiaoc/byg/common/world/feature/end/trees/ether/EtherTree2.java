    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwEndTags(worldIn, pos.down(), config)) {
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(3, 4, -2), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(3, 6, -1), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(4, 7, 0), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(-1, 8, -4), boundsIn);
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(0, 8, -5), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(5, 8, -1), boundsIn);
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(5, 8, 1), boundsIn);
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.add(6, 8, -1), boundsIn);
                ...
                placeLeaves(config, rand,changedBlocks, worldIn, mainmutable.add(7, 8, -1), boundsIn);
                placeLeaves(config, rand,changedBlocks, worldIn, mainmutable.add(7, 8, 0), boundsIn);
