...
public class EtherTree2 extends BYGAbstractTreeFeature<BYGTreeFeatureConfig> {

    public EtherTree2(Codec<BYGTreeFeatureConfig> configIn) {
        super(configIn);
    }
    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwEndTags(worldIn, pos.down(), config)) {
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.setPos(pos).move(3, 6, -1), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.setPos(pos).move(4, 7, 0), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.setPos(pos).move(0, 8, -5), boundsIn);
                ...
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.setPos(pos).move(5, 8, -1), boundsIn);
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.setPos(pos).move(5, 8, 1), boundsIn);
                placeBranch(config, rand,changedBlocks, worldIn, mainmutable.setPos(pos).move(6, 8, -1), boundsIn);
                ...
                placeLeaves(config, rand,changedBlocks, worldIn, mainmutable.setPos(pos).move(7, 8, -1), boundsIn);
                placeLeaves(config, rand,changedBlocks, worldIn, mainmutable.setPos(pos).move(7, 8, 0), boundsIn);
