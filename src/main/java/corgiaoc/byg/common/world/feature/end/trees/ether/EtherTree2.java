    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getMaxBuildHeight()) {
            if (!isDesiredGroundwEndTags(worldIn, pos.below(), config)) {
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(8, 7, -2), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(8, 8, -2), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(8, 9, -3), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(7, 10, -3), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(7, 10, -2), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(7, 10, -1), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(8, 10, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(8, 10, -2), boundsIn);
                ...
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(7, 11, -4), boundsIn);
                placeLeaves(config, rand, changedBlocks, worldIn, mainmutable.set(pos).move(7, 11, -3), boundsIn);
