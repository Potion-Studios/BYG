    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwNetherTags(worldIn, pos.down(), config)) {
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 15, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 16, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 17, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-2, 18, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 18, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-2, 19, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-2, 20, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 20, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 21, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.setPos(pos).move(-1, 22, 1), boundsIn);
