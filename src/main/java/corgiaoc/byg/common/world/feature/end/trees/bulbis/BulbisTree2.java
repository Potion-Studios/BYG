    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwEndTags(config, worldIn, pos.down(), BYGBlocks.IVIS_PHYLIUM)) {
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(3, 6, -2));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-5, 8, 1));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(4, 8, -2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-5, 9, 1));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 11, 1));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(1, 11, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-2, 12, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 12, -2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(0, 12, 2));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(2, 12, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-3, 13, -1));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-3, 13, 0));
                placeStemBranch(STEM, worldIn, mainmutable.setPos(pos).move(-3, 13, 1));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(2, 8, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 8, -1));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-3, 9, 1));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(0, 14, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 14, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 14, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 14, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 14, -1));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(0, 15, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 15, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 15, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 15, -2));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(1, 15, 0));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(1, 15, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 15, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 15, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 15, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 15, -1));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-2, 16, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 16, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-2, 16, 2));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(0, 16, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 16, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 16, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 16, -2));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(1, 16, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 16, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 16, 3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 16, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(2, 16, -1));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-1, 17, -1));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-1, 17, 0));
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(-1, 17, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 17, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(-1, 17, 3));
                ...
                this.shroomlight(worldIn, mainmutable.setPos(pos).move(0, 18, 0));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 18, 1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(0, 18, 2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 18, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.setPos(pos).move(1, 18, -1));
