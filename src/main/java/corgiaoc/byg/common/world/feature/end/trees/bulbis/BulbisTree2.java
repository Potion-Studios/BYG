    ...
    protected boolean placeMushroom(ISeedReader worldIn, Random rand, BlockPos pos, boolean isMushroom, BYGMushroomFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwEndTags(worldIn, pos.down(), BYGBlocks.IVIS_PHYLIUM)) {
                ...
                placeStemBranch(STEM, worldIn, mainmutable.add(1, 2, -1));
                ...
                placeStemBranch(STEM, worldIn, mainmutable.add(-1, 4, 0));
                placeStemBranch(STEM, worldIn, mainmutable.add(-1, 4, 1));
                placeStemBranch(STEM, worldIn, mainmutable.add(1, 4, -2));
                placeStemBranch(STEM, worldIn, mainmutable.add(1, 4, -1));
                placeStemBranch(STEM, worldIn, mainmutable.add(2, 4, -2));
                placeStemBranch(STEM, worldIn, mainmutable.add(-2, 5, 1));
                placeStemBranch(STEM, worldIn, mainmutable.add(2, 5, -2));
                placeStemBranch(STEM, worldIn, mainmutable.add(-2, 6, 1));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(1, 6, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(1, 6, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(1, 6, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(2, 6, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(2, 6, -1));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 6, -3));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 6, -2));
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(3, 6, -1));
                ...
                placeMushroom(MUSHROOM, worldIn, mainmutable.add(-2, 7, 2));
