...
public class SythianFungusTree3 extends BYGAbstractMushroomFeature<BYGMushroomConfig> {
    ...
    private void hangingSythianRoots(StructureWorldAccess reader, BlockPos pos) {
        if (isAir(reader, pos)) {
    ...
    //Leaves Placement
    private void hangingSythianRootsPlant(StructureWorldAccess reader, BlockPos pos) {
        if (isAir(reader, pos)) {
