    ...
    protected boolean generate(Set<BlockPos> changedBlocks, ISeedReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling, BYGTreeFeatureConfig config) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getHeight()) {
            if (!isDesiredGroundwNetherTags(worldIn, pos.down(), config)) {
                ...
                placeNetherTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 10, 0), boundsIn);
                placeNetherTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 11, 0), boundsIn);
                ...
                placeNetherTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 15, 0), boundsIn);
                placeNetherTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 16, 0), boundsIn);
                placeNetherTrunk(config, rand, changedBlocks, worldIn, mainmutable.add(0, 17, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 0, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 0, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 0, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 0, -3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 0, 3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 0, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 0, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 0, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 1, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 1, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 1, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 1, -3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 1, 3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 1, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 1, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 1, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 2, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 2, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 2, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 2, -3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 2, 3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 2, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 2, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 2, 0), boundsIn);
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 3, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 3, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 3, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 3, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 3, 0), boundsIn);
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 5, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 5, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 5, 0), boundsIn);
                ...
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 11, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 11, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 11, 3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 11, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 12, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 12, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 12, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 12, 7), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 12, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 12, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 13, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 13, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 13, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 13, 3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 13, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 13, 5), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 13, 7), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 13, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 13, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 13, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 13, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 13, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(6, 13, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-7, 14, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 14, -4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 14, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 14, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 14, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 14, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 14, 6), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 14, 4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 14, -5), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 14, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 14, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(5, 14, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(6, 14, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-7, 15, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-5, 15, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 15, -4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 15, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 15, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 15, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 15, 2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-3, 15, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(2, 15, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 15, -5), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 15, -3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 15, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 15, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 15, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(4, 15, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(6, 15, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-6, 16, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 16, -3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-4, 16, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 16, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 16, -3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 16, 3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 16, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 16, -4), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(3, 16, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(5, 16, -2), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-1, 17, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 17, -3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 17, -1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 17, 1), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(0, 17, 3), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(1, 17, 0), boundsIn);
                placeNetherBranch(config, rand, changedBlocks, worldIn, mainmutable.add(-2, 18, 0), boundsIn);
