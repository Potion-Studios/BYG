...
public class QuartzDesertSB extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    public QuartzDesertSB(Codec<SurfaceBuilderBaseConfiguration> p_i51312_1_) {
        super(p_i51312_1_);
    }
