...
public class GreatLakeIsleSB extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    public GreatLakeIsleSB(Codec<SurfaceBuilderBaseConfiguration> p_i51312_1_) {
        super(p_i51312_1_);
    }
