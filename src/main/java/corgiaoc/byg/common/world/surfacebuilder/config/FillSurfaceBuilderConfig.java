...
public class FillSurfaceBuilderConfig implements SurfaceConfig {

    public static final Codec<FillSurfaceBuilderConfig> CODEC = RecordCodecBuilder.create((codecRecorder) -> {
        return codecRecorder.group(BlockStateProvider.TYPE_CODEC.fieldOf("top_material").forGetter((config) -> {
            return config.topMaterial;
        }), BlockStateProvider.TYPE_CODEC.fieldOf("under_material").forGetter((config) -> {
            return config.underMaterial;
        }), BlockStateProvider.TYPE_CODEC.fieldOf("filler_material").forGetter((config) -> {
