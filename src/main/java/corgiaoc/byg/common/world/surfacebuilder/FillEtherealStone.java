...
public class FillEtherealStone extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    public static final BlockState SAND = Blocks.SAND.defaultBlockState();

    public FillEtherealStone(Codec<SurfaceBuilderBaseConfiguration> p_i51312_1_) {
        super(p_i51312_1_);
    }
