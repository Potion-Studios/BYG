...
public class ShatteredGlacierSB extends SurfaceBuilder<TernarySurfaceConfig> {
    ...
    public void initSeed(long seed) {
        ...
        if (this.seed != seed || this.perlin1 == null || this.perlin2 == null) {
            ...
            this.perlin1 = new OctaveSimplexNoiseSampler(sharedseedrandom, ImmutableList.of(0));
            this.perlin2 = new OctaveSimplexNoiseSampler(sharedseedrandom, ImmutableList.of(0));
        }
    ...
    protected void fillBlockStateArray(long seed) {
        ...
        ChunkRandom sharedseedrandom = new ChunkRandom(seed);
        this.perlin3 = new OctaveSimplexNoiseSampler(sharedseedrandom, ImmutableList.of(0));
