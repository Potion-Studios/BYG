...
public class LunaSB extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    private static final BlockState WHITE_TERRACOTTA = Blocks.WHITE_TERRACOTTA.defaultBlockState();
    private static final BlockState ORANGE_TERRACOTTA = Blocks.WHITE_TERRACOTTA.defaultBlockState();
    ...
    public LunaSB(Codec<SurfaceBuilderBaseConfiguration> p_i51317_1_) {
        super(p_i51317_1_);
    }
