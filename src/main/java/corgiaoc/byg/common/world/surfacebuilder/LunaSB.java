...
public class LunaSB extends SurfaceBuilder<TernarySurfaceConfig> {
    ...
    public LunaSB(Codec<TernarySurfaceConfig> p_i51317_1_) {
        super(p_i51317_1_);
    }

    @Override
    public void generate(Random random, Chunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, int seaLevel, int xx, long seed, TernarySurfaceConfig config) {
        int i = x & 15;
        int j = z & 15;
    ...
    public void initSeed(long seed) {
        ...
        if (this.field_215433_b != seed || this.field_215435_c == null || this.field_215437_d == null) {
            ...
            this.field_215435_c = new OctaveSimplexNoiseSampler(sharedseedrandom, ImmutableList.of(0));
            this.field_215437_d = new OctaveSimplexNoiseSampler(sharedseedrandom, ImmutableList.of(0));
        }
    ...
    protected void func_215430_b(long p_215430_1_) {
        ...
        this.field_215439_e = new OctaveSimplexNoiseSampler(sharedseedrandom, ImmutableList.of(0));
