...
public class DaciteWhiteBeachSB extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    public DaciteWhiteBeachSB(Codec<SurfaceBuilderBaseConfiguration> p_i51312_1_) {
        super(p_i51312_1_);
    }
