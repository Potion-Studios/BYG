...
//
//public abstract class Worley3DNoiseChunkGenerator<T extends BYGBiome implements BiomeToolsGenerationSettings> extends ChunkGenerator<T> {
//
...
//            do {
//                blendingValue += fssnOctavesBlend[octave].sample3D(worldX * hScaleBlend * freq, worldY * vScaleBlend * freq, worldZ * hScaleBlend * freq) * amp;
//                freq *= 2.0;
//                amp /= 2.0;
//                octave++;
...
//            do {
//                if (blendingValue < 1)
//                    actualValue += (1 - blendingValue) * fssnOctaves1[octave].sample3D(worldX * hScale * freq, worldY * vScale * freq, worldZ * vScale * freq) * amp;
//                if (blendingValue > 0)
//                    actualValue += blendingValue * fssnOctaves2[octave].sample3D(worldX * hScale * freq, worldY * vScale * freq, worldZ * hScale * freq) * amp;
//                freq *= 2.0;
//                amp /= 2.0;
//                octave++;
