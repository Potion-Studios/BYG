...
//
//public class Cubic2DOverworldChunkGenerator extends Cubic2DNoiseChunkGenerator<OverworldGenSettings> {
...
//
//    public Cubic2DOverworldChunkGenerator(IWorld world, BiomeProvider provider, OverworldGenSettings settings) {
