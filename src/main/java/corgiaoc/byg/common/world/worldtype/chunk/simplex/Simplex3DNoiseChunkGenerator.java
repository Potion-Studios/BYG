...
//
//public abstract class Simplex3DNoiseChunkGenerator<T extends BYGBiome implements BiomeToolsGenerationSettings> extends ChunkGenerator<T> {
//
...
//    private final ChunkFastSimplexStyleNoise[] fssnOctaves1;
//    private final ChunkFastSimplexStyleNoise[] fssnOctaves2;
//    private final ChunkFastSimplexStyleNoise[] fssnOctavesBlend;
...
//     */
//
//    public Simplex3DNoiseChunkGenerator(IWorld worldIn, BiomeProvider biomeProvider, int horizontalBiomeGranularityPowerOfTwo, int worldHeight, T settings, int nOctavesOutput, int nOctavesBlend, double hScale, double vScale, double hScaleBlend, double vScaleBlend) {
...
//
//        fssnOctaves1 = new ChunkFastSimplexStyleNoise[nOctavesOutput];
//        fssnOctaves2 = new ChunkFastSimplexStyleNoise[nOctavesOutput];
//        fssnOctavesBlend = new ChunkFastSimplexStyleNoise[nOctavesBlend];
//        for (int i = 0; i < Math.max(nOctavesOutput, nOctavesBlend); i++) {
//            if (i < nOctavesOutput) {
//                fssnOctaves1[i] = new ChunkFastSimplexStyleNoise(randomSeed);
//                fssnOctaves2[i] = new ChunkFastSimplexStyleNoise(randomSeed); //TODO I think if nOctavesBlend=0, we don't even need any of octaves2
//            }
//            if (i < nOctavesBlend) fssnOctavesBlend[i] = new ChunkFastSimplexStyleNoise(randomSeed);
//        }
//
...
//            do {
//                if (blendingValue < 1)
//                    actualValue += (1 - blendingValue) * fssnOctaves1[octave].noise3_PlaneFirst(worldX * hScale * freq, worldZ * hScale * freq, worldY * vScale * freq) * amp;
//                if (blendingValue > 0)
//                    actualValue += blendingValue * fssnOctaves2[octave].noise3_PlaneFirst(worldX * hScale * freq, worldZ * hScale * freq, worldY * vScale * freq) * amp;
//                freq *= 2.0;
//                amp /= 2.0;
//                octave++;
