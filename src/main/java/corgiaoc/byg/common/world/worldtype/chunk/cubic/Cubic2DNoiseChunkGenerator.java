//package voronoiaoc.byg.common.world.worldtype.chunk.cubic;
//
...
//import voronoiaoc.byg.common.world.worldtype.noise.CubicNoise;
//import voronoiaoc.byg.common.world.worldtype.noise.simplex.chunkgen.DisklessDepositor;
//import voronoiaoc.byg.common.world.worldtype.noise.simplex.chunkgen.SplerpBaseCubic;
//
//import java.util.Iterator;
//import java.util.Random;
//
//public abstract class Cubic2DNoiseChunkGenerator<T extends BYGBiome implements BiomeToolsGenerationSettings> extends ChunkGenerator<T> {
//
...
//    private final CubicNoise[] fssnOctaves1;
//    private final CubicNoise[] fssnOctaves2;
//    private final CubicNoise[] fssnOctavesBlend;
...
//     */
//    private final SplerpBaseCubic biomeSplerpBaseSimplex;
//
//    /*
//     * Generate a whole chunk
//     */
//
//    public Cubic2DNoiseChunkGenerator(IWorld worldIn, BiomeProvider biomeProvider, int horizontalBiomeGranularityPowerOfTwo, int worldHeight, T settings, int nOctavesOutput, int nOctavesBlend, double hScale, double vScale, double hScaleBlend, double vScaleBlend) {
...
//
//        fssnOctaves1 = new CubicNoise[nOctavesOutput];
//        fssnOctaves2 = new CubicNoise[nOctavesOutput];
//        fssnOctavesBlend = new CubicNoise[nOctavesBlend];
//        for (int i = 0; i < Math.max(nOctavesOutput, nOctavesBlend); i++) {
//            if (i < nOctavesOutput) {
//                fssnOctaves1[i] = new CubicNoise(100000);
//                fssnOctaves2[i] = new CubicNoise(100000); //TODO I think if nOctavesBlend=0, we don't even need any of octaves2
//            }
//            if (i < nOctavesBlend) fssnOctavesBlend[i] = new CubicNoise(10000);
//        }
//
...
//        this.biomeSplerpBaseSimplex = SplerpBaseCubic.forStride(horizontalBiomeGranularityPowerOfTwo);
//
...
//                }
//
//                SplerpBaseCubic.BiSplerp biSplerp1 = new SplerpBaseCubic.BiSplerp(biomeSplerpBaseSimplex, biomeSplerpBaseSimplex, biSplerpValues1);
//                SplerpBaseCubic.BiSplerp biSplerp2 = new SplerpBaseCubic.BiSplerp(biomeSplerpBaseSimplex, biomeSplerpBaseSimplex, biSplerpValues2);
//
//                for (int z = 0; z < horizontalBiomeGranularity; z++) {
//                    SplerpBaseCubic.Splerp splerp1 = biSplerp1.at(z);
//                    SplerpBaseCubic.Splerp splerp2 = biSplerp2.at(z);
