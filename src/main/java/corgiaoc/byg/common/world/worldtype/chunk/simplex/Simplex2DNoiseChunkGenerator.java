...
//
//public abstract class Simplex2DNoiseChunkGenerator<T extends BYGBiome implements BiomeToolsGenerationSettings> extends ChunkGenerator<T> {
//
...
//     */
//
//    public Simplex2DNoiseChunkGenerator(IWorld worldIn, BiomeProvider biomeProvider, int horizontalBiomeGranularityPowerOfTwo, int worldHeight, T settings, int nOctavesOutput, int nOctavesBlend, double hScale, double vScale, double hScaleBlend, double vScaleBlend) {
