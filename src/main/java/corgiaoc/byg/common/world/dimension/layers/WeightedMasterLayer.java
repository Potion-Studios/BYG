...
public class WeightedMasterLayer implements AreaTransformer0 {
    ...
    private final WeightedRandomList<WeightedEntry.Wrapper<ResourceKey<Biome>>> weightedBiomesList;

    public WeightedMasterLayer(Registry<Biome> biomeRegistry, WeightedRandomList<WeightedEntry.Wrapper<ResourceKey<Biome>>> weightedBiomesList) {
