...
public class BlockDataGenerator {
    ...
    public static void makeBYGLangFile(String filePath) {
        ...
        for (Block block : Registry.BLOCK) {
            String blockID = Objects.requireNonNull(Registry.BLOCK.getId(block)).toString();
        ...
        for (Item item : Registry.ITEM) {
            String itemID = Objects.requireNonNull(Registry.ITEM.getId(item)).toString();
        ...
        for (Biome biome : BuiltinRegistries.BIOME) {
            String biomeID = Objects.requireNonNull(BuiltinRegistries.BIOME.getId(biome)).toString();
